...
TypeId SixLowPanHc1::GetInstanceTypeId() const { return GetTypeId(); }
...
void SixLowPanHc1::SetHopLimit(uint8_t limit) { m_hopLimit = limit; }

uint8_t SixLowPanHc1::GetHopLimit() const { return m_hopLimit; }

SixLowPanHc1::LowPanHc1Addr_e SixLowPanHc1::GetDstCompression() const {
  return m_dstCompression;
}

const uint8_t *SixLowPanHc1::GetDstInterface() const { return m_dstInterface; }

const uint8_t *SixLowPanHc1::GetDstPrefix() const { return m_dstPrefix; }

uint32_t SixLowPanHc1::GetFlowLabel() const { return m_flowLabel; }

uint8_t SixLowPanHc1::GetNextHeader() const { return m_nextHeader; }

SixLowPanHc1::LowPanHc1Addr_e SixLowPanHc1::GetSrcCompression() const {
  return m_srcCompression;
}

const uint8_t *SixLowPanHc1::GetSrcInterface() const { return m_srcInterface; }

const uint8_t *SixLowPanHc1::GetSrcPrefix() const { return m_srcPrefix; }

uint8_t SixLowPanHc1::GetTrafficClass() const { return m_trafficClass; }

bool SixLowPanHc1::IsTcflCompression() const { return m_tcflCompression; }

bool SixLowPanHc1::IsHc2HeaderPresent() const { return m_hc2HeaderPresent; }
...
void SixLowPanHc1::SetFlowLabel(uint32_t flowLabel) { m_flowLabel = flowLabel; }
...
TypeId SixLowPanFrag1::GetInstanceTypeId() const { return GetTypeId(); }

void SixLowPanFrag1::Print(std::ostream &os) const {
  os << "datagram size " << m_datagramSize << " tag " << m_datagramTag;
}

uint32_t SixLowPanFrag1::GetSerializedSize() const { return 4; }

void SixLowPanFrag1::Serialize(Buffer::Iterator start) const {
  Buffer::Iterator i = start;

  uint16_t temp =
      m_datagramSize | (uint16_t(SixLowPanDispatch::LOWPAN_FRAG1) << 8);
...
uint16_t SixLowPanFrag1::GetDatagramTag() const { return m_datagramTag; }
...
TypeId SixLowPanFragN::GetInstanceTypeId() const { return GetTypeId(); }

void SixLowPanFragN::Print(std::ostream &os) const {
  os << "datagram size " << m_datagramSize << " tag " << m_datagramTag
     << " offset " << +m_datagramOffset;
}

uint32_t SixLowPanFragN::GetSerializedSize() const { return 5; }

void SixLowPanFragN::Serialize(Buffer::Iterator start) const {
  Buffer::Iterator i = start;

  uint16_t temp =
      m_datagramSize | (uint16_t(SixLowPanDispatch::LOWPAN_FRAGN) << 8);
...
uint16_t SixLowPanFragN::GetDatagramTag() const { return m_datagramTag; }

void SixLowPanFragN::SetDatagramOffset(uint8_t datagramOffset) {
  m_datagramOffset = datagramOffset;
}

uint8_t SixLowPanFragN::GetDatagramOffset() const { return m_datagramOffset; }
...
TypeId SixLowPanIpv6::GetInstanceTypeId() const { return GetTypeId(); }

void SixLowPanIpv6::Print(std::ostream &os) const { os << "Uncompressed IPv6"; }

uint32_t SixLowPanIpv6::GetSerializedSize() const { return 1; }
...
TypeId SixLowPanIphc::GetInstanceTypeId() const { return GetTypeId(); }
...
bool SixLowPanIphc::GetNh() const { return ((m_baseFormat >> 10) & 0x1); }
...
bool SixLowPanIphc::GetCid() const { return ((m_baseFormat >> 7) & 0x1); }
...
bool SixLowPanIphc::GetSac() const { return ((m_baseFormat >> 6) & 0x1); }
...
bool SixLowPanIphc::GetM() const { return ((m_baseFormat >> 3) & 0x1); }
...
bool SixLowPanIphc::GetDac() const { return ((m_baseFormat >> 2) & 0x1); }
...
uint8_t SixLowPanIphc::GetEcn() const { return m_ecn; }
...
uint8_t SixLowPanIphc::GetDscp() const { return m_dscp; }
...
uint32_t SixLowPanIphc::GetFlowLabel() const { return m_flowLabel; }

void SixLowPanIphc::SetNextHeader(uint8_t nextHeader) {
  m_nextHeader = nextHeader;
}

uint8_t SixLowPanIphc::GetNextHeader() const { return m_nextHeader; }

void SixLowPanIphc::SetHopLimit(uint8_t hopLimit) { m_hopLimit = hopLimit; }

uint8_t SixLowPanIphc::GetHopLimit() const { return m_hopLimit; }
...
TypeId SixLowPanNhcExtension::GetInstanceTypeId() const { return GetTypeId(); }
...
uint8_t SixLowPanNhcExtension::GetNextHeader() const { return m_nhcNextHeader; }
...
uint16_t SixLowPanUdpNhcExtension::GetSrcPort() const { return m_srcPort; }

void SixLowPanUdpNhcExtension::SetDstPort(uint16_t dstport) {
  m_dstPort = dstport;
}

uint16_t SixLowPanUdpNhcExtension::GetDstPort() const { return m_dstPort; }
...
uint16_t SixLowPanUdpNhcExtension::GetChecksum() const { return m_checksum; }
...
TypeId SixLowPanBc0::GetInstanceTypeId() const { return GetTypeId(); }

void SixLowPanBc0::Print(std::ostream &os) const {
  os << "Sequence number: " << +m_seqNumber;
}

uint32_t SixLowPanBc0::GetSerializedSize() const { return 2; }
...
uint8_t SixLowPanBc0::GetSequenceNumber() const { return m_seqNumber; }
...
TypeId SixLowPanMesh::GetInstanceTypeId() const { return GetTypeId(); }
...
Address SixLowPanMesh::GetOriginator() const { return m_src; }
...
Address SixLowPanMesh::GetFinalDst() const { return m_dst; }

void SixLowPanMesh::SetHopsLeft(uint8_t hopsLeft) { m_hopsLeft = hopsLeft; }

uint8_t SixLowPanMesh::GetHopsLeft() const { return m_hopsLeft; }
