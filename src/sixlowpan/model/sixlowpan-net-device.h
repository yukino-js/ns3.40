...
private:
  ...
  Ptr<RandomVariableStream>
      m_meshUnderJitter; //!< Random variable for the mesh-under packet
                         //!< retransmission.
  std::map<Address /* OriginatorAddress */,
           std::list<uint8_t /* SequenceNumber */>>
  ...
  std::map<uint8_t, ContextEntry>
      m_contextTable; //!< Table of the contexts used in
                      //!< compression/decompression
