...
int main(int argc, char **argv) {
  ...
  mobility.SetPositionAllocator(
      ...
      DoubleValue(0.0), "DeltaX", DoubleValue(80), "DeltaY", DoubleValue(80),
  ...
  lrWpanHelper.EnableAsciiAll(
      ascii.CreateFileStream("Ping-6LoW-lr-wpan-meshunder-lr-wpan.tr"));
  lrWpanHelper.EnablePcapAll(std::string("Ping-6LoW-lr-wpan-meshunder-lr-wpan"),
                             true);

  csmaHelper.EnableAsciiAll(
      ascii.CreateFileStream("Ping-6LoW-lr-wpan-meshunder-csma.tr"));
  csmaHelper.EnablePcapAll(std::string("Ping-6LoW-lr-wpan-meshunder-csma"),
                           true);
