...
private:
  ...
  LteRrcSap::PhysicalConfigDedicated
      m_physicalConfigDedicated; ///< physical config dedicated
...
private:
  ...
  Callback<void, Ptr<Packet>>
      m_forwardUpCallback; ///< forward up callback function
  ...
  std::set<uint16_t>
      m_ueSrsConfigurationIndexSet; ///< UE SRS configuration index set
  uint16_t
      m_lastAllocatedConfigurationIndex; ///< last allocated configuration index
