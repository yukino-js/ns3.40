...
private:
  ...
  std::vector<bool>
      m_dlSecondarySegmentRbgMap; ///< DL secondary segment RBG map
  ...
  std::vector<bool>
      m_ulSecondarySegmentRbgMap; ///< UL secondary segment RBG map
  ...
  std::map<uint16_t, std::vector<bool>>
      m_dlRbgAvailableforUe; ///< DL RBG available for UE

  uint8_t m_ulCqiThreshold;                     ///< UL CQI threshold
  std::map<uint16_t, std::vector<int>> m_ulCqi; ///< UL CQI
  std::map<uint16_t, std::vector<bool>>
      m_ulRbAvailableforUe; ///< UL RB available for UE
