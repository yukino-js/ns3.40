...
private:
  ...
  std::vector<MacCeListElement_s>
      m_ulCeReceived; ///< CE received (BSR up to now)

  std::vector<DlInfoListElement_s>
      m_dlInfoListReceived; ///< DL HARQ feedback received

  std::vector<UlInfoListElement_s>
      m_ulInfoListReceived; ///< UL HARQ feedback received
  ...
  std::map<uint8_t, uint32_t>
      m_receivedRachPreambleCount; ///< received RACH preamble count
