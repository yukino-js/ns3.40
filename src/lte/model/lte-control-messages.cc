...
void LteControlMessage::SetMessageType(LteControlMessage::MessageType type) {
  m_type = type;
}

LteControlMessage::MessageType LteControlMessage::GetMessageType() {
  return m_type;
}
...
void DlDciLteControlMessage::SetDci(DlDciListElement_s dci) { m_dci = dci; }
...
void DlCqiLteControlMessage::SetDlCqi(CqiListElement_s dlcqi) {
  m_dlCqi = dlcqi;
}
...
void BsrLteControlMessage::SetBsr(MacCeListElement_s bsr) { m_bsr = bsr; }
...
void RachPreambleLteControlMessage::SetRapId(uint32_t rapId) {
  m_rapId = rapId;
}
...
void RarLteControlMessage::SetRaRnti(uint16_t raRnti) { m_raRnti = raRnti; }

uint16_t RarLteControlMessage::GetRaRnti() const { return m_raRnti; }

void RarLteControlMessage::AddRar(Rar rar) { m_rarList.push_back(rar); }
...
void MibLteControlMessage::SetMib(LteRrcSap::MasterInformationBlock mib) {
  m_mib = mib;
}
...
void Sib1LteControlMessage::SetSib1(
...
void DlHarqFeedbackLteControlMessage::SetDlHarqFeedback(DlInfoListElement_s m) {
  m_dlInfoListElement = m;
}

DlInfoListElement_s DlHarqFeedbackLteControlMessage::GetDlHarqFeedback() {
