...
private:
  ...
  Ptr<LteFfrAlgorithm>
      m_ffrAlgorithm; /**< DEPRECATED - It is maintained for backward
  ...
  uint16_t
      m_dlBandwidth; /**<DEPRECATE - It is maintained for backward compatibility
                        after adding CA feature- downlink bandwidth in RBs */
  uint16_t
      m_ulBandwidth; /**<DEPRECATE - It is maintained for backward compatibility
                        after adding CA feature- uplink bandwidth in RBs */

  uint32_t
      m_dlEarfcn; /**<DEPRECATE - It is maintained for backward compatibility
                     after adding CA feature- downlink carrier frequency */
  uint32_t
      m_ulEarfcn; /**<DEPRECATE - It is maintained for backward compatibility
