...
LteFrStrictAlgorithm::LteFrStrictAlgorithm()
  ...
  m_ffrRrcSapProvider =
      new MemberLteFfrRrcSapProvider<LteFrStrictAlgorithm>(this);
}

LteFrStrictAlgorithm::~LteFrStrictAlgorithm() { NS_LOG_FUNCTION(this); }

void LteFrStrictAlgorithm::DoDispose() {
  NS_LOG_FUNCTION(this);
  delete m_ffrSapProvider;
  delete m_ffrRrcSapProvider;
}

TypeId LteFrStrictAlgorithm::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::LteFrStrictAlgorithm")
          ...
          .AddAttribute("UlCommonSubBandwidth",
                        ...
                        MakeUintegerAccessor(
                            &LteFrStrictAlgorithm::m_ulCommonSubBandwidth),
          ...
          .AddAttribute(
              ...
              UintegerValue(0),
              MakeUintegerAccessor(
                  &LteFrStrictAlgorithm::m_ulEdgeSubBandOffset),
              MakeUintegerChecker<uint8_t>())
          .AddAttribute(
              "UlEdgeSubBandwidth",
          ...
          .AddAttribute("DlCommonSubBandwidth",
                        ...
                        UintegerValue(25),
                        MakeUintegerAccessor(
                            &LteFrStrictAlgorithm::m_dlCommonSubBandwidth),
                        MakeUintegerChecker<uint8_t>())
          .AddAttribute(
              "DlEdgeSubBandOffset",
              ...
              UintegerValue(0),
              MakeUintegerAccessor(
                  &LteFrStrictAlgorithm::m_dlEdgeSubBandOffset),
              MakeUintegerChecker<uint8_t>())
          .AddAttribute(
              "DlEdgeSubBandwidth",
          ...
          .AddAttribute("RsrqThreshold",
                        ...
                        UintegerValue(20),
                        MakeUintegerAccessor(
                            &LteFrStrictAlgorithm::m_edgeSubBandThreshold),
                        MakeUintegerChecker<uint8_t>())
          .AddAttribute("CenterPowerOffset",
                        ...
                        MakeUintegerAccessor(
                            &LteFrStrictAlgorithm::m_centerAreaPowerOffset),
                        MakeUintegerChecker<uint8_t>())
          .AddAttribute("EdgePowerOffset",
                        ...
                        UintegerValue(5),
                        MakeUintegerAccessor(
                            &LteFrStrictAlgorithm::m_edgeAreaPowerOffset),
                        MakeUintegerChecker<uint8_t>())
          .AddAttribute(
              "CenterAreaTpc",
...
void LteFrStrictAlgorithm::SetLteFfrSapUser(LteFfrSapUser *s) {
  NS_LOG_FUNCTION(this << s);
  m_ffrSapUser = s;
}

LteFfrSapProvider *LteFrStrictAlgorithm::GetLteFfrSapProvider() {
  NS_LOG_FUNCTION(this);
  return m_ffrSapProvider;
}

void LteFrStrictAlgorithm::SetLteFfrRrcSapUser(LteFfrRrcSapUser *s) {
  NS_LOG_FUNCTION(this << s);
  m_ffrRrcSapUser = s;
}

LteFfrRrcSapProvider *LteFrStrictAlgorithm::GetLteFfrRrcSapProvider() {
  NS_LOG_FUNCTION(this);
  return m_ffrRrcSapProvider;
}

void LteFrStrictAlgorithm::DoInitialize() {
  NS_LOG_FUNCTION(this);
...
void LteFrStrictAlgorithm::Reconfigure() {
  NS_LOG_FUNCTION(this);
  if (m_frCellTypeId != 0) {
    SetDownlinkConfiguration(m_frCellTypeId, m_dlBandwidth);
    SetUplinkConfiguration(m_frCellTypeId, m_ulBandwidth);
...
void LteFrStrictAlgorithm::SetDownlinkConfiguration(uint16_t cellId,
                                                    uint8_t bandwidth) {
  NS_LOG_FUNCTION(this);
  for (uint16_t i = 0; i < NUM_DOWNLINK_CONFS; ++i) {
    if ((g_frStrictDownlinkDefaultConfiguration[i].cellId == cellId) &&
        g_frStrictDownlinkDefaultConfiguration[i].dlBandwidth ==
            m_dlBandwidth) {
      m_dlCommonSubBandwidth =
          g_frStrictDownlinkDefaultConfiguration[i].dlCommonSubBandwidth;
      m_dlEdgeSubBandOffset =
          g_frStrictDownlinkDefaultConfiguration[i].dlEdgeSubBandOffset;
      m_dlEdgeSubBandwidth =
          g_frStrictDownlinkDefaultConfiguration[i].dlEdgeSubBandwidth;
    }
  }
}

void LteFrStrictAlgorithm::SetUplinkConfiguration(uint16_t cellId,
                                                  uint8_t bandwidth) {
  NS_LOG_FUNCTION(this);
  for (uint16_t i = 0; i < NUM_UPLINK_CONFS; ++i) {
    if ((g_frStrictUplinkDefaultConfiguration[i].cellId == cellId) &&
      ...
      m_ulCommonSubBandwidth =
          g_frStrictUplinkDefaultConfiguration[i].ulCommonSubBandwidth;
      m_ulEdgeSubBandOffset =
          g_frStrictUplinkDefaultConfiguration[i].ulEdgeSubBandOffset;
      m_ulEdgeSubBandwidth =
          g_frStrictUplinkDefaultConfiguration[i].ulEdgeSubBandwidth;
    }
  }
}

void LteFrStrictAlgorithm::InitializeDownlinkRbgMaps() {
  m_dlRbgMap.clear();
  ...
  NS_ASSERT_MSG((m_dlCommonSubBandwidth + m_dlEdgeSubBandOffset +
                 m_dlEdgeSubBandwidth) <= m_dlBandwidth,
  ...
  for (int i =
           m_dlCommonSubBandwidth / rbgSize + m_dlEdgeSubBandOffset / rbgSize;
...
void LteFrStrictAlgorithm::InitializeUplinkRbgMaps() {
  m_ulRbgMap.clear();
  ...
  NS_ASSERT_MSG((m_ulCommonSubBandwidth + m_ulEdgeSubBandOffset +
                 m_ulEdgeSubBandwidth) <= m_ulBandwidth,
...
std::vector<bool> LteFrStrictAlgorithm::DoGetAvailableDlRbg() {
  NS_LOG_FUNCTION(this);
...
bool LteFrStrictAlgorithm::DoIsDlRbgAvailableForUe(int rbgId, uint16_t rnti) {
  NS_LOG_FUNCTION(this);
...
std::vector<bool> LteFrStrictAlgorithm::DoGetAvailableUlRbg() {
  NS_LOG_FUNCTION(this);
...
bool LteFrStrictAlgorithm::DoIsUlRbgAvailableForUe(int rbgId, uint16_t rnti) {
  NS_LOG_FUNCTION(this);
...
void LteFrStrictAlgorithm::DoReportDlCqiInfo(
...
void LteFrStrictAlgorithm::DoReportUlCqiInfo(
...
uint8_t LteFrStrictAlgorithm::DoGetTpc(uint16_t rnti) {
  NS_LOG_FUNCTION(this);
...
uint16_t LteFrStrictAlgorithm::DoGetMinContinuousUlBandwidth() {
  NS_LOG_FUNCTION(this);
  ...
  uint8_t minContinuousUlBandwidth =
      m_ulCommonSubBandwidth < m_ulEdgeSubBandwidth ? m_ulCommonSubBandwidth
                                                    : m_ulEdgeSubBandwidth;
...
void LteFrStrictAlgorithm::DoReportUeMeas(uint16_t rnti,
...
void LteFrStrictAlgorithm::DoRecvLoadInformation(
