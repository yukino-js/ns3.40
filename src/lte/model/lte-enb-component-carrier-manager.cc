...
TypeId LteEnbComponentCarrierManager::GetTypeId() {
...
void LteEnbComponentCarrierManager::DoDispose() {}

void LteEnbComponentCarrierManager::SetLteCcmRrcSapUser(LteCcmRrcSapUser *s) {
  NS_LOG_FUNCTION(this << s);
  m_ccmRrcSapUser = s;
}

LteCcmRrcSapProvider *LteEnbComponentCarrierManager::GetLteCcmRrcSapProvider() {
  NS_LOG_FUNCTION(this);
  return m_ccmRrcSapProvider;
}

LteMacSapProvider *LteEnbComponentCarrierManager::GetLteMacSapProvider() {
  NS_LOG_FUNCTION(this);
  return m_macSapProvider;
}

LteCcmMacSapUser *LteEnbComponentCarrierManager::GetLteCcmMacSapUser() {
  NS_LOG_FUNCTION(this);
  return m_ccmMacSapUser;
}

bool LteEnbComponentCarrierManager::SetMacSapProvider(
    uint8_t componentCarrierId, LteMacSapProvider *sap) {
  NS_LOG_FUNCTION(this);
  bool res = false;
...
bool LteEnbComponentCarrierManager::SetCcmMacSapProviders(
    uint8_t componentCarrierId, LteCcmMacSapProvider *sap) {
  NS_LOG_FUNCTION(this);
  bool res = false;
...
void LteEnbComponentCarrierManager::SetNumberOfComponentCarriers(
