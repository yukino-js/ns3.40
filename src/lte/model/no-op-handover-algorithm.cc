...
NoOpHandoverAlgorithm::~NoOpHandoverAlgorithm() { NS_LOG_FUNCTION(this); }

void NoOpHandoverAlgorithm::DoDispose() {
  NS_LOG_FUNCTION(this);
  delete m_handoverManagementSapProvider;
}

TypeId NoOpHandoverAlgorithm::GetTypeId() {
...
void NoOpHandoverAlgorithm::SetLteHandoverManagementSapUser(
...
void NoOpHandoverAlgorithm::DoReportUeMeas(uint16_t rnti,
