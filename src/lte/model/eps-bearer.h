...
public:
  ...
  enum Qci : uint8_t {
    ...
    GBR_MC_PUSH_TO_TALK =
        65, ///< GBR Mission Critical User Plane Push To Talk voice
    ...
    NGBR_VOICE_VIDEO_GAMING =
        7,                      ///< Non-GBR Voice, Video, Interactive Streaming
    ...
    DGBR_ITS =
        84, ///< Delay-Critical GBR Intelligent Transport Systems (TS 22.261)
    DGBR_ELECTRICITY = 85, ///< Delay-Critical GBR Electricity Distribution High
                           ///< Voltage (TS 22.261)
