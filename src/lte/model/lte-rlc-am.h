...
private:
  ...
  std::vector<RetxPdu>
      m_txedBuffer; ///< Buffer for transmitted and retransmitted PDUs
                    ///< that have not been acked but are not considered
                    ///< for retransmission
  std::vector<RetxPdu>
      m_retxBuffer; ///< Buffer for PDUs considered for retransmission
  ...
  bool m_txOpportunityForRetxAlwaysBigEnough; ///< transmit opportunity for
                                              ///< retransmit?
  bool
      m_pollRetransmitTimerJustExpired; ///< poll retransmit timer just expired?
