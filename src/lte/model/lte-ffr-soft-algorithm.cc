...
static const FfrSoftDownlinkDefaultConfiguration
    g_ffrSoftDownlinkDefaultConfiguration[]{
        ...
        {1, 25, 6, 0, 6},    {2, 25, 6, 6, 6},     {3, 25, 6, 12, 6},
        {1, 50, 21, 0, 9},   {2, 50, 21, 9, 9},    {3, 50, 21, 18, 11},
        {1, 75, 36, 0, 12},  {2, 75, 36, 12, 12},  {3, 75, 36, 24, 15},
...
LteFfrSoftAlgorithm::LteFfrSoftAlgorithm()
    : m_ffrSapUser(nullptr), m_ffrRrcSapUser(nullptr), m_dlEdgeSubBandOffset(0),
      m_dlEdgeSubBandwidth(0), m_ulEdgeSubBandOffset(0),
      m_ulEdgeSubBandwidth(0), m_measId(0) {
  NS_LOG_FUNCTION(this);
  m_ffrSapProvider = new MemberLteFfrSapProvider<LteFfrSoftAlgorithm>(this);
  m_ffrRrcSapProvider =
      new MemberLteFfrRrcSapProvider<LteFfrSoftAlgorithm>(this);
}

LteFfrSoftAlgorithm::~LteFfrSoftAlgorithm() { NS_LOG_FUNCTION(this); }

void LteFfrSoftAlgorithm::DoDispose() {
  NS_LOG_FUNCTION(this);
  delete m_ffrSapProvider;
  delete m_ffrRrcSapProvider;
}

TypeId LteFfrSoftAlgorithm::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::LteFfrSoftAlgorithm")
          ...
          .AddAttribute("UlCommonSubBandwidth",
                        ...
                        MakeUintegerAccessor(
                            &LteFfrSoftAlgorithm::m_ulCommonSubBandwidth),
          ...
          .AddAttribute("DlCommonSubBandwidth",
                        ...
                        UintegerValue(6),
                        MakeUintegerAccessor(
                            &LteFfrSoftAlgorithm::m_dlCommonSubBandwidth),
                        MakeUintegerChecker<uint8_t>())
          .AddAttribute(
              "DlEdgeSubBandOffset",
          ...
          .AddAttribute("CenterRsrqThreshold",
                        ...
                        UintegerValue(30),
                        MakeUintegerAccessor(
                            &LteFfrSoftAlgorithm::m_centerSubBandThreshold),
                        MakeUintegerChecker<uint8_t>())
          .AddAttribute("EdgeRsrqThreshold",
                        ...
                        UintegerValue(20),
                        MakeUintegerAccessor(
                            &LteFfrSoftAlgorithm::m_edgeSubBandThreshold),
                        MakeUintegerChecker<uint8_t>())
          .AddAttribute("CenterAreaPowerOffset",
                        ...
                        UintegerValue(5),
                        MakeUintegerAccessor(
                            &LteFfrSoftAlgorithm::m_centerAreaPowerOffset),
                        MakeUintegerChecker<uint8_t>())
          .AddAttribute("MediumAreaPowerOffset",
                        ...
                        UintegerValue(5),
                        MakeUintegerAccessor(
                            &LteFfrSoftAlgorithm::m_mediumAreaPowerOffset),
                        MakeUintegerChecker<uint8_t>())
          .AddAttribute(
              "EdgeAreaPowerOffset",
...
void LteFfrSoftAlgorithm::SetLteFfrSapUser(LteFfrSapUser *s) {
  NS_LOG_FUNCTION(this << s);
  m_ffrSapUser = s;
}

LteFfrSapProvider *LteFfrSoftAlgorithm::GetLteFfrSapProvider() {
  NS_LOG_FUNCTION(this);
  return m_ffrSapProvider;
}

void LteFfrSoftAlgorithm::SetLteFfrRrcSapUser(LteFfrRrcSapUser *s) {
  NS_LOG_FUNCTION(this << s);
  m_ffrRrcSapUser = s;
}

LteFfrRrcSapProvider *LteFfrSoftAlgorithm::GetLteFfrRrcSapProvider() {
  NS_LOG_FUNCTION(this);
  return m_ffrRrcSapProvider;
}

void LteFfrSoftAlgorithm::DoInitialize() {
  NS_LOG_FUNCTION(this);
  LteFfrAlgorithm::DoInitialize();

  NS_ASSERT_MSG(m_dlBandwidth > 14,
                "DlBandwidth must be at least 15 to use FFR algorithms");
  NS_ASSERT_MSG(m_ulBandwidth > 14,
                "UlBandwidth must be at least 15 to use FFR algorithms");
...
void LteFfrSoftAlgorithm::Reconfigure() {
  NS_LOG_FUNCTION(this);
  if (m_frCellTypeId != 0) {
    SetDownlinkConfiguration(m_frCellTypeId, m_dlBandwidth);
    SetUplinkConfiguration(m_frCellTypeId, m_ulBandwidth);
...
void LteFfrSoftAlgorithm::SetDownlinkConfiguration(uint16_t cellId,
                                                   uint8_t bandwidth) {
  NS_LOG_FUNCTION(this);
  for (uint16_t i = 0; i < NUM_DOWNLINK_CONFS; ++i) {
    if ((g_ffrSoftDownlinkDefaultConfiguration[i].cellId == cellId) &&
      ...
      m_dlCommonSubBandwidth =
          g_ffrSoftDownlinkDefaultConfiguration[i].dlCommonSubBandwidth;
      m_dlEdgeSubBandOffset =
          g_ffrSoftDownlinkDefaultConfiguration[i].dlEdgeSubBandOffset;
      m_dlEdgeSubBandwidth =
          g_ffrSoftDownlinkDefaultConfiguration[i].dlEdgeSubBandwidth;
    }
  }
}

void LteFfrSoftAlgorithm::SetUplinkConfiguration(uint16_t cellId,
                                                 uint8_t bandwidth) {
  NS_LOG_FUNCTION(this);
  for (uint16_t i = 0; i < NUM_UPLINK_CONFS; ++i) {
    if ((g_ffrSoftUplinkDefaultConfiguration[i].cellId == cellId) &&
      ...
      m_ulCommonSubBandwidth =
          g_ffrSoftUplinkDefaultConfiguration[i].ulCommonSubBandwidth;
      m_ulEdgeSubBandOffset =
          g_ffrSoftUplinkDefaultConfiguration[i].ulEdgeSubBandOffset;
      m_ulEdgeSubBandwidth =
          g_ffrSoftUplinkDefaultConfiguration[i].ulEdgeSubBandwidth;
    }
  }
}

void LteFfrSoftAlgorithm::InitializeDownlinkRbgMaps() {
  m_dlRbgMap.clear();
  ...
  NS_ASSERT_MSG(
      m_dlCommonSubBandwidth + m_dlEdgeSubBandOffset <= m_dlBandwidth,
...
void LteFfrSoftAlgorithm::InitializeUplinkRbgMaps() {
  m_ulRbgMap.clear();
  ...
  NS_ASSERT_MSG(
      m_ulCommonSubBandwidth + m_ulEdgeSubBandOffset <= m_ulBandwidth,
  ...
  NS_ASSERT_MSG(
      (m_ulCommonSubBandwidth + m_ulEdgeSubBandOffset + m_ulEdgeSubBandwidth) <=
          m_ulBandwidth,
...
std::vector<bool> LteFfrSoftAlgorithm::DoGetAvailableDlRbg() {
  NS_LOG_FUNCTION(this);
...
bool LteFfrSoftAlgorithm::DoIsDlRbgAvailableForUe(int rbgId, uint16_t rnti) {
  NS_LOG_FUNCTION(this);
  ...
  return (isCenterRbg && isCenterUe) || (isMediumRbg && isMediumUe) ||
         (isEdgeRbg && isEdgeUe);
}

std::vector<bool> LteFfrSoftAlgorithm::DoGetAvailableUlRbg() {
  NS_LOG_FUNCTION(this);
...
bool LteFfrSoftAlgorithm::DoIsUlRbgAvailableForUe(int rbgId, uint16_t rnti) {
  NS_LOG_FUNCTION(this);
...
void LteFfrSoftAlgorithm::DoReportDlCqiInfo(
...
void LteFfrSoftAlgorithm::DoReportUlCqiInfo(
...
uint8_t LteFfrSoftAlgorithm::DoGetTpc(uint16_t rnti) {
  NS_LOG_FUNCTION(this);
...
uint16_t LteFfrSoftAlgorithm::DoGetMinContinuousUlBandwidth() {
  NS_LOG_FUNCTION(this);
  ...
  minContinuousUlBandwidth = ((centerSubBandwidth > 0) &&
                              (centerSubBandwidth < minContinuousUlBandwidth))
                                 ? centerSubBandwidth
                                 : minContinuousUlBandwidth;

  minContinuousUlBandwidth = ((mediumSubBandwidth > 0) &&
                              (mediumSubBandwidth < minContinuousUlBandwidth))
                                 ? mediumSubBandwidth
                                 : minContinuousUlBandwidth;
...
void LteFfrSoftAlgorithm::DoReportUeMeas(uint16_t rnti,
  ...
  NS_ASSERT_MSG(
      m_centerSubBandThreshold >= m_edgeSubBandThreshold,
  ...
  if (measResults.measId != m_measId) {
    ...
    } else if (measResults.measResultPCell.rsrqResult <
...
void LteFfrSoftAlgorithm::DoRecvLoadInformation(
