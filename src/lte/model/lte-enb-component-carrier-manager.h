...
protected:
   ...
   */
  LteMacSapProvider
      *m_macSapProvider; //!< A pointer to main SAP interface of the MAC
  ...
  std::map<uint8_t, LteMacSapProvider *>
      m_macSapProvidersMap; //!< A map of pointers to real SAP interfaces of MAC
                            //!< instances.
  ...
  LteCcmMacSapUser
      *m_ccmMacSapUser; //!< LteCcmMacSapUser is extended version of
                        //!< LteMacSapUser interface. Contains functions that
                        //!< allow reporting of UL BSR from MAC to CCM.
  LteCcmRrcSapUser
      *m_ccmRrcSapUser; //!< A pointer to SAP interface of RRC instance, i.e. to
                        //!< configure measurements reporting for CCM.
  LteCcmRrcSapProvider
      *m_ccmRrcSapProvider; //!< A pointer to the SAP interface of the CCM
