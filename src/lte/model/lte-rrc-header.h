...
private:
  ...
  LteRrcSap::MobilityControlInfo
      m_mobilityControlInfo;               ///< the modility control info
...
private:
  ...
  LteRrcSap::ReestablishmentCause
      m_reestablishmentCause; ///< reestablishment cause
};
...
private:
  LteRrcSap::RrcConnectionRelease
      m_rrcConnectionRelease; ///< RRC connection release
};
...
private:
  LteRrcSap::RrcConnectionReject
      m_rrcConnectionReject; ///< RRC connection reject
};
