...
void RrcAsn1Header::SerializeDrbToAddModList(
  ...
  for (; it != drbToAddModList.end(); it++) {
    ...
    drbToAddModListOptionalFieldsPresent.set(
        4, true); // eps-BearerIdentity present
    ...
    drbToAddModListOptionalFieldsPresent.set(
        1, true); // logicalChannelIdentity present
    drbToAddModListOptionalFieldsPresent.set(
        0, true); // logicalChannelConfig present
...
void RrcAsn1Header::SerializeSrbToAddModList(
  ...
  for (; it != srbToAddModList.end(); it++) {
    ...
    srbToAddModListOptionalFieldsPresent.set(
        0, true); // logicalChannelConfig present
...
void RrcAsn1Header::SerializePhysicalConfigDedicated(
  ...
  optionalFieldsPhysicalConfigDedicated.set(
      ...
      physicalConfigDedicated
          .havePdschConfigDedicated); // pdsch-ConfigDedicated
  optionalFieldsPhysicalConfigDedicated.set(
      8, false); // pucch-ConfigDedicated not present
  optionalFieldsPhysicalConfigDedicated.set(
      7, false); // pusch-ConfigDedicated not present
  optionalFieldsPhysicalConfigDedicated.set(
      6, false); // uplinkPowerControlDedicated not present
  optionalFieldsPhysicalConfigDedicated.set(
      5, false); // tpc-PDCCH-ConfigPUCCH not present
  optionalFieldsPhysicalConfigDedicated.set(
      4, false); // tpc-PDCCH-ConfigPUSCH not present
  optionalFieldsPhysicalConfigDedicated.set(
      3, false); // cqi-ReportConfig not present
  optionalFieldsPhysicalConfigDedicated.set(
      2,
      physicalConfigDedicated
          .haveSoundingRsUlConfigDedicated); // soundingRS-UL-ConfigDedicated
  optionalFieldsPhysicalConfigDedicated.set(
      1,
      physicalConfigDedicated.haveAntennaInfoDedicated); // antennaInfo
  optionalFieldsPhysicalConfigDedicated.set(
      0, false); // schedulingRequestConfig not present
...
void RrcAsn1Header::SerializeRadioResourceConfigDedicated(
  ...
  optionalFieldsPresent.set(
      5, isSrbToAddModListPresent); // srb-ToAddModList present
  optionalFieldsPresent.set(
      4, isDrbToAddModListPresent); // drb-ToAddModList present
  optionalFieldsPresent.set(
      3, isDrbToReleaseListPresent);   // drb-ToReleaseList present
...
void RrcAsn1Header::SerializeNonCriticalExtensionConfiguration(
  ...
  noncriticalExtension_v1020.set(2,
                                 !nonCriticalExtension.sCellToReleaseList
...
void RrcAsn1Header::SerializeRadioResourceConfigCommonSCell(
  ...
  radioResourceConfigCommonSCell_r10.set(
      1, rrccsc.haveNonUlConfiguration); // NonUlConfiguration
  radioResourceConfigCommonSCell_r10.set(
      0, rrccsc.haveUlConfiguration); // UlConfiguration
  ...
  if (rrccsc.haveUlConfiguration) {
    ...
    FreqInfo_r10.set(
        0, false); // additionalSpectrumEmissionSCell-r10 Not Implemented
    ...
    UlPowerControlCommonSCell_r10.set(
        1, false); // p0-NominalPUSCH-r10 Not Implemented
...
void RrcAsn1Header::SerializePhysicalConfigDedicatedSCell(
  ...
  if (pcdsc.haveUlConfiguration) {
    ...
    ulOpt.set(
        2,
        pcdsc
            .haveSoundingRsUlConfigDedicated); // soundingRS-UL-ConfigDedicated-r10
...
Buffer::Iterator RrcAsn1Header::DeserializePhysicalConfigDedicatedSCell(
  ...
  if (pcdsc->haveUlConfiguration) {
    ...
    NS_ASSERT(
        !ulOpt[0]); // soundingRS-UL-ConfigDedicatedAperiodic-r10 not present
...
Buffer::Iterator RrcAsn1Header::DeserializeSystemInformationBlockType1(
  ...
  for (int i = 0; i < numSchedulingInfo; i++) {
    ...
    int numSibType;
    bIterator = DeserializeSequenceOf(&numSibType, MAX_SIB - 1, 0,
...
Buffer::Iterator RrcAsn1Header::DeserializeRachConfigCommon(
  ...
  bIterator =
      DeserializeEnum(16, &n, bIterator); // preambleInitialReceivedTargetPower
  ...
  bIterator =
      DeserializeEnum(8, &n, bIterator); // mac-ContentionResolutionTimer
...
Buffer::Iterator RrcAsn1Header::DeserializeRadioResourceConfigCommonSib(
  ...
  bIterator = DeserializeSequence(&bitset0, false, bIterator);
  bIterator =
      DeserializeInteger(&n, -60, 50, bIterator);      // referenceSignalPower
...
void RrcConnectionReconfigurationHeader::PreSerialize() const {
  ...
  options.set(
      0, m_haveNonCriticalExtension); // Implemented nonCriticalExtension
...
void HandoverPreparationInfoHeader::PreSerialize() const {
  ...
  SerializeEnum(
      6,
      BandwidthToEnum(
          m_asConfig.sourceMasterInformationBlock.dlBandwidth)); // dl-Bandwidth
  ...
  SerializeBitstring(
      std::bitset<8>(m_asConfig.sourceMasterInformationBlock
