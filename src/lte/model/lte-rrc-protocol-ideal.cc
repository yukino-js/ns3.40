...
void LteUeRrcProtocolIdeal::DoDispose() {
  NS_LOG_FUNCTION(this);
  delete m_ueRrcSapUser;
  m_rrc = nullptr;
}

TypeId LteUeRrcProtocolIdeal::GetTypeId() {
...
void LteUeRrcProtocolIdeal::SetLteUeRrcSapProvider(LteUeRrcSapProvider *p) {
  m_ueRrcSapProvider = p;
}

LteUeRrcSapUser *LteUeRrcProtocolIdeal::GetLteUeRrcSapUser() {
  return m_ueRrcSapUser;
}

void LteUeRrcProtocolIdeal::SetUeRrc(Ptr<LteUeRrc> rrc) { m_rrc = rrc; }
...
void LteUeRrcProtocolIdeal::DoSendRrcConnectionSetupCompleted(
...
void LteUeRrcProtocolIdeal::DoSendRrcConnectionReestablishmentRequest(
...
void LteUeRrcProtocolIdeal::DoSendRrcConnectionReestablishmentComplete(
...
void LteUeRrcProtocolIdeal::DoSendMeasurementReport(
...
void LteUeRrcProtocolIdeal::DoSendIdealUeContextRemoveRequest(uint16_t rnti) {
  NS_LOG_FUNCTION(this);
...
void LteUeRrcProtocolIdeal::SetEnbRrcSapProvider() {
  NS_LOG_FUNCTION(this);
...
LteEnbRrcProtocolIdeal::~LteEnbRrcProtocolIdeal() { NS_LOG_FUNCTION(this); }

void LteEnbRrcProtocolIdeal::DoDispose() {
  NS_LOG_FUNCTION(this);
  delete m_enbRrcSapUser;
}

TypeId LteEnbRrcProtocolIdeal::GetTypeId() {
...
void LteEnbRrcProtocolIdeal::SetLteEnbRrcSapProvider(LteEnbRrcSapProvider *p) {
  m_enbRrcSapProvider = p;
}

LteEnbRrcSapUser *LteEnbRrcProtocolIdeal::GetLteEnbRrcSapUser() {
  return m_enbRrcSapUser;
}

void LteEnbRrcProtocolIdeal::SetCellId(uint16_t cellId) { m_cellId = cellId; }
...
void LteEnbRrcProtocolIdeal::DoSetupUe(
...
void LteEnbRrcProtocolIdeal::DoRemoveUe(uint16_t rnti) {
  NS_LOG_FUNCTION(this << rnti);
...
void LteEnbRrcProtocolIdeal::DoSendRrcConnectionSetup(
...
void LteEnbRrcProtocolIdeal::DoSendRrcConnectionReconfiguration(
...
void LteEnbRrcProtocolIdeal::DoSendRrcConnectionReestablishment(
...
void LteEnbRrcProtocolIdeal::DoSendRrcConnectionReestablishmentReject(
...
void LteEnbRrcProtocolIdeal::DoSendRrcConnectionRelease(
...
void LteEnbRrcProtocolIdeal::DoSendRrcConnectionReject(
...
void IdealHandoverPreparationInfoHeader::SetMsgId(uint32_t id) { m_msgId = id; }

TypeId IdealHandoverPreparationInfoHeader::GetTypeId() {
...
TypeId IdealHandoverPreparationInfoHeader::GetInstanceTypeId() const {
  return GetTypeId();
}
...
void IdealHandoverPreparationInfoHeader::Serialize(
...
Ptr<Packet> LteEnbRrcProtocolIdeal::DoEncodeHandoverPreparationInformation(
...
LteEnbRrcProtocolIdeal::DoDecodeHandoverPreparationInformation(Ptr<Packet> p) {
  ...
  NS_ASSERT_MSG(it != g_handoverPreparationInfoMsgMap.end(),
                "msgId " << msgId << " not found");
...
void IdealHandoverCommandHeader::SetMsgId(uint32_t id) { m_msgId = id; }

TypeId IdealHandoverCommandHeader::GetTypeId() {
...
TypeId IdealHandoverCommandHeader::GetInstanceTypeId() const {
  return GetTypeId();
}
...
uint32_t IdealHandoverCommandHeader::GetSerializedSize() const { return 4; }
...
Ptr<Packet> LteEnbRrcProtocolIdeal::DoEncodeHandoverCommand(
    LteRrcSap::RrcConnectionReconfiguration msg) {
  uint32_t msgId = ++g_handoverCommandMsgIdCounter;
  NS_ASSERT_MSG(g_handoverCommandMsgMap.find(msgId) ==
                    g_handoverCommandMsgMap.end(),
                "msgId " << msgId << " already in use");
  NS_LOG_INFO(" encoding msgId = " << msgId);
...
LteEnbRrcProtocolIdeal::DoDecodeHandoverCommand(Ptr<Packet> p) {
  ...
  NS_ASSERT_MSG(it != g_handoverCommandMsgMap.end(),
                "msgId " << msgId << " not found");
