...
public:
  ...
  struct ErabsSubjectToStatusTransferItem {
    ...
    std::bitset<m_maxPdcpSn>
        receiveStatusOfUlPdcpSdus; ///< receive status of UL PDCP SDUs
  ...
  struct UlHighInterferenceInformationItem {
    ...
    std::vector<bool>
        ulHighInterferenceIndicationList; ///< UL high interference indication
                                          ///< list
  };
  ...
  struct RelativeNarrowbandTxBand {
    ...
    uint16_t pdcchInterferenceImpact{
        UINT16_MAX}; ///< PDC channel interference list
  };
  ...
  struct CellInformationItem {
    ...
    std::vector<UlHighInterferenceInformationItem>
        ulHighInterferenceInformationList; ///< UL high interference information
                                           ///< list
    RelativeNarrowbandTxBand
        relativeNarrowbandTxBand; ///< relative narrow transmit band
  };
  ...
  struct CellMeasurementResultItem {
    ...
    CompositeAvailCapacity
        dlCompositeAvailableCapacity; ///< DL composite available capacity
    CompositeAvailCapacity
        ulCompositeAvailableCapacity; ///< UL composite available capacity
  };
  ...
  struct HandoverRequestParams {
    ...
    uint64_t
        ueAggregateMaxBitRateDownlink; ///< UE aggregate max bit rate downlink
  ...
  struct HandoverRequestAckParams {
    ...
    std::vector<ErabNotAdmittedItem>
        notAdmittedBearers; ///< not admitted bearers
    Ptr<Packet> rrcContext; ///< RRC context
  };
  ...
  struct LoadInformationParams {
    ...
    std::vector<CellInformationItem>
        cellInformationList; ///< cell information list
  };
