...
LteUeComponentCarrierManager::LteUeComponentCarrierManager()
    : m_ccmRrcSapUser(nullptr), m_ccmRrcSapProvider(nullptr),
...
TypeId LteUeComponentCarrierManager::GetTypeId() {
...
void LteUeComponentCarrierManager::DoDispose() { NS_LOG_FUNCTION(this); }

void LteUeComponentCarrierManager::SetLteCcmRrcSapUser(LteUeCcmRrcSapUser *s) {
...
bool LteUeComponentCarrierManager::SetComponentCarrierMacSapProviders(
...
void LteUeComponentCarrierManager::SetNumberOfComponentCarriers(
