...
int main(int argc, char *argv[]) {
  ...
  internet.EnablePcapIpv6("LenaIpv6-Ue-Ue-Ue0.pcap", ueNodes.Get(0)->GetId(), 1,
                          true);
  internet.EnablePcapIpv6("LenaIpv6-Ue-Ue-Ue1.pcap", ueNodes.Get(1)->GetId(), 1,
                          true);
  internet.EnablePcapIpv6("LenaIpv6-Ue-Ue-RH.pcap",
                          remoteHostContainer.Get(0)->GetId(), 1, true);
  internet.EnablePcapIpv6("LenaIpv6-Ue-Ue-Pgw-Iface1.pcap", pgw->GetId(), 1,
                          true);
  internet.EnablePcapIpv6("LenaIpv6-Ue-Ue-Pgw-Iface2.pcap", pgw->GetId(), 2,
                          true);
