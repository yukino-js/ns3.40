...
int main(int argc, char *argv[]) {
  ...
  internet.EnablePcapIpv6("LenaIpv6-Ue-Rh-Ue0.pcap", ueNodes.Get(0)->GetId(), 1,
                          true);
  internet.EnablePcapIpv6("LenaIpv6-Ue-Rh-Ue1.pcap", ueNodes.Get(1)->GetId(), 1,
                          true);
  internet.EnablePcapIpv6("LenaIpv6-Ue-Rh-RH.pcap",
                          remoteHostContainer.Get(0)->GetId(), 1, true);
  internet.EnablePcapIpv6("LenaIpv6-Ue-Rh-Pgw-Iface1.pcap", pgw->GetId(), 1,
                          true);
  internet.EnablePcapIpv6("LenaIpv6-Ue-Rh-Pgw-Iface2.pcap", pgw->GetId(), 2,
                          true);
