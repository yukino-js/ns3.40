...
LenaTestCqaFfMacSchedulerSuite::LenaTestCqaFfMacSchedulerSuite()
  ...
  //  185000 bytes/sec
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(1, 0, 232000, 232000, 200, 1,
                                                 errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(3, 0, 232000, 232000, 200, 1,
                                                 errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(6, 0, 232000, 232000, 200, 1,
                                                 errorModel),
              TestCase::EXTENSIVE);
  ...
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(1, 4800, 232000, 232000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(3, 4800, 232000, 232000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(6, 4800, 230500, 125000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  // AddTestCase (new LenaCqaFfMacSchedulerTestCase1
  ...
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(1, 6000, 232000, 232000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(3, 6000, 232000, 201000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(6, 6000, 198500, 97000, 200, 1,
                                                 errorModel),
              TestCase::EXTENSIVE);
  ...
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(1, 10000, 232000, 232000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(3, 10000, 232000, 137000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaCqaFfMacSchedulerTestCase1(6, 10000, 129166, 67000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  // AddTestCase (new LenaCqaFfMacSchedulerTestCase1
  ...
  AddTestCase(
      new LenaCqaFfMacSchedulerTestCase1(1, 100000, 0, 0, 200, 1, errorModel),
      TestCase::QUICK);
  ...
  AddTestCase(new LenaCqaFfMacSchedulerTestCase2(dist1, estThrCqaDl1,
  ...
  AddTestCase(new LenaCqaFfMacSchedulerTestCase2(dist2, estThrCqaDl2,
  ...
  AddTestCase(new LenaCqaFfMacSchedulerTestCase2(dist3, estThrCqaDl3,
...
std::string LenaCqaFfMacSchedulerTestCase1::BuildNameString(uint16_t nUser,
                                                            double dist) {
...
void LenaCqaFfMacSchedulerTestCase1::DoRun() {
...
std::string
LenaCqaFfMacSchedulerTestCase2::BuildNameString(uint16_t nUser,
...
LenaCqaFfMacSchedulerTestCase2::LenaCqaFfMacSchedulerTestCase2(
    std::vector<double> dist, std::vector<uint32_t> estThrCqaDl,
    ...
    : TestCase(BuildNameString(dist.size(), dist)), m_nUser(dist.size()),
      ...
      m_estThrCqaDl(estThrCqaDl), m_errorModelEnabled(errorModelEnabled) {}

LenaCqaFfMacSchedulerTestCase2::~LenaCqaFfMacSchedulerTestCase2() {}

void LenaCqaFfMacSchedulerTestCase2::DoRun() {
  if (!m_errorModelEnabled) {
    Config::SetDefault("ns3::LteSpectrumPhy::CtrlErrorModelEnabled",
                       BooleanValue(false));
    Config::SetDefault("ns3::LteSpectrumPhy::DataErrorModelEnabled",
  ...
  for (int i = 0; i < m_nUser; i++) {
    NS_TEST_ASSERT_MSG_EQ_TOL(
        (double)dlDataRxed.at(i) / statsDuration, m_estThrCqaDl.at(i),
