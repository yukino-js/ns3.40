...
LteInterferenceFrTestSuite::LteInterferenceFrTestSuite()
  ...
  AddTestCase(new LteInterferenceHardFrTestCase("d1=50, d2=20", 50.000000,
                                                ...
                                                10803.280215),
              TestCase::QUICK);
  AddTestCase(new LteInterferenceHardFrTestCase("d1=50, d2=50", 50.000000,
                                                50.000000, 356449.932732,
                                                10803.280215),
              TestCase::QUICK);
  AddTestCase(new LteInterferenceHardFrTestCase("d1=50, d2=200", 50.000000,
                                                200.000000, 356449.932732,
                                                10803.280215),
              TestCase::QUICK);
  AddTestCase(new LteInterferenceHardFrTestCase("d1=50, d2=500", 50.000000,
                                                500.000000, 356449.932732,
                                                10803.280215),
              TestCase::QUICK);

  AddTestCase(new LteInterferenceStrictFrTestCase(
                  "d1=50, d2=20", 50.000000, 20.000000, 0.160000, 0.159998,
                  356449.932732, 10803.280215, 18),
              TestCase::QUICK);
  AddTestCase(new LteInterferenceStrictFrTestCase(
                  "d1=50, d2=50", 50.000000, 50.000000, 0.999997, 0.999907,
                  356449.932732, 10803.280215, 28),
              TestCase::QUICK);
  AddTestCase(new LteInterferenceStrictFrTestCase(
                  "d1=50, d2=200", 50.000000, 200.000000, 15.999282, 15.976339,
                  356449.932732, 10803.280215, 30),
              TestCase::QUICK);
  AddTestCase(new LteInterferenceStrictFrTestCase(
                  "d1=50, d2=500", 50.000000, 500.000000, 99.971953, 99.082845,
                  356449.932732, 10803.280215, 30),
              TestCase::QUICK);
}
...
void LteInterferenceHardFrTestCase::DoRun() {
  ...
  for (uint32_t i = 0; i < 12; i++) {
    ...
    NS_TEST_ASSERT_MSG_EQ_TOL(dlSinr2, 0, 0.01,
                              "Wrong SINR in DL! (eNB2 --> UE2)");
  }

  for (uint32_t i = 12; i < 24; i++) {
    double dlSinr1 = dlSinr1Catcher.GetValue()->operator[](i);
    NS_TEST_ASSERT_MSG_EQ_TOL(dlSinr1, 0, 0.01,
                              "Wrong SINR in DL! (eNB1 --> UE1)");
...
LteInterferenceStrictFrTestCase::LteInterferenceStrictFrTestCase(
    std::string name, double d1, double d2, double commonDlSinr,
...
void LteInterferenceStrictFrTestCase::DoRun() {
  NS_LOG_INFO(this << GetName());
  ...
  lteHelper->SetFfrAlgorithmAttribute("RsrqThreshold",
                                      UintegerValue(m_rspqThreshold));
  lteHelper->SetFfrAlgorithmAttribute(
      "CenterPowerOffset", UintegerValue(LteRrcSap::PdschConfigDedicated::dB0));
  lteHelper->SetFfrAlgorithmAttribute(
      "EdgePowerOffset", UintegerValue(LteRrcSap::PdschConfigDedicated::dB0));
