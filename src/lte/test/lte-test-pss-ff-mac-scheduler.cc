...
LenaTestPssFfMacSchedulerSuite::LenaTestPssFfMacSchedulerSuite()
  ...
  //  185000 bytes/sec
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(1, 0, 232000, 232000, 200, 1,
                                                 errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(3, 0, 232000, 232000, 200, 1,
                                                 errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(6, 0, 232000, 232000, 200, 1,
                                                 errorModel),
              TestCase::EXTENSIVE);
  ...
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(1, 4800, 232000, 232000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(3, 4800, 232000, 232000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(6, 4800, 230500, 125000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  // AddTestCase (new LenaPssFfMacSchedulerTestCase1
  ...
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(1, 6000, 232000, 232000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(3, 6000, 232000, 201000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(6, 6000, 198500, 97000, 200, 1,
                                                 errorModel),
              TestCase::EXTENSIVE);
  ...
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(1, 10000, 232000, 232000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(3, 10000, 232000, 137000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaPssFfMacSchedulerTestCase1(6, 10000, 129166, 67000, 200,
                                                 1, errorModel),
              TestCase::EXTENSIVE);
  // AddTestCase (new LenaPssFfMacSchedulerTestCase1
  ...
  AddTestCase(
      new LenaPssFfMacSchedulerTestCase1(1, 100000, 0, 0, 200, 1, errorModel),
      TestCase::QUICK);
  ...
  AddTestCase(new LenaPssFfMacSchedulerTestCase2(dist1, estThrPssDl1,
  ...
  AddTestCase(new LenaPssFfMacSchedulerTestCase2(dist2, estThrPssDl2,
  ...
  AddTestCase(new LenaPssFfMacSchedulerTestCase2(dist3, estThrPssDl3,
...
std::string LenaPssFfMacSchedulerTestCase1::BuildNameString(uint16_t nUser,
                                                            double dist) {
...
void LenaPssFfMacSchedulerTestCase1::DoRun() {
...
std::string
LenaPssFfMacSchedulerTestCase2::BuildNameString(uint16_t nUser,
...
LenaPssFfMacSchedulerTestCase2::LenaPssFfMacSchedulerTestCase2(
    std::vector<double> dist, std::vector<uint32_t> estThrPssDl,
...
void LenaPssFfMacSchedulerTestCase2::DoRun() {
  ...
  for (int i = 0; i < m_nUser; i++) {
    NS_TEST_ASSERT_MSG_EQ_TOL(
        (double)dlDataRxed.at(i) / statsDuration, m_estThrPssDl.at(i),
