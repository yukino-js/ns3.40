...
LteUeMeasurementsTestSuite::LteUeMeasurementsTestSuite()
  ...
  AddTestCase(new LteUeMeasurementsTestCase("d1=10, d2=10000", 10.000000,
                                            10000.000000, -53.739702,
                                            -113.739702, -3.010305, -63.010305),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=20, d2=10000", 20.000000,
                                            10000.000000, -59.760302,
                                            -113.739702, -3.010319, -56.989719),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=50, d2=10000", 50.000000,
                                            10000.000000, -67.719102,
                                            -113.739702, -3.010421, -49.031021),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=100, d2=10000", 100.000000,
                                            10000.000000, -73.739702,
                                            -113.739702, -3.010783, -43.010783),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=200, d2=10000", 200.000000,
                                            10000.000000, -79.760302,
                                            -113.739702, -3.012232, -36.991632),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=100, d2=10000", 100.000000,
                                            10000.000000, -73.739702,
                                            -113.739702, -3.010783, -43.010783),
  ...
  AddTestCase(new LteUeMeasurementsTestCase("d1=200, d2=10000", 200.000000,
                                            ...
                                            -113.739702, -3.012232, -36.991632),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=500, d2=10000", 500.000000,
                                            10000.000000, -87.719102,
                                            -113.739702, -3.022359, -29.042959),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=1000, d2=10000", 1000.000000,
                                            10000.000000, -93.739702,
                                            -113.739702, -3.058336, -23.058336),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=2000, d2=10000", 2000.000000,
                                            10000.000000, -99.760302,
                                            -113.739702, -3.199337, -17.178738),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=5000, d2=10000", 5000.000000,
                                            10000.000000, -107.719102,
                                            -113.739702, -4.075793, -10.096393),
              TestCase::QUICK);
  AddTestCase(new LteUeMeasurementsTestCase("d1=10000, d2=10000", 10000.000000,
                                            10000.000000, -113.739702,
                                            -113.739702, -6.257687, -6.257687),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=20000, d2=10000", 20000.000000,
                                            10000.000000, -119.760302,
                                            -113.739702, -10.373365, -4.352765),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase("d1=50000, d2=10000", 50000.000000,
                                            10000.000000, -127.719102,
                                            -113.739702, -17.605046, -3.625645),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase(
                  "d1=100000, d2=10000", 100000.000000, 10000.000000,
                  -133.739702, -113.739702, -23.511071, -3.511071),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase(
                  "d1=200000, d2=10000", 200000.000000, 10000.000000,
                  -139.760302, -113.739702, -29.502549, -3.481949),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase(
                  "d1=500000, d2=10000", 500000.000000, 10000.000000,
                  -147.719102, -113.739702, -37.453160, -3.473760),
              TestCase::EXTENSIVE);
  AddTestCase(new LteUeMeasurementsTestCase(
                  "d1=1000000, d2=10000", 1000000.000000, 10000.000000,
...
LteUeMeasurementsTestCase::LteUeMeasurementsTestCase(
    ...
    : TestCase(name), m_d1(d1), m_d2(d2), m_rsrpDbmUeServingCell(rsrpDbmUe1),
      m_rsrpDbmUeNeighborCell(rsrpDbmUe2), m_rsrqDbUeServingCell(rsrqDbUe1),
      m_rsrqDbUeNeighborCell(rsrqDbUe2) {
  NS_LOG_INFO("Test UE Measurements d1 = " << d1 << " m. and d2 = " << d2
                                           << " m.");
}

LteUeMeasurementsTestCase::~LteUeMeasurementsTestCase() {}

void LteUeMeasurementsTestCase::DoRun() {
  ...
  if (Simulator::Now() > MilliSeconds(400)) {
    if (servingCell) {
      NS_LOG_DEBUG("UE serving cellId " << cellId << " Rxed RSRP " << rsrp
                                        << " thr " << m_rsrpDbmUeServingCell
                                        << " RSRQ " << rsrq << " thr "
                                        << m_rsrqDbUeServingCell);
      NS_TEST_ASSERT_MSG_EQ_TOL(m_rsrpDbmUeServingCell, rsrp, 0.2,
                                "Wrong RSRP UE 1");
      NS_TEST_ASSERT_MSG_EQ_TOL(m_rsrqDbUeServingCell, rsrq, 0.2,
                                "Wrong RSRQ UE 1");
    } else {
      NS_LOG_DEBUG("UE neighbor cellId " << cellId << " Rxed RSRP " << rsrp
                                         << " thr " << m_rsrpDbmUeNeighborCell
                                         << " RSRQ " << rsrq << " thr "
                                         << m_rsrqDbUeNeighborCell);
      NS_TEST_ASSERT_MSG_EQ_TOL(m_rsrpDbmUeNeighborCell, rsrp, 0.2,
                                "Wrong RSRP UE 2");
      NS_TEST_ASSERT_MSG_EQ_TOL(m_rsrqDbUeNeighborCell, rsrq, 0.2,
                                "Wrong RSRQ UE ");
    }
  }
}
  ...
  if (Simulator::Now() > MilliSeconds(400)) {
    if (cellId == imsi) {
      NS_LOG_DEBUG(this << "Serving Cell: received IMSI " << imsi << " CellId "
                        << cellId << " RNTI " << rnti << " thr "
                        << (uint16_t)EutranMeasurementMapping::Dbm2RsrpRange(
                               m_rsrpDbmUeServingCell)
                        << " RSRP "
                        << (uint16_t)meas.measResults.measResultPCell.rsrpResult
                        << " RSRQ "
                        << (uint16_t)meas.measResults.measResultPCell.rsrqResult
                        << " thr "
                        << (uint16_t)EutranMeasurementMapping::Db2RsrqRange(
                               m_rsrqDbUeServingCell));
      ...
      NS_LOG_DEBUG(this << "Neighbor cell: received IMSI " << imsi << " CellId "
                        << cellId << " RNTI " << rnti << " thr "
                        << (uint16_t)EutranMeasurementMapping::Dbm2RsrpRange(
...
LteUeMeasurementsPiecewiseTestSuite1::LteUeMeasurementsPiecewiseTestSuite1()
  ...
  expectedTime.clear();
  expectedTime << 200 << 320 << 440 << 560 << 680 << 800 << 920 << 1040 << 1160
               << 1280 << 1400 << 1520 << 1640 << 1760 << 1880 << 2000 << 2120;
  expectedRsrp.clear();
  expectedRsrp << 67 << 67 << 57 << 57 << 66 << 47 << 47 << 66 << 66 << 57 << 51
               << 51 << 47 << 47 << 51 << 57 << 57;
  ...
  expectedRsrp << 67 << 67 << 57 << 57 << 66 << 66 << 66 << 57 << 57 << 51
               << 67;
  AddTestCase(new LteUeMeasurementsPiecewiseTestCase1(
                  "Piecewise test case 1 - Event A1 with hysteresis", config,
  ...
  AddTestCase(new LteUeMeasurementsPiecewiseTestCase1(
                  "Piecewise test case 1 - Event A2 with hysteresis", config,
                  expectedTime, expectedRsrp),
              TestCase::EXTENSIVE);
  ...
  config.a3Offset = 0;
  AddTestCase(new LteUeMeasurementsPiecewiseTestCase1(
                  "Piecewise test case 1 - Event A3", config, expectedTime,
                  expectedRsrp),
              TestCase::EXTENSIVE);
  ...
  config.threshold1.range = 54;
  AddTestCase(new LteUeMeasurementsPiecewiseTestCase1(
                  "Piecewise test case 1 - Event A4", config, expectedTime,
                  expectedRsrp),
              TestCase::EXTENSIVE);
...
void LteUeMeasurementsPiecewiseTestCase1::DoRun() {
  NS_LOG_INFO(this << " " << GetName());
...
void LteUeMeasurementsPiecewiseTestCase1::DoTeardown() {
  ...
  NS_TEST_ASSERT_MSG_EQ(hasEnded, true,
                        "Reporting should have occurred at "
                            << m_itExpectedTime->As(Time::S));
  hasEnded = m_itExpectedRsrp == m_expectedRsrp.end();
  NS_ASSERT(hasEnded);
}

void LteUeMeasurementsPiecewiseTestCase1::RecvMeasurementReportCallback(
...
void LteUeMeasurementsPiecewiseTestCase1::TeleportNear() {
  NS_LOG_FUNCTION(this);
  m_ueMobility->SetPosition(Vector(300.0, 0.0, 0.0));
}

void LteUeMeasurementsPiecewiseTestCase1::TeleportFar() {
  NS_LOG_FUNCTION(this);
  m_ueMobility->SetPosition(Vector(600.0, 0.0, 0.0));
}

void LteUeMeasurementsPiecewiseTestCase1::TeleportVeryFar() {
  NS_LOG_FUNCTION(this);
...
LteUeMeasurementsPiecewiseTestSuite2::LteUeMeasurementsPiecewiseTestSuite2()
  ...
  expectedTime.clear();
  expectedTime << 200 << 440 << 680 << 920 << 1160 << 1400 << 1640 << 1880
               << 2120;
  expectedRsrp.clear();
  ...
  AddTestCase(new LteUeMeasurementsPiecewiseTestCase2(
                  "Piecewise test case 2 - Event A1 with hysteresis", config,
                  expectedTime, expectedRsrp),
              TestCase::EXTENSIVE);
  ...
  AddTestCase(new LteUeMeasurementsPiecewiseTestCase2(
                  "Piecewise test case 2 - Event A2 with hysteresis", config,
                  expectedTime, expectedRsrp),
              TestCase::EXTENSIVE);
  ...
  expectedRsrp << 52 << 56 << 52 << 56;
  AddTestCase(new LteUeMeasurementsPiecewiseTestCase2(
                  "Piecewise test case 2 - Event A3 with zero offset", config,
                  expectedTime, expectedRsrp),
              TestCase::EXTENSIVE);
  ...
  AddTestCase(new LteUeMeasurementsPiecewiseTestCase2(
                  "Piecewise test case 2 - Event A3 with hysteresis", config,
                  expectedTime, expectedRsrp),
              TestCase::QUICK);
  ...
  AddTestCase(new LteUeMeasurementsPiecewiseTestCase2(
                  "Piecewise test case 2 - Event A4 with hysteresis", config,
                  expectedTime, expectedRsrp),
              TestCase::QUICK);
  ...
  expectedRsrp << 52 << 56 << 52 << 56;
  AddTestCase(
      new LteUeMeasurementsPiecewiseTestCase2(
  ...
  expectedRsrp << 52 << 52 << 56 << 59;
  AddTestCase(new LteUeMeasurementsPiecewiseTestCase2(
                  "Piecewise test case 2 - Event A5 with hysteresis", config,
                  expectedTime, expectedRsrp),
              TestCase::QUICK);
...
void LteUeMeasurementsPiecewiseTestCase2::RecvMeasurementReportCallback(
    std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti,
    LteRrcSap::MeasurementReport report) {
  NS_LOG_FUNCTION(this << context);
  NS_ASSERT(rnti == 1);
...
void LteUeMeasurementsPiecewiseTestCase3::DoRun() {
  NS_LOG_INFO(this << " " << GetName());
...
void LteUeMeasurementsPiecewiseTestCase3::DoTeardown() {
  ...
  NS_TEST_ASSERT_MSG_EQ(hasEnded, true,
                        "Reporting should have occurred at "
                            << m_itExpectedTime->GetSeconds() << "s");
}

void LteUeMeasurementsPiecewiseTestCase3::RecvMeasurementReportCallback(
    std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti,
    LteRrcSap::MeasurementReport report) {
  NS_LOG_FUNCTION(this << context);
  NS_ASSERT(rnti == 1);
...
LteUeMeasurementsHandoverTestSuite::LteUeMeasurementsHandoverTestSuite()
  ...
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - decreasing report interval",
  ...
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - increasing report interval",
                  sourceConfigList, targetConfigList, expectedTime,
                  expectedRsrp, Seconds(2)),
              TestCase::QUICK);
  ...
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A1 to Event A2", sourceConfigList,
  ...
  expectedRsrp.clear();
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A2 to Event A1", sourceConfigList,
                  targetConfigList, expectedTime, expectedRsrp, Seconds(2)),
              TestCase::TAKES_FOREVER);
  ...
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A3 to Event A4", sourceConfigList,
                  targetConfigList, expectedTime, expectedRsrp, Seconds(2)),
              TestCase::TAKES_FOREVER);
  ...
  expectedRsrp << 53 << 53 << 53 << 53;
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A4 to Event A3", sourceConfigList,
                  targetConfigList, expectedTime, expectedRsrp, Seconds(2)),
              TestCase::QUICK);
  ...
  expectedRsrp << 53 << 53 << 53 << 53;
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A2 to Event A3", sourceConfigList,
                  targetConfigList, expectedTime, expectedRsrp, Seconds(2)),
              TestCase::EXTENSIVE);
  ...
  expectedRsrp << 53 << 53 << 53 << 53;
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A3 to Event A2", sourceConfigList,
                  targetConfigList, expectedTime, expectedRsrp, Seconds(2)),
              TestCase::TAKES_FOREVER);
  ...
  expectedRsrp << 53 << 53 << 53 << 53;
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A4 to Event A5", sourceConfigList,
                  targetConfigList, expectedTime, expectedRsrp, Seconds(2)),
              TestCase::TAKES_FOREVER);
  ...
  expectedRsrp << 53 << 53 << 53 << 53;
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A5 to Event A4", sourceConfigList,
                  targetConfigList, expectedTime, expectedRsrp, Seconds(2)),
              TestCase::EXTENSIVE);
  ...
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A1 threshold difference",
                  sourceConfigList, targetConfigList, expectedTime,
                  expectedRsrp, Seconds(2)),
              TestCase::EXTENSIVE);
  ...
  expectedRsrp << 53 << 53 << 53 << 53;
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A2 threshold difference",
                  sourceConfigList, targetConfigList, expectedTime,
                  expectedRsrp, Seconds(2)),
              TestCase::QUICK);
  ...
  expectedRsrp << 55 << 55 << 55 << 55;
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A3 offset difference",
                  sourceConfigList, targetConfigList, expectedTime,
                  expectedRsrp, Seconds(2)),
              TestCase::QUICK);
  ...
  expectedRsrp << 55 << 55 << 55 << 55;
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A4 threshold difference",
                  sourceConfigList, targetConfigList, expectedTime,
                  expectedRsrp, Seconds(2)),
              TestCase::EXTENSIVE);
  ...
  expectedRsrp.clear();
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - Event A5 threshold difference",
                  sourceConfigList, targetConfigList, expectedTime,
                  expectedRsrp, Seconds(2)),
              TestCase::EXTENSIVE);
  ...
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - decreasing TTT (short)",
                  sourceConfigList, targetConfigList, expectedTime,
                  expectedRsrp, Seconds(2)),
              TestCase::QUICK);
  ...
  expectedTime.clear();
  expectedTime << 1224 << 1464 << 1704 << 1944 << 2840 << 3080 << 3320 << 3560
               << 3800 << 4040;
  expectedRsrp.clear();
  expectedRsrp << 55 << 55 << 55 << 55 << 53 << 53 << 53 << 53 << 53 << 53;
  AddTestCase(new LteUeMeasurementsHandoverTestCase(
                  "Handover test case - decreasing TTT (long)",
                  sourceConfigList, targetConfigList, expectedTime,
...
void LteUeMeasurementsHandoverTestCase::DoRun() {
  NS_LOG_INFO(this << " " << GetName());
...
void LteUeMeasurementsHandoverTestCase::RecvMeasurementReportCallback(
    std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti,
    LteRrcSap::MeasurementReport report) {
