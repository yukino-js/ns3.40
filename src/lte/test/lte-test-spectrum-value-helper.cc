...
void LteSpectrumModelTestCase::DoRun() {
...
LteNoisePsdTestCase::LteNoisePsdTestCase(const char *str, uint16_t earfcn,
                                         uint8_t bw, double noiseFigureDb,
                                         SpectrumValue &expected)
    : TestCase(str),
      m_actual(LteSpectrumValueHelper::CreateNoisePowerSpectralDensity(
          earfcn, bw, noiseFigureDb)),
...
void LteNoisePsdTestCase::DoRun() {
...
LteTxPsdTestCase::LteTxPsdTestCase(const char *str, uint16_t earfcn, uint8_t bw,
                                   double txPowerDbm,
                                   std::vector<int> activeRbs,
                                   SpectrumValue &expected)
    : TestCase(str),
      m_actual(LteSpectrumValueHelper::CreateTxPowerSpectralDensity(
          earfcn, bw, txPowerDbm, activeRbs)),
      m_expected(Create<SpectrumValue>(expected)) {
...
LteSpectrumValueHelperTestSuite::LteSpectrumValueHelperTestSuite()
  ...
  AddTestCase(
      new LteSpectrumModelTestCase("fc2160nrb100", 500, 100, fc2160nrb100),
      TestCase::QUICK);
  ...
  AddTestCase(
      new LteSpectrumModelTestCase("fc1730nrb15", 19400, 15, fc1730nrb15),
      TestCase::QUICK);
  ...
  AddTestCase(
      new LteSpectrumModelTestCase("fc1730nrb25", 19400, 25, fc1730nrb25),
      TestCase::QUICK);
  ...
  AddTestCase(
      new LteSpectrumModelTestCase("fc1730nrb50", 19400, 50, fc1730nrb50),
      TestCase::QUICK);
  ...
  AddTestCase(
      new LteSpectrumModelTestCase("fc1730nrb75", 19400, 75, fc1730nrb75),
      TestCase::QUICK);
  ...
  AddTestCase(
      new LteSpectrumModelTestCase("fc1730nrb100", 19400, 100, fc1730nrb100),
      TestCase::QUICK);

  SpectrumValue nfdB0earfcn500nrb6(
  ...
  AddTestCase(new LteNoisePsdTestCase("nfdB0earfcn500nrb6", 500, 6, 0.000000,
                                      nfdB0earfcn500nrb6),
              TestCase::QUICK);

  SpectrumValue nfdB5earfcn500nrb6(
      LteSpectrumValueHelper::GetSpectrumModel(500, 6));
  ...
  AddTestCase(new LteNoisePsdTestCase("nfdB5earfcn500nrb6", 500, 6, 5.000000,
                                      nfdB5earfcn500nrb6),
              TestCase::QUICK);

  SpectrumValue nfdB10earfcn500nrb6(
      LteSpectrumValueHelper::GetSpectrumModel(500, 6));
  ...
  AddTestCase(new LteNoisePsdTestCase("nfdB10earfcn500nrb6", 500, 6, 10.000000,
                                      nfdB10earfcn500nrb6),
              TestCase::QUICK);

  SpectrumValue nfdB0earfcn500nrb15(
      LteSpectrumValueHelper::GetSpectrumModel(500, 15));
  ...
  AddTestCase(new LteNoisePsdTestCase("nfdB0earfcn500nrb15", 500, 15, 0.000000,
                                      nfdB0earfcn500nrb15),
              TestCase::QUICK);

  SpectrumValue nfdB5earfcn500nrb15(
      LteSpectrumValueHelper::GetSpectrumModel(500, 15));
  ...
  AddTestCase(new LteNoisePsdTestCase("nfdB5earfcn500nrb15", 500, 15, 5.000000,
                                      nfdB5earfcn500nrb15),
              TestCase::QUICK);

  SpectrumValue nfdB10earfcn500nrb15(
      LteSpectrumValueHelper::GetSpectrumModel(500, 15));
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB10nrb6run1earfcn500", 500, 6,
                                   10.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB30nrb6run1earfcn500", 500, 6,
                                   30.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB10nrb25run1earfcn500", 500, 25,
                                   10.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB30nrb25run1earfcn500", 500, 25,
                                   30.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB10nrb100run1earfcn500", 500, 100,
                                   10.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB30nrb100run1earfcn500", 500, 100,
                                   30.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB10nrb6run2earfcn500", 500, 6,
                                   10.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB30nrb6run2earfcn500", 500, 6,
                                   30.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB10nrb25run2earfcn500", 500, 25,
                                   10.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB30nrb25run2earfcn500", 500, 25,
                                   30.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB10nrb100run2earfcn500", 500, 100,
                                   10.000000,
  ...
  AddTestCase(new LteTxPsdTestCase("txpowdB30nrb100run2earfcn500", 500, 100,
                                   30.000000,
