...
std::string LteX2HandoverMeasuresTestCase::BuildNameString(
    ...
    std::string checkPointEventListName, bool useUdp, std::string schedulerType,
    std::string handoverAlgorithmType, bool admitHo, bool useIdealRrc) {
  std::ostringstream oss;
  oss << "nEnbs=" << nEnbs << " nUes=" << nUes
      << " nDedicatedBearers=" << nDedicatedBearers << " udp=" << useUdp << " "
      << schedulerType << " " << handoverAlgorithmType << " admitHo=" << admitHo
...
LteX2HandoverMeasuresTestCase::LteX2HandoverMeasuresTestCase(
    ...
    : TestCase(BuildNameString(nEnbs, nUes, nDedicatedBearers,
      ...
      m_nEnbs(nEnbs), m_nUes(nUes), m_nDedicatedBearers(nDedicatedBearers),
      m_checkPointEventList(checkPointEventList),
      m_checkPointEventListName(checkPointEventListName), m_epc(true),
      m_useUdp(useUdp), m_schedulerType(schedulerType),
      m_handoverAlgorithmType(handoverAlgorithmType), m_admitHo(admitHo),
      m_useIdealRrc(useIdealRrc), m_maxHoDuration(Seconds(0.1)),
      m_statsDuration(Seconds(0.5)), m_udpClientInterval(Seconds(0.01)),
      m_udpClientPktSize(100) {}

void LteX2HandoverMeasuresTestCase::DoRun() {
  NS_LOG_FUNCTION(this << BuildNameString(
                      m_nEnbs, m_nUes, m_nDedicatedBearers,
...
void LteX2HandoverMeasuresTestCase::CheckConnected(Ptr<NetDevice> ueDevice,
...
void LteX2HandoverMeasuresTestCase::SaveStats(uint32_t ueIndex) {
...
void LteX2HandoverMeasuresTestCase::CheckStats(uint32_t ueIndex) {
  NS_LOG_FUNCTION(ueIndex);
  uint32_t b = 1;
  for (auto it = m_ueDataVector.at(ueIndex).bearerDataList.begin();
       it != m_ueDataVector.at(ueIndex).bearerDataList.end(); ++it) {
    ...
    double expectedBytes = m_udpClientPktSize *
...
LteX2HandoverMeasuresTestSuite::LteX2HandoverMeasuresTestSuite()
  ...
  for (auto useIdealRrc : {true, false}) {
    ...
    AddTestCase(new LteX2HandoverMeasuresTestCase(2, 1, 1, cel1, cel1name, true,
                                                  sched, ho, true, useIdealRrc),
                TestCase::QUICK);
    AddTestCase(new LteX2HandoverMeasuresTestCase(2, 1, 2, cel1, cel1name, true,
                                                  sched, ho, true, useIdealRrc),
                TestCase::TAKES_FOREVER);
    AddTestCase(new LteX2HandoverMeasuresTestCase(3, 1, 0, cel2, cel2name, true,
                                                  sched, ho, true, useIdealRrc),
                TestCase::TAKES_FOREVER);
    AddTestCase(new LteX2HandoverMeasuresTestCase(3, 1, 1, cel2, cel2name, true,
                                                  sched, ho, true, useIdealRrc),
                TestCase::TAKES_FOREVER);
    AddTestCase(new LteX2HandoverMeasuresTestCase(3, 1, 2, cel2, cel2name, true,
                                                  sched, ho, true, useIdealRrc),
                TestCase::EXTENSIVE);
    AddTestCase(new LteX2HandoverMeasuresTestCase(4, 1, 0, cel3, cel3name, true,
                                                  sched, ho, true, useIdealRrc),
                TestCase::EXTENSIVE);
    AddTestCase(new LteX2HandoverMeasuresTestCase(4, 1, 1, cel3, cel3name, true,
                                                  sched, ho, true, useIdealRrc),
                TestCase::TAKES_FOREVER);
    AddTestCase(new LteX2HandoverMeasuresTestCase(4, 1, 2, cel3, cel3name, true,
                                                  sched, ho, true, useIdealRrc),
                TestCase::TAKES_FOREVER);
  }
