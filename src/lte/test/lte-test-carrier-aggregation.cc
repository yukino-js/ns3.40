...
TestCarrierAggregationSuite::TestCarrierAggregationSuite()
                                                  ...
                                                  // file
  {
    std::cout << "\n Running TestCarrierAggregationSuite with activated option "
              ...
              << dlResultsFileName << " and uplink results to "
              << ulResultsFileName << std::endl;
    ...
    AddTestCase(new CarrierAggregationTestCase(1, 0, 100, 100, 1),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(3, 0, 100, 100, 1),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(6, 0, 100, 100, 1),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(9, 0, 100, 100, 1),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(12, 0, 100, 100, 1),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(15, 0, 100, 100, 1),
                TestCase::QUICK);

    AddTestCase(new CarrierAggregationTestCase(1, 0, 100, 100, 2),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(3, 0, 100, 100, 2),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(6, 0, 100, 100, 2),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(9, 0, 100, 100, 2),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(12, 0, 100, 100, 2),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(15, 0, 100, 100, 2),
                TestCase::QUICK);

    AddTestCase(new CarrierAggregationTestCase(1, 0, 100, 100, 3),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(3, 0, 100, 100, 3),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(6, 0, 100, 100, 3),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(9, 0, 100, 100, 3),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(12, 0, 100, 100, 3),
                TestCase::QUICK);
    ...
    AddTestCase(new CarrierAggregationTestCase(3, 0, 25, 25, 2),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(6, 0, 25, 25, 2),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(9, 0, 25, 25, 2),
                TestCase::EXTENSIVE);
    ...
    AddTestCase(new CarrierAggregationTestCase(1, 4800, 25, 25, 2),
                TestCase::QUICK);
    ...
    AddTestCase(new CarrierAggregationTestCase(3, 0, 25, 25, 3),
                TestCase::QUICK);
    AddTestCase(new CarrierAggregationTestCase(6, 0, 25, 25, 3),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(9, 0, 25, 25, 3),
                TestCase::EXTENSIVE);
    ...
    AddTestCase(new CarrierAggregationTestCase(1, 4800, 25, 25, 3),
                TestCase::QUICK);
    ...
    AddTestCase(new CarrierAggregationTestCase(3, 0, 6, 6, 3),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(6, 0, 6, 6, 3),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(9, 0, 6, 6, 3),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(12, 0, 6, 6, 3),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(15, 0, 6, 6, 3),
                TestCase::EXTENSIVE);

    AddTestCase(new CarrierAggregationTestCase(1, 4800, 6, 6, 3),
                TestCase::QUICK);
    ...
    AddTestCase(new CarrierAggregationTestCase(3, 0, 6, 6, 2),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(6, 0, 6, 6, 2),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(9, 0, 6, 6, 2),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(12, 0, 6, 6, 2),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(15, 0, 6, 6, 2),
                TestCase::EXTENSIVE);
    ...
    AddTestCase(new CarrierAggregationTestCase(12, 6000, 6, 6, 2),
                TestCase::EXTENSIVE);
    AddTestCase(new CarrierAggregationTestCase(15, 6000, 6, 6, 2),
                TestCase::QUICK);
...
std::string CarrierAggregationTestCase::BuildNameString(
    uint16_t nUser, uint16_t dist, uint32_t dlBandwidth, uint32_t ulBandwidth,
...
CarrierAggregationTestCase::CarrierAggregationTestCase(
    uint16_t nUser, uint16_t dist, uint32_t dlbandwidth, uint32_t ulBandwidth,
    uint32_t numberOfComponentCarriers)
    : TestCase(BuildNameString(nUser, dist, dlbandwidth, ulBandwidth,
                               numberOfComponentCarriers)),
      m_nUser(nUser), m_dist(dist), m_dlBandwidth(dlbandwidth),
...
void CarrierAggregationTestCase::DoRun() {
  ...
  Config::SetDefault("ns3::LteEnbNetDevice::DlBandwidth",
                     UintegerValue(m_dlBandwidth));
  Config::SetDefault("ns3::LteEnbNetDevice::UlBandwidth",
                     UintegerValue(m_ulBandwidth));
  ...
  for (auto itDownlink = m_ccDownlinkTraffic.begin();
  ...
  for (auto itUplink = m_ccUplinkTraffic.begin();
...
void CarrierAggregationTestCase::DlScheduling(DlSchedulingCallbackInfo dlInfo) {
  ...
  if (Simulator::Now() > MilliSeconds(300)) {
    if (m_ccDownlinkTraffic.find(dlInfo.componentCarrierId) ==
      ...
      m_ccDownlinkTraffic[dlInfo.componentCarrierId] +=
  ...
  if (Simulator::Now() > MilliSeconds(300)) {
    if (m_ccUplinkTraffic.find(componentCarrierId) == m_ccUplinkTraffic.end()) {
      m_ccUplinkTraffic.insert(
          std::pair<uint8_t, uint32_t>(componentCarrierId, sizeTb));
    } else {
