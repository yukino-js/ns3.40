...
LteDownlinkSinrTestSuite::LteDownlinkSinrTestSuite()
  ...
  AddTestCase(new LteDownlinkDataSinrTestCase(rxPsd1, theoreticalSinr1,
                                              "sdBm = [-46 -48]"),
              TestCase::QUICK);
  AddTestCase(new LteDownlinkCtrlSinrTestCase(rxPsd1, theoreticalSinr1,
                                              "sdBm = [-46 -48]"),
              TestCase::QUICK);
  ...
  AddTestCase(new LteDownlinkDataSinrTestCase(rxPsd2, theoreticalSinr2,
                                              "sdBm = [-63 -61]"),
              TestCase::QUICK);
  AddTestCase(new LteDownlinkCtrlSinrTestCase(rxPsd2, theoreticalSinr2,
                                              "sdBm = [-63 -61]"),
              TestCase::QUICK);
}
...
LteDownlinkDataSinrTestCase::LteDownlinkDataSinrTestCase(
    ...
    : TestCase("SINR calculation in downlink Data frame: " + name), m_sv(sv),
      m_sm(sv->GetSpectrumModel()), m_expectedSinr(sinr) {
...
void LteDownlinkDataSinrTestCase::DoRun() {
  ...
  Ptr<LteSpectrumSignalParametersDataFrame> ip1 =
      Create<LteSpectrumSignalParametersDataFrame>();
  ip1->psd = i1;
  ip1->txPhy = nullptr;
  ip1->duration = di1;
  ...
  Ptr<LteSpectrumSignalParametersDataFrame> ip2 =
      Create<LteSpectrumSignalParametersDataFrame>();
  ip2->psd = i2;
  ip2->txPhy = nullptr;
  ip2->duration = di2;
  ...
  Ptr<LteSpectrumSignalParametersDataFrame> ip3 =
      Create<LteSpectrumSignalParametersDataFrame>();
  ip3->psd = i3;
  ip3->txPhy = nullptr;
  ip3->duration = di3;
  ...
  Ptr<LteSpectrumSignalParametersDataFrame> ip4 =
      Create<LteSpectrumSignalParametersDataFrame>();
  ip4->psd = i4;
  ip4->txPhy = nullptr;
  ip4->duration = di4;
