...
private:
  ...
  LteRrcSap::PdschConfigDedicated
      m_pdschConfigDedicated; ///< PDSCH config dedicated
...
private:
  ...
  bool m_changePdschConfigDedicatedTriggered; ///< change PDSCH config dedicated
                                              ///< triggered?
  bool m_connectionReconfigurationUeReceived; ///< connection reconfiguration UE
                                              ///< received?
