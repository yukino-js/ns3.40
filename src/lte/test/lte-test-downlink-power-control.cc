...
LteDownlinkPowerControlTestSuite::LteDownlinkPowerControlTestSuite()
  ...
  // Spectrum helper test
  {
    ...
    rbTxPower =
        CalculateRbTxPower(powerTx, LteRrcSap::PdschConfigDedicated::dB_6);
    powerTxMap.insert(std::pair<int, double>(0, rbTxPower));

    rbTxPower =
        CalculateRbTxPower(powerTx, LteRrcSap::PdschConfigDedicated::dB_3);
    powerTxMap.insert(std::pair<int, double>(2, rbTxPower));

    rbTxPower =
        CalculateRbTxPower(powerTx, LteRrcSap::PdschConfigDedicated::dB0);
    powerTxMap.insert(std::pair<int, double>(3, rbTxPower));

    rbTxPower =
        CalculateRbTxPower(powerTx, LteRrcSap::PdschConfigDedicated::dB2);
    ...
    AddTestCase(new LteDownlinkPowerControlSpectrumValueTestCase(
                    "txpowdB30nrb6run1earfcn500_allRbPower", earfcn, bw,
                    powerTx, powerTxMap, activeRbs_txpowdB30nrb6run1earfcn500,
  ...
  }
  {
    ...
    AddTestCase(new LteDownlinkPowerControlSpectrumValueTestCase(
                    "txpowdB30nrb6run1earfcn500", earfcn, bw, powerTx,
  ...
  }
  {
    ...
    powerTxMap.insert(std::pair<int, double>(0, rbTxPower));
    rbTxPower =
        CalculateRbTxPower(powerTx, LteRrcSap::PdschConfigDedicated::dB_4dot77);
    powerTxMap.insert(std::pair<int, double>(1, rbTxPower));
    rbTxPower =
        CalculateRbTxPower(powerTx, LteRrcSap::PdschConfigDedicated::dB_6);
    powerTxMap.insert(std::pair<int, double>(2, rbTxPower));
    rbTxPower =
        CalculateRbTxPower(powerTx, LteRrcSap::PdschConfigDedicated::dB1);
    powerTxMap.insert(std::pair<int, double>(3, rbTxPower));
    rbTxPower =
        CalculateRbTxPower(powerTx, LteRrcSap::PdschConfigDedicated::dB2);
    ...
    rbTxPower =
        CalculateRbTxPower(powerTx, LteRrcSap::PdschConfigDedicated::dB_1dot77);
    ...
    rbTxPower =
        CalculateRbTxPower(powerTx, LteRrcSap::PdschConfigDedicated::dB3);
    ...
    AddTestCase(new LteDownlinkPowerControlSpectrumValueTestCase(
                    "txpowdB30nrb25run1earfcn500_allRbPower", earfcn, bw,
                    powerTx, powerTxMap, activeRbs_txpowdB30nrb25run1earfcn500,
  ...
  }
  {
    ...
    AddTestCase(new LteDownlinkPowerControlSpectrumValueTestCase(
                    "txpowdB30nrb25run1earfcn500", earfcn, bw, powerTx,
  ...
  AddTestCase(new LteDownlinkPowerControlTestCase(
              ...
              TestCase::QUICK);
  AddTestCase(new LteDownlinkPowerControlTestCase(
                  true, LteRrcSap::PdschConfigDedicated::dB_6,
                  "DataCtrlPowerDifference_dB_6"),
              TestCase::QUICK);
  AddTestCase(new LteDownlinkPowerControlTestCase(
                  true, LteRrcSap::PdschConfigDedicated::dB_4dot77,
                  "DataCtrlPowerDifference_dB_4dot77"),
              TestCase::QUICK);
  AddTestCase(new LteDownlinkPowerControlTestCase(
                  true, LteRrcSap::PdschConfigDedicated::dB_3,
                  "DataCtrlPowerDifference_dB_3"),
              TestCase::QUICK);
  AddTestCase(new LteDownlinkPowerControlTestCase(
                  true, LteRrcSap::PdschConfigDedicated::dB_1dot77,
                  "DataCtrlPowerDifference_dB_1dot77"),
              TestCase::QUICK);
  AddTestCase(new LteDownlinkPowerControlTestCase(
                  true, LteRrcSap::PdschConfigDedicated::dB0,
                  "DataCtrlPowerDifference_dB0"),
              TestCase::QUICK);
  AddTestCase(new LteDownlinkPowerControlTestCase(
                  true, LteRrcSap::PdschConfigDedicated::dB1,
                  "DataCtrlPowerDifference_dB1"),
              TestCase::QUICK);
  AddTestCase(new LteDownlinkPowerControlTestCase(
                  true, LteRrcSap::PdschConfigDedicated::dB2,
                  "DataCtrlPowerDifference_dB2"),
              TestCase::QUICK);
  AddTestCase(new LteDownlinkPowerControlTestCase(
                  true, LteRrcSap::PdschConfigDedicated::dB3,
...
double LteDownlinkPowerControlTestSuite::CalculateRbTxPower(double txPower,
                                                            uint8_t pa) {
  LteRrcSap::PdschConfigDedicated pdschConfigDedicated;
  pdschConfigDedicated.pa = pa;
  double rbTxpower = txPower + LteRrcSap::ConvertPdschConfigDedicated2Double(
...
LteDownlinkPowerControlSpectrumValueTestCase::
    LteDownlinkPowerControlSpectrumValueTestCase(
        std::string name, uint16_t earfcn, uint16_t bw, double powerTx,
        std::map<int, double> powerTxMap, std::vector<int> activeRbs,
        SpectrumValue &expected)
    : TestCase("Downlink Power Control: " + name),
      m_actual(LteSpectrumValueHelper::CreateTxPowerSpectralDensity(
          earfcn, bw, powerTx, powerTxMap, activeRbs)),
...
void LteDownlinkPowerControlSpectrumValueTestCase::DoRun() {
...
LteDownlinkPowerControlTestCase::LteDownlinkPowerControlTestCase(
    bool changePower, uint8_t pa, std::string name)
    : TestCase("Downlink Power Control: " + name) {
...
void LteDownlinkPowerControlTestCase::DoRun() {
  Config::Reset();
  ...
  Ptr<LteFfrSimple> simpleFfrAlgorithm =
      DynamicCast<LteFfrSimple>(tmp.GetObject());
  ...
  testDlDataPowerReceived->AddCallback(MakeCallback(
      &LteSpectrumValueCatcher::ReportValue, &dlDataPowerReceivedCatcher));
  ue1Phy->GetDownlinkSpectrumPhy()->AddDataPowerChunkProcessor(
  ...
  testDlCtrlPowerReceived->AddCallback(MakeCallback(
      &LteSpectrumValueCatcher::ReportValue, &dlCtrlPowerReceivedCatcher));
  ue1Phy->GetDownlinkSpectrumPhy()->AddRsPowerChunkProcessor(
  ...
  double dataPower =
      10.0 * std::log10(dlDataPowerReceivedCatcher.GetValue()->operator[](0));
  double ctrlPower =
      10.0 * std::log10(dlCtrlPowerReceivedCatcher.GetValue()->operator[](0));
...
void NotifyConnectionReconfigurationUe(
...
void NotifyConnectionReconfigurationEnb(
    LteDownlinkPowerControlRrcConnectionReconfigurationTestCase *testcase,
    std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti) {
  testcase->ConnectionReconfigurationEnb(context, imsi, cellId, rnti);
}

void ChangePdschConfigDedicatedCallback(
    LteDownlinkPowerControlRrcConnectionReconfigurationTestCase *testcase,
...
LteDownlinkPowerControlRrcConnectionReconfigurationTestCase::
    LteDownlinkPowerControlRrcConnectionReconfigurationTestCase(
        bool useIdealRrc, std::string name)
    : TestCase("Downlink Power Control: " + name), m_useIdealRrc(useIdealRrc),
...
void LteDownlinkPowerControlRrcConnectionReconfigurationTestCase::
    ConnectionReconfigurationEnb(std::string context, uint64_t imsi,
...
void LteDownlinkPowerControlRrcConnectionReconfigurationTestCase::
    ConnectionReconfigurationUe(std::string context, uint64_t imsi,
                                uint16_t cellid, uint16_t rnti) {
  if (Simulator::Now() > MilliSeconds(100)) {
