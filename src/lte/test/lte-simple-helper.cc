...
void LteSimpleHelper::DoInitialize() {
  NS_LOG_FUNCTION(this);
...
LteSimpleHelper::~LteSimpleHelper() { NS_LOG_FUNCTION(this); }
...
void LteSimpleHelper::DoDispose() {
  NS_LOG_FUNCTION(this);
...
NetDeviceContainer LteSimpleHelper::InstallUeDevice(NodeContainer c) {
  NS_LOG_FUNCTION(this);
  NetDeviceContainer devices;
  for (auto i = c.Begin(); i != c.End(); ++i) {
    Ptr<Node> node = *i;
...
Ptr<NetDevice> LteSimpleHelper::InstallSingleEnbDevice(Ptr<Node> n) {
  NS_LOG_FUNCTION(this);
  ...
  Ptr<LteSimpleNetDevice> enbDev =
      m_enbDeviceFactory.Create<LteSimpleNetDevice>();
...
Ptr<NetDevice> LteSimpleHelper::InstallSingleUeDevice(Ptr<Node> n) {
  NS_LOG_FUNCTION(this);
  ...
  Ptr<LteSimpleNetDevice> ueDev =
      m_ueDeviceFactory.Create<LteSimpleNetDevice>();
...
void LteSimpleHelper::EnableLogComponents() {
  auto level = (LogLevel)(LOG_LEVEL_ALL | LOG_PREFIX_TIME | LOG_PREFIX_NODE |
                          LOG_PREFIX_FUNC);
