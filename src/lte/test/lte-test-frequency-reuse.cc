...
LteFrequencyReuseTestSuite::LteFrequencyReuseTestSuite()
  ...
  AddTestCase(new LteHardFrTestCase("DownlinkHardFrPf1", 1,
                                    "ns3::PfFfMacScheduler", 25, 25, 0, 12, 0,
                                    12, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteHardFrTestCase("DownlinkHardFrPf2", 5,
                                    "ns3::PfFfMacScheduler", 25, 25, 0, 12, 0,
                                    12, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteHardFrTestCase("DownlinkHardFrPss1", 1,
                                    "ns3::PssFfMacScheduler", 25, 25, 0, 12, 0,
                                    12, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteHardFrTestCase("DownlinkHardFrPss2", 5,
                                    "ns3::PssFfMacScheduler", 25, 25, 0, 12, 0,
                                    12, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteHardFrTestCase("DownlinkHardFrCqa1", 1,
                                    "ns3::CqaFfMacScheduler", 25, 25, 0, 12, 0,
                                    12, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteHardFrTestCase("DownlinkHardFrCqa2", 5,
                                    "ns3::CqaFfMacScheduler", 25, 25, 0, 12, 0,
                                    12, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteHardFrTestCase("DownlinkHardFrFdTbfq1", 1,
                                    "ns3::FdTbfqFfMacScheduler", 25, 25, 0, 12,
                                    0, 12, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteHardFrTestCase("DownlinkHardFrFdTbfq2", 5,
                                    "ns3::FdTbfqFfMacScheduler", 25, 25, 0, 12,
                                    0, 12, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteHardFrTestCase("DownlinkHardFrTdTbfq1", 1,
                                    "ns3::TdTbfqFfMacScheduler", 25, 25, 0, 12,
                                    0, 12, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteHardFrTestCase("DownlinkHardFrTdTbfq2", 5,
                                    "ns3::TdTbfqFfMacScheduler", 25, 25, 0, 12,
                                    0, 12, availableDlRb, availableUlRb),
              TestCase::QUICK);
  ...
  AddTestCase(new LteStrictFrTestCase("DownlinkStrictFrPf1", 1,
                                      "ns3::PfFfMacScheduler", 25, 25, 6, 6, 6,
                                      6, 6, 6, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteStrictFrTestCase("DownlinkStrictFrPf2", 5,
                                      "ns3::PfFfMacScheduler", 25, 25, 6, 6, 6,
                                      6, 6, 6, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteStrictFrTestCase("DownlinkStrictFrPss1", 1,
                                      "ns3::PssFfMacScheduler", 25, 25, 6, 6, 6,
                                      6, 6, 6, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteStrictFrTestCase("DownlinkStrictFrPss2", 5,
                                      "ns3::PssFfMacScheduler", 25, 25, 6, 6, 6,
                                      6, 6, 6, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteStrictFrTestCase("DownlinkStrictFrCqa1", 1,
                                      "ns3::CqaFfMacScheduler", 25, 25, 6, 6, 6,
                                      6, 6, 6, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteStrictFrTestCase("DownlinkStrictFrCqa2", 5,
                                      "ns3::CqaFfMacScheduler", 25, 25, 6, 6, 6,
                                      6, 6, 6, availableDlRb, availableUlRb),
              TestCase::QUICK);
  AddTestCase(new LteStrictFrTestCase("DownlinkStrictFrCqaFdTbfq1", 1,
                                      "ns3::FdTbfqFfMacScheduler", 25, 25, 6, 6,
                                      6, 6, 6, 6, availableDlRb, availableUlRb),
              TestCase::QUICK);
  ...
  AddTestCase(new LteStrictFrTestCase("DownlinkStrictFrCqaTdTbfq1", 1,
                                      "ns3::TdTbfqFfMacScheduler", 25, 25, 6, 6,
                                      6, 6, 6, 6, availableDlRb, availableUlRb),
              TestCase::QUICK);
  ...
  AddTestCase(new LteStrictFrAreaTestCase("LteStrictFrAreaTestCasePf1",
                                          "ns3::PfFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteStrictFrAreaTestCase("LteStrictFrAreaTestCasePss1",
                                          "ns3::PssFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteStrictFrAreaTestCase("LteStrictFrAreaTestCaseCqa1",
                                          "ns3::CqaFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteStrictFrAreaTestCase("LteStrictFrAreaTestCaseFdTbfq1",
                                          "ns3::FdTbfqFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteStrictFrAreaTestCase("LteStrictFrAreaTestCaseTdTbfq1",
                                          "ns3::TdTbfqFfMacScheduler"),
              TestCase::QUICK);

  AddTestCase(new LteSoftFrAreaTestCase("LteSoftFrAreaTestCasePf1",
                                        "ns3::PfFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteSoftFrAreaTestCase("LteSoftFrAreaTestCasePss1",
                                        "ns3::PssFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteSoftFrAreaTestCase("LteSoftFrAreaTestCaseCqa1",
                                        "ns3::CqaFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteSoftFrAreaTestCase("LteSoftFrAreaTestCaseFdTbfq1",
                                        "ns3::FdTbfqFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteSoftFrAreaTestCase("LteSoftFrAreaTestCaseTdTbfq1",
                                        "ns3::TdTbfqFfMacScheduler"),
              TestCase::QUICK);

  AddTestCase(new LteSoftFfrAreaTestCase("LteSoftFfrAreaTestCasePf1",
                                         "ns3::PfFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteSoftFfrAreaTestCase("LteSoftFfrAreaTestCasePss1",
                                         "ns3::PssFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteSoftFfrAreaTestCase("LteSoftFfrAreaTestCaseCqa1",
                                         "ns3::CqaFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteSoftFfrAreaTestCase("LteSoftFfrAreaTestCaseFdTbfq1",
                                         "ns3::FdTbfqFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteSoftFfrAreaTestCase("LteSoftFfrAreaTestCaseTdTbfq1",
                                         "ns3::TdTbfqFfMacScheduler"),
              TestCase::QUICK);

  AddTestCase(new LteEnhancedFfrAreaTestCase("LteEnhancedFfrAreaTestCasePf1",
                                             "ns3::PfFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteEnhancedFfrAreaTestCase("LteEnhancedFfrAreaTestCasePss1",
                                             "ns3::PssFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(new LteEnhancedFfrAreaTestCase("LteEnhancedFfrAreaTestCaseCqa1",
                                             "ns3::CqaFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(
      new LteEnhancedFfrAreaTestCase("LteEnhancedFfrAreaTestCaseFdTbfq1",
                                     "ns3::FdTbfqFfMacScheduler"),
      TestCase::QUICK);
  AddTestCase(
      new LteEnhancedFfrAreaTestCase("LteEnhancedFfrAreaTestCaseTdTbfq1",
                                     "ns3::TdTbfqFfMacScheduler"),
      TestCase::QUICK);

  AddTestCase(new LteDistributedFfrAreaTestCase(
                  "LteDistributedFfrAreaTestCasePf1", "ns3::PfFfMacScheduler"),
              TestCase::QUICK);
  AddTestCase(
      new LteDistributedFfrAreaTestCase("LteDistributedFfrAreaTestCasePss1",
                                        "ns3::PssFfMacScheduler"),
      TestCase::QUICK);
  AddTestCase(
      new LteDistributedFfrAreaTestCase("LteDistributedFfrAreaTestCaseCqa1",
                                        "ns3::CqaFfMacScheduler"),
      TestCase::QUICK);
  AddTestCase(
      new LteDistributedFfrAreaTestCase("LteDistributedFfrAreaTestCaseFdTbfq1",
                                        "ns3::FdTbfqFfMacScheduler"),
      TestCase::QUICK);
  AddTestCase(
      new LteDistributedFfrAreaTestCase("LteDistributedFfrAreaTestCaseTdTbfq1",
                                        "ns3::TdTbfqFfMacScheduler"),
      TestCase::QUICK);
}
...
LteFrTestCase::LteFrTestCase(std::string name, uint32_t userNum,
                             uint16_t dlBandwidth, uint16_t ulBandwidth,
                             std::vector<bool> availableDlRb,
                             std::vector<bool> availableUlRb)
    : TestCase("Test: " + name), m_userNum(userNum), m_dlBandwidth(dlBandwidth),
      m_ulBandwidth(ulBandwidth), m_availableDlRb(availableDlRb),
      m_usedMutedDlRbg(false), m_availableUlRb(availableUlRb),
...
void LteFrTestCase::DoRun() {}

LteHardFrTestCase::LteHardFrTestCase(
    std::string name, uint32_t userNum, std::string schedulerType,
    uint16_t dlBandwidth, uint16_t ulBandwidth, uint8_t dlSubBandOffset,
    uint16_t dlSubBandwidth, uint8_t ulSubBandOffset, uint16_t ulSubBandwidth,
    std::vector<bool> availableDlRb, std::vector<bool> availableUlRb)
    : LteFrTestCase(name, userNum, dlBandwidth, ulBandwidth, availableDlRb,
                    availableUlRb),
      m_schedulerType(schedulerType), m_dlSubBandOffset(dlSubBandOffset),
      m_dlSubBandwidth(dlSubBandwidth), m_ulSubBandOffset(ulSubBandOffset),
...
void LteHardFrTestCase::DoRun() {
  ...
  lteHelper->SetFfrAlgorithmAttribute("DlSubBandOffset",
                                      UintegerValue(m_dlSubBandOffset));
  lteHelper->SetFfrAlgorithmAttribute("DlSubBandwidth",
                                      UintegerValue(m_dlSubBandwidth));

  lteHelper->SetFfrAlgorithmAttribute("UlSubBandOffset",
                                      UintegerValue(m_ulSubBandOffset));
  ...
  Ptr<LteSimpleSpectrumPhy> testDlSpectrumPhy =
      CreateObject<LteSimpleSpectrumPhy>();
  Ptr<LteEnbNetDevice> eNbDev = enbDevs.Get(0)->GetObject<LteEnbNetDevice>();
  testDlSpectrumPhy->SetRxSpectrumModel(
      LteSpectrumValueHelper::GetSpectrumModel(eNbDev->GetDlEarfcn(),
                                               m_dlBandwidth));
  ...
  Ptr<LteSimpleSpectrumPhy> testUlSpectrumPhy =
      CreateObject<LteSimpleSpectrumPhy>();
  testUlSpectrumPhy->SetRxSpectrumModel(
      LteSpectrumValueHelper::GetSpectrumModel(eNbDev->GetUlEarfcn(),
                                               m_ulBandwidth));
...
LteStrictFrTestCase::LteStrictFrTestCase(
    std::string name, uint32_t userNum, std::string schedulerType,
    uint16_t dlBandwidth, uint16_t ulBandwidth, uint16_t dlCommonSubBandwidth,
    uint8_t dlEdgeSubBandOffset, uint16_t dlEdgeSubBandwidth,
    uint16_t ulCommonSubBandwidth, uint8_t ulEdgeSubBandOffset,
    uint16_t ulEdgeSubBandwidth, std::vector<bool> availableDlRb,
    std::vector<bool> availableUlRb)
    : LteFrTestCase(name, userNum, dlBandwidth, ulBandwidth, availableDlRb,
                    availableUlRb),
...
void LteStrictFrTestCase::DoRun() {
  NS_LOG_DEBUG("LteFrTestCase");
  ...
  lteHelper->SetFfrAlgorithmAttribute("DlEdgeSubBandwidth",
                                      UintegerValue(m_dlEdgeSubBandwidth));
...
void LteFrAreaTestCase::SimpleTeleportUe(uint32_t x, uint32_t y) {
...
void LteFrAreaTestCase::TeleportUe(uint32_t x, uint32_t y, double expectedPower,
...
void LteFrAreaTestCase::TeleportUe2(Ptr<Node> ueNode, uint32_t x, uint32_t y,
...
void LteFrAreaTestCase::SetDlExpectedValues(double expectedDlPower,
                                            std::vector<bool> expectedDlRb) {
  NS_LOG_FUNCTION(this);
...
void LteFrAreaTestCase::SetUlExpectedValues(double expectedUlPower,
                                            std::vector<bool> expectedUlRb) {
  NS_LOG_FUNCTION(this);
...
void LteStrictFrAreaTestCase::DoRun() {
  ...
  lteHelper->SetFfrAlgorithmAttribute(
      "CenterPowerOffset", UintegerValue(LteRrcSap::PdschConfigDedicated::dB0));
  lteHelper->SetFfrAlgorithmAttribute(
      "EdgePowerOffset", UintegerValue(LteRrcSap::PdschConfigDedicated::dB3));
  ...
  Simulator::Schedule(MilliSeconds(1), &LteFrAreaTestCase::TeleportUe, this,
                      200, 0, 1, expectedDlRbCenterArea);
  Simulator::Schedule(MilliSeconds(1), &LteFrAreaTestCase::SetUlExpectedValues,
                      this, 0.0150543, expectedUlRbCenterArea);

  Simulator::Schedule(MilliSeconds(501), &LteFrAreaTestCase::TeleportUe, this,
                      800, 0, 2, expectedDlRbEdgeArea);
  Simulator::Schedule(MilliSeconds(501),
                      &LteFrAreaTestCase::SetUlExpectedValues, this, 0.199526,
                      expectedUlRbEdgeArea);

  Simulator::Schedule(MilliSeconds(1001), &LteFrAreaTestCase::TeleportUe, this,
                      200, 0, 1, expectedDlRbCenterArea);
  Simulator::Schedule(MilliSeconds(1001),
                      &LteFrAreaTestCase::SetUlExpectedValues, this, 0.0150543,
...
void LteSoftFrAreaTestCase::DoRun() {
...
void LteSoftFfrAreaTestCase::DoRun() {
  ...
  Simulator::Schedule(MilliSeconds(1), &LteFrAreaTestCase::TeleportUe, this,
                      200, 0, expectedDlPowerCenterArea,
                      expectedDlRbCenterArea);
  Simulator::Schedule(MilliSeconds(1), &LteFrAreaTestCase::SetUlExpectedValues,
                      this, 0.0150543, expectedUlRbCenterArea);

  Simulator::Schedule(MilliSeconds(501), &LteFrAreaTestCase::TeleportUe, this,
                      600, 0, expectedDlPowerMiddleArea,
                      expectedDlRbMiddleArea);
  Simulator::Schedule(MilliSeconds(501),
                      &LteFrAreaTestCase::SetUlExpectedValues, this, 0.135489,
                      expectedUlRbMiddleArea);

  Simulator::Schedule(MilliSeconds(1001), &LteFrAreaTestCase::TeleportUe, this,
                      800, 0, expectedDlPowerEdgeArea, expectedDlRbEdgeArea);
  Simulator::Schedule(MilliSeconds(1001),
                      &LteFrAreaTestCase::SetUlExpectedValues, this, 0.199526,
                      expectedUlRbEdgeArea);

  Simulator::Schedule(MilliSeconds(1501), &LteFrAreaTestCase::TeleportUe, this,
                      600, 0, expectedDlPowerMiddleArea,
                      expectedDlRbMiddleArea);
  ...
  Simulator::Schedule(MilliSeconds(2001), &LteFrAreaTestCase::TeleportUe, this,
                      200, 0, expectedDlPowerCenterArea,
                      expectedDlRbCenterArea);
...
LteEnhancedFfrAreaTestCase::LteEnhancedFfrAreaTestCase(
    std::string name, std::string schedulerType)
    : LteFrAreaTestCase(name, schedulerType) {
...
void LteEnhancedFfrAreaTestCase::DoRun() {
  ...
  Simulator::Schedule(MilliSeconds(1), &LteEnhancedFfrAreaTestCase::TeleportUe,
                      this, 100, 0, expectedDlPowerCenterArea,
                      expectedDlRbCenterArea);
  Simulator::Schedule(MilliSeconds(1), &LteFrAreaTestCase::SetUlExpectedValues,
                      this, 0.00250905, expectedUlRbCenterArea);

  Simulator::Schedule(MilliSeconds(501),
                      &LteEnhancedFfrAreaTestCase::TeleportUe, this, 300, 0,
                      expectedDlPowerMiddleArea, expectedDlRbMiddleArea);
  Simulator::Schedule(MilliSeconds(501),
                      &LteFrAreaTestCase::SetUlExpectedValues, this, 0.0225815,
                      expectedUlRbMiddleArea);
  ...
  Simulator::Schedule(MilliSeconds(1001),
                      &LteFrAreaTestCase::SetUlExpectedValues, this, 0.0903259,
                      expectedUlRbEdgeArea);
  ...
  Simulator::Schedule(MilliSeconds(1501),
                      &LteFrAreaTestCase::SetUlExpectedValues, this, 0.00250905,
                      expectedUlRbCenterArea);
...
void LteDistributedFfrAreaTestCase::DoRun() {
  ...
  lteHelper->SetFfrAlgorithmAttribute("RsrqThreshold", UintegerValue(25));
  lteHelper->SetFfrAlgorithmAttribute("RsrpDifferenceThreshold",
                                      UintegerValue(5));
  ...
  Simulator::Schedule(MilliSeconds(1), &LteFrAreaTestCase::TeleportUe, this,
                      800, 0, expectedDlPowerCenterArea,
                      expectedDlRbCenterArea);
  Simulator::Schedule(MilliSeconds(1), &LteFrAreaTestCase::SetUlExpectedValues,
                      this, 0.0225815, expectedUlRbCenterArea);

  Simulator::Schedule(MilliSeconds(501), &LteFrAreaTestCase::TeleportUe, this,
                      400, 0, expectedDlPowerEdgeArea, expectedDlRbEdgeArea);
  Simulator::Schedule(MilliSeconds(501),
                      &LteFrAreaTestCase::SetUlExpectedValues, this, 0.135489,
                      expectedUlRbEdgeArea);

  Simulator::Schedule(MilliSeconds(1001), &LteFrAreaTestCase::TeleportUe2, this,
                      ueNodes1.Get(0), 600, 0, expectedDlPowerEdgeArea,
                      expectedDlRbEdgeArea2);
  Simulator::Schedule(MilliSeconds(1001),
                      &LteFrAreaTestCase::SetUlExpectedValues, this, 0.135489,
                      expectedUlRbEdgeArea2);

  Simulator::Schedule(MilliSeconds(1501), &LteFrAreaTestCase::TeleportUe2, this,
                      ueNodes1.Get(0), 200, 0, expectedDlPowerEdgeArea,
