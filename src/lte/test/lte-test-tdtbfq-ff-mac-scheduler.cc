...
LenaTestTdTbfqFfMacSchedulerSuite::LenaTestTdTbfqFfMacSchedulerSuite()
  ...
  //  185000 bytes/sec
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(1, 0, 232000, 232000, 200,
                                                    1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(3, 0, 232000, 232000, 200,
                                                    1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(6, 0, 232000, 232000, 200,
                                                    1, errorModel),
              TestCase::EXTENSIVE);
  ...
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(1, 4800, 232000, 232000,
                                                    200, 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(3, 4800, 232000, 232000,
                                                    200, 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(6, 4800, 230500, 125000,
                                                    200, 1, errorModel),
              TestCase::EXTENSIVE);
  // AddTestCase (new LenaTdTbfqFfMacSchedulerTestCase1
  ...
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(1, 6000, 232000, 232000,
                                                    200, 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(3, 6000, 232000, 201000,
                                                    200, 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(6, 6000, 198500, 97000, 200,
                                                    1, errorModel),
              TestCase::EXTENSIVE);
  // AddTestCase (new LenaTdTbfqFfMacSchedulerTestCase1
  ...
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(1, 10000, 232000, 232000,
                                                    200, 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(3, 10000, 232000, 137000,
                                                    200, 1, errorModel),
              TestCase::EXTENSIVE);
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(6, 10000, 129166, 67000,
                                                    200, 1, errorModel),
              TestCase::EXTENSIVE);
  // AddTestCase (new LenaTdTbfqFfMacSchedulerTestCase1
  ...
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(1, 100000, 0, 0, 200, 1,
                                                    errorModel),
              TestCase::QUICK);
  ...
  estThrTdTbfqDl1.push_back(
      132000); // User 0 estimated TTI throughput from TDTBFQ
  estThrTdTbfqDl1.push_back(
      132000); // User 1 estimated TTI throughput from TDTBFQ
  estThrTdTbfqDl1.push_back(
      132000); // User 2 estimated TTI throughput from TDTBFQ
  estThrTdTbfqDl1.push_back(
      132000); // User 3 estimated TTI throughput from TDTBFQ
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase2(dist1, estThrTdTbfqDl1,
  ...
  estThrTdTbfqDl2.push_back(
      302500); // User 0 estimated TTI throughput from TDTBFQ
  estThrTdTbfqDl2.push_back(
      302500); // User 1 estimated TTI throughput from TDTBFQ
  estThrTdTbfqDl2.push_back(
      302500); // User 2 estimated TTI throughput from TDTBFQ
  estThrTdTbfqDl2.push_back(
      302500); // User 3 estimated TTI throughput from TDTBFQ
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase2(dist2, estThrTdTbfqDl2,
  ...
  estThrTdTbfqDl3.push_back(
      132000); // User 0 estimated TTI throughput from TDTBFQ
  estThrTdTbfqDl3.push_back(
      232000); // User 1 estimated TTI throughput from TDTBFQ
  estThrTdTbfqDl3.push_back(
      332000); // User 2 estimated TTI throughput from TDTBFQ
  AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase2(dist3, estThrTdTbfqDl3,
...
std::string LenaTdTbfqFfMacSchedulerTestCase1::BuildNameString(uint16_t nUser,
                                                               double dist) {
...
void LenaTdTbfqFfMacSchedulerTestCase1::DoRun() {
...
std::string
LenaTdTbfqFfMacSchedulerTestCase2::BuildNameString(uint16_t nUser,
...
LenaTdTbfqFfMacSchedulerTestCase2::LenaTdTbfqFfMacSchedulerTestCase2(
    ...
    : TestCase(BuildNameString(dist.size(), dist)), m_nUser(dist.size()),
      ...
      m_estThrTdTbfqDl(estThrTdTbfqDl), m_errorModelEnabled(errorModelEnabled) {
}

LenaTdTbfqFfMacSchedulerTestCase2::~LenaTdTbfqFfMacSchedulerTestCase2() {}

void LenaTdTbfqFfMacSchedulerTestCase2::DoRun() {
  if (!m_errorModelEnabled) {
    Config::SetDefault("ns3::LteSpectrumPhy::CtrlErrorModelEnabled",
                       BooleanValue(false));
    Config::SetDefault("ns3::LteSpectrumPhy::DataErrorModelEnabled",
  ...
  for (int i = 0; i < m_nUser; i++) {
    NS_TEST_ASSERT_MSG_EQ_TOL(
        (double)dlDataRxed.at(i) / statsDuration, m_estThrTdTbfqDl.at(i),
        m_estThrTdTbfqDl.at(i) * tolerance, " Unfair Throughput!");
  }
