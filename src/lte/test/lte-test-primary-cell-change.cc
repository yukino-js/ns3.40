...
LtePrimaryCellChangeTestSuite::LtePrimaryCellChangeTestSuite()
  ...
  // framework.
  AddTestCase(
      new LtePrimaryCellChangeTestCase("ideal RRC, RngRun=1", true, 1, 1, 0, 1),
      TestCase::QUICK);
  AddTestCase(
      new LtePrimaryCellChangeTestCase("real RRC, RngRun=1", false, 1, 1, 0, 1),
      TestCase::QUICK);

  // Test that handover between first carriers of eNBs works.
  AddTestCase(
      new LtePrimaryCellChangeTestCase("ideal RRC, RngRun=1", true, 1, 2, 0, 2),
      TestCase::QUICK);
  AddTestCase(
      new LtePrimaryCellChangeTestCase("real RRC, RngRun=1", false, 1, 2, 0, 2),
      TestCase::QUICK);

  // Test that handover from second carrier of first eNB to first carrier of
  // second eNB works.
  AddTestCase(
      new LtePrimaryCellChangeTestCase("ideal RRC, RngRun=1", true, 1, 2, 1, 2),
      TestCase::QUICK);
  AddTestCase(
      new LtePrimaryCellChangeTestCase("real RRC, RngRun=1", false, 1, 2, 1, 2),
      TestCase::QUICK);

  // Test that handover from first carrier of first eNB to first carrier of
  // second eNB works.
  AddTestCase(
      new LtePrimaryCellChangeTestCase("ideal RRC, RngRun=1", true, 1, 2, 0, 3),
      TestCase::QUICK);
  AddTestCase(
      new LtePrimaryCellChangeTestCase("real RRC, RngRun=1", false, 1, 2, 0, 3),
      TestCase::QUICK);

  // Test that handover from second carrier of first eNB to second carrier of
  // second eNB works.
  AddTestCase(
      new LtePrimaryCellChangeTestCase("ideal RRC, RngRun=1", true, 1, 2, 1, 3),
      TestCase::QUICK);
  AddTestCase(
      new LtePrimaryCellChangeTestCase("real RRC, RngRun=1", false, 1, 2, 1, 3),
      TestCase::QUICK);

  // Test intra-eNB inter-frequency handover.
  AddTestCase(
      new LtePrimaryCellChangeTestCase("ideal RRC, RngRun=1", true, 1, 2, 0, 1),
      TestCase::QUICK);
  AddTestCase(
      new LtePrimaryCellChangeTestCase("real RRC, RngRun=1", false, 1, 2, 0, 1),
      TestCase::QUICK);
  AddTestCase(
      new LtePrimaryCellChangeTestCase("ideal RRC, RngRun=1", true, 1, 2, 1, 0),
      TestCase::QUICK);
  AddTestCase(
      new LtePrimaryCellChangeTestCase("real RRC, RngRun=1", false, 1, 2, 1, 0),
      TestCase::QUICK);
  AddTestCase(
      new LtePrimaryCellChangeTestCase("ideal RRC, RngRun=1", true, 1, 4, 3, 1),
      TestCase::QUICK);
  AddTestCase(
      new LtePrimaryCellChangeTestCase("real RRC, RngRun=1", false, 1, 4, 3, 1),
      TestCase::QUICK);
...
LtePrimaryCellChangeTestCase::LtePrimaryCellChangeTestCase(
    ...
    uint8_t numberOfComponentCarriers, uint8_t sourceComponentCarrier,
    uint8_t targetComponentCarrier)
    : TestCase(name), m_isIdealRrc{isIdealRrc}, m_rngRun{rngRun},
...
void LtePrimaryCellChangeTestCase::DoRun() {
  ...
  auto ueDev =
      DynamicCast<LteUeNetDevice>(lteHelper->InstallUeDevice(ueNode).Get(0));
  ...
  lteHelper->Attach(ueDev, sourceEnbDev,
                    m_sourceComponentCarrier % m_numberOfComponentCarriers);
  ...
  NS_TEST_ASSERT_MSG_EQ(
      m_lastState.at(ueDev->GetImsi()), LteUeRrc::CONNECTED_NORMALLY,
...
void LtePrimaryCellChangeTestCase::StateTransitionCallback(
...
void LtePrimaryCellChangeTestCase::ConnectionEstablishedCallback(
    std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti) {
