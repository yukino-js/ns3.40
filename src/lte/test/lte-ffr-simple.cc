...
LteFfrSimple::LteFfrSimple()
    : m_ffrSapUser(nullptr), m_ffrRrcSapUser(nullptr), m_dlOffset(0),
      m_dlSubBand(0), m_ulOffset(0), m_ulSubBand(0), m_measId(0),
      m_changePdschConfigDedicated(false), m_tpc(1), m_tpcNum(0),
...
LteFfrSimple::~LteFfrSimple() { NS_LOG_FUNCTION(this); }

void LteFfrSimple::DoDispose() {
  NS_LOG_FUNCTION(this);
  delete m_ffrSapProvider;
  delete m_ffrRrcSapProvider;
}

TypeId LteFfrSimple::GetTypeId() {
  static TypeId tid =
...
void LteFfrSimple::SetLteFfrSapUser(LteFfrSapUser *s) {
  NS_LOG_FUNCTION(this << s);
  m_ffrSapUser = s;
}

LteFfrSapProvider *LteFfrSimple::GetLteFfrSapProvider() {
  NS_LOG_FUNCTION(this);
  return m_ffrSapProvider;
}

void LteFfrSimple::SetLteFfrRrcSapUser(LteFfrRrcSapUser *s) {
  NS_LOG_FUNCTION(this << s);
  m_ffrRrcSapUser = s;
}

LteFfrRrcSapProvider *LteFfrSimple::GetLteFfrRrcSapProvider() {
  NS_LOG_FUNCTION(this);
  return m_ffrRrcSapProvider;
}

void LteFfrSimple::DoInitialize() {
  NS_LOG_FUNCTION(this);
...
void LteFfrSimple::Reconfigure() { NS_LOG_FUNCTION(this); }

void LteFfrSimple::ChangePdschConfigDedicated(bool change) {
  m_changePdschConfigDedicated = change;
}

void LteFfrSimple::SetPdschConfigDedicated(
    LteRrcSap::PdschConfigDedicated pdschConfigDedicated) {
  m_pdschConfigDedicated = pdschConfigDedicated;
}

void LteFfrSimple::SetTpc(uint32_t tpc, uint32_t num, bool acculumatedMode) {
  m_tpc = tpc;
  m_tpcNum = num;
  m_accumulatedMode = acculumatedMode;
}

std::vector<bool> LteFfrSimple::DoGetAvailableDlRbg() {
  NS_LOG_FUNCTION(this);
...
bool LteFfrSimple::DoIsDlRbgAvailableForUe(int i, uint16_t rnti) {
  NS_LOG_FUNCTION(this);
  return true;
}

std::vector<bool> LteFfrSimple::DoGetAvailableUlRbg() {
  NS_LOG_FUNCTION(this);
...
bool LteFfrSimple::DoIsUlRbgAvailableForUe(int i, uint16_t rnti) {
  NS_LOG_FUNCTION(this);
  return true;
}

void LteFfrSimple::DoReportDlCqiInfo(
    const FfMacSchedSapProvider::SchedDlCqiInfoReqParameters &params) {
  NS_LOG_FUNCTION(this);
}

void LteFfrSimple::DoReportUlCqiInfo(
...
uint8_t LteFfrSimple::DoGetTpc(uint16_t rnti) {
  NS_LOG_FUNCTION(this);
...
uint16_t LteFfrSimple::DoGetMinContinuousUlBandwidth() {
  NS_LOG_FUNCTION(this);
  return m_ulBandwidth;
}

void LteFfrSimple::DoReportUeMeas(uint16_t rnti,
  ...
  if (it == m_ues.end()) {
    ...
    m_ues.insert(std::pair<uint16_t, LteRrcSap::PdschConfigDedicated>(
        rnti, pdschConfigDedicated));
  }
...
void LteFfrSimple::UpdatePdschConfigDedicated() {
  NS_LOG_FUNCTION(this);
...
void LteFfrSimple::DoRecvLoadInformation(
