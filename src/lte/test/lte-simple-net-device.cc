...
LteSimpleNetDevice::LteSimpleNetDevice() { NS_LOG_FUNCTION(this); }
...
void LteSimpleNetDevice::DoDispose() {
  NS_LOG_FUNCTION(this);
  SimpleNetDevice::DoDispose();
}

void LteSimpleNetDevice::DoInitialize() { NS_LOG_FUNCTION(this); }

bool LteSimpleNetDevice::Send(Ptr<Packet> packet, const Address &dest,
