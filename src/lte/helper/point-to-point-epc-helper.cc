...
PointToPointEpcHelper::~PointToPointEpcHelper() { NS_LOG_FUNCTION(this); }

TypeId PointToPointEpcHelper::GetTypeId() {
...
TypeId PointToPointEpcHelper::GetInstanceTypeId() const { return GetTypeId(); }

void PointToPointEpcHelper::DoDispose() {
  NS_LOG_FUNCTION(this);
  NoBackhaulEpcHelper::DoDispose();
}

void PointToPointEpcHelper::AddEnb(Ptr<Node> enb,
  ...
  Ipv4InterfaceContainer enbSgwIpIfaces =
  ...
  NoBackhaulEpcHelper::AddS1Interface(enb, enbS1uAddress, sgwS1uAddress,
                                      cellIds);
}
