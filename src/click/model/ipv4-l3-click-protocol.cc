...
TypeId Ipv4L3ClickProtocol::GetTypeId() {
  static TypeId tid =
...
void Ipv4L3ClickProtocol::DoDispose() {
...
void Ipv4L3ClickProtocol::SetRoutingProtocol(
...
Ptr<Ipv4RoutingProtocol> Ipv4L3ClickProtocol::GetRoutingProtocol() const {
  return m_routingProtocol;
}

Ptr<Ipv4Interface> Ipv4L3ClickProtocol::GetInterface(uint32_t index) const {
...
uint32_t Ipv4L3ClickProtocol::GetNInterfaces() const {
  NS_LOG_FUNCTION_NOARGS();
  return m_interfaces.size();
}

int32_t Ipv4L3ClickProtocol::GetInterfaceForAddress(Ipv4Address address) const {
  NS_LOG_FUNCTION(this << address);

  int32_t interface = 0;
  for (auto i = m_interfaces.begin(); i != m_interfaces.end();
       i++, interface++) {
...
int32_t Ipv4L3ClickProtocol::GetInterfaceForPrefix(Ipv4Address address,
                                                   Ipv4Mask mask) const {
...
bool Ipv4L3ClickProtocol::IsDestinationAddress(Ipv4Address address,
                                               uint32_t iif) const {
...
void Ipv4L3ClickProtocol::SetIpForward(bool forward) {
...
bool Ipv4L3ClickProtocol::GetIpForward() const { return m_ipForward; }

void Ipv4L3ClickProtocol::SetWeakEsModel(bool model) { m_weakEsModel = model; }

bool Ipv4L3ClickProtocol::GetWeakEsModel() const { return m_weakEsModel; }

Ptr<NetDevice> Ipv4L3ClickProtocol::GetNetDevice(uint32_t i) {
  NS_LOG_FUNCTION(this << i);
  return GetInterface(i)->GetDevice();
}

void Ipv4L3ClickProtocol::SetDefaultTtl(uint8_t ttl) {
  NS_LOG_FUNCTION_NOARGS();
  m_defaultTtl = ttl;
}

void Ipv4L3ClickProtocol::SetupLoopback() {
  NS_LOG_FUNCTION_NOARGS();
  ...
  node->RegisterProtocolHandler(
      MakeCallback(&Ipv4L3ClickProtocol::Receive, this),
...
Ptr<Socket> Ipv4L3ClickProtocol::CreateRawSocket() {
  NS_LOG_FUNCTION(this);
...
void Ipv4L3ClickProtocol::DeleteRawSocket(Ptr<Socket> socket) {
...
bool Ipv4L3ClickProtocol::AddAddress(uint32_t i, Ipv4InterfaceAddress address) {
...
Ipv4L3ClickProtocol::GetAddress(uint32_t interfaceIndex,
...
uint32_t Ipv4L3ClickProtocol::GetNAddresses(uint32_t interface) const {
  NS_LOG_FUNCTION(this << interface);
  Ptr<Ipv4Interface> iface = GetInterface(interface);
  return iface->GetNAddresses();
}

bool Ipv4L3ClickProtocol::RemoveAddress(uint32_t i, uint32_t addressIndex) {
...
bool Ipv4L3ClickProtocol::RemoveAddress(uint32_t i, Ipv4Address address) {
  NS_LOG_FUNCTION(this << i << address);
...
Ipv4Address Ipv4L3ClickProtocol::SelectSourceAddress(
...
void Ipv4L3ClickProtocol::SetMetric(uint32_t i, uint16_t metric) {
  NS_LOG_FUNCTION(i << metric);
  Ptr<Ipv4Interface> interface = GetInterface(i);
  interface->SetMetric(metric);
}

uint16_t Ipv4L3ClickProtocol::GetMetric(uint32_t i) const {
  NS_LOG_FUNCTION(i);
  Ptr<Ipv4Interface> interface = GetInterface(i);
  return interface->GetMetric();
}

uint16_t Ipv4L3ClickProtocol::GetMtu(uint32_t i) const {
  NS_LOG_FUNCTION(this << i);
  Ptr<Ipv4Interface> interface = GetInterface(i);
  return interface->GetDevice()->GetMtu();
}

bool Ipv4L3ClickProtocol::IsUp(uint32_t i) const {
  NS_LOG_FUNCTION(this << i);
  Ptr<Ipv4Interface> interface = GetInterface(i);
  return interface->IsUp();
}

void Ipv4L3ClickProtocol::SetUp(uint32_t i) {
  NS_LOG_FUNCTION(this << i);
  Ptr<Ipv4Interface> interface = GetInterface(i);
  interface->SetUp();
...
void Ipv4L3ClickProtocol::SetDown(uint32_t ifaceIndex) {
...
bool Ipv4L3ClickProtocol::IsForwarding(uint32_t i) const {
  NS_LOG_FUNCTION(this << i);
  Ptr<Ipv4Interface> interface = GetInterface(i);
...
void Ipv4L3ClickProtocol::SetForwarding(uint32_t i, bool val) {
  NS_LOG_FUNCTION(this << i);
  Ptr<Ipv4Interface> interface = GetInterface(i);
  interface->SetForwarding(val);
}

void Ipv4L3ClickProtocol::SetPromisc(uint32_t i) {
  ...
  NS_ASSERT(node);
  node->RegisterProtocolHandler(
      MakeCallback(&Ipv4L3ClickProtocol::Receive, this), 0, netdev, true);
}

uint32_t Ipv4L3ClickProtocol::AddInterface(Ptr<NetDevice> device) {
...
uint32_t Ipv4L3ClickProtocol::AddIpv4Interface(Ptr<Ipv4Interface> interface) {
  NS_LOG_FUNCTION(this << interface);
...
void Ipv4L3ClickProtocol::Send(Ptr<Packet> packet, Ipv4Address source,
  ...
  ipHeader = BuildHeader(source, destination, protocol, packet->GetSize(), ttl,
                         mayFragment);
  Ptr<Ipv4ClickRouting> click =
      DynamicCast<Ipv4ClickRouting>(m_routingProtocol);
  if (Node::ChecksumEnabled()) {
    ipHeader.EnableChecksum();
  }
...
void Ipv4L3ClickProtocol::SendWithHeader(Ptr<Packet> packet,
                                         Ipv4Header ipHeader,
                                         Ptr<Ipv4Route> route) {
...
void Ipv4L3ClickProtocol::Receive(Ptr<NetDevice> device, Ptr<const Packet> p,
  ...
  Ptr<Ipv4ClickRouting> click =
      DynamicCast<Ipv4ClickRouting>(GetRoutingProtocol());
...
Ptr<Icmpv4L4Protocol> Ipv4L3ClickProtocol::GetIcmp() const {
  Ptr<IpL4Protocol> prot =
      GetProtocol(Icmpv4L4Protocol::GetStaticProtocolNumber());
  if (prot) {
...
void Ipv4L3ClickProtocol::Insert(Ptr<IpL4Protocol> protocol) {
...
void Ipv4L3ClickProtocol::Remove(Ptr<IpL4Protocol> protocol) {
  NS_LOG_FUNCTION(this << protocol);
...
Ptr<IpL4Protocol> Ipv4L3ClickProtocol::GetProtocol(int protocolNumber) const {
...
Ptr<IpL4Protocol>
Ipv4L3ClickProtocol::GetProtocol(int protocolNumber,
