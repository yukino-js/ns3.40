...
int main(int argc, char *argv[]) {
...

  {
    ...
    Ptr<ExponentialRandomVariable> expVar =
        CreateObjectWithAttributes<ExponentialRandomVariable>(
            "Mean", DoubleValue(50.0));
...

  {
    ...
    Gnuplot plot = TestProbabilistic(nak, testProbabilisticDistance, 100.0,
...

  {
    ...
    Gnuplot plot = TestProbabilistic(log3, testProbabilisticDistance, 100.0,
                                     testProbabilisticSamples);
