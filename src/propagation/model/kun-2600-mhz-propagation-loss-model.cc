...
TypeId Kun2600MhzPropagationLossModel::GetTypeId() {
...
double Kun2600MhzPropagationLossModel::GetLoss(Ptr<MobilityModel> a,
...
double Kun2600MhzPropagationLossModel::DoCalcRxPower(
    double txPowerDbm, Ptr<MobilityModel> a, Ptr<MobilityModel> b) const {
  return (txPowerDbm - GetLoss(a, b));
}

int64_t Kun2600MhzPropagationLossModel::DoAssignStreams(int64_t stream) {
  return 0;
}
