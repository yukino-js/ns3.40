...
TypeId PropagationLossModel::GetTypeId() {
...
PropagationLossModel::PropagationLossModel() : m_next(nullptr) {}

PropagationLossModel::~PropagationLossModel() {}

void PropagationLossModel::SetNext(Ptr<PropagationLossModel> next) {
  m_next = next;
}

Ptr<PropagationLossModel> PropagationLossModel::GetNext() { return m_next; }

double PropagationLossModel::CalcRxPower(double txPowerDbm,
                                         Ptr<MobilityModel> a,
...
int64_t PropagationLossModel::AssignStreams(int64_t stream) {
...
double RandomPropagationLossModel::DoCalcRxPower(double txPowerDbm,
                                                 Ptr<MobilityModel> a,
                                                 Ptr<MobilityModel> b) const {
...
int64_t RandomPropagationLossModel::DoAssignStreams(int64_t stream) {
...
TypeId FriisPropagationLossModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::FriisPropagationLossModel")
          ...
          .AddAttribute(
              "SystemLoss", "The system loss", DoubleValue(1.0),
...
void FriisPropagationLossModel::SetSystemLoss(double systemLoss) {
  m_systemLoss = systemLoss;
}

double FriisPropagationLossModel::GetSystemLoss() const { return m_systemLoss; }

void FriisPropagationLossModel::SetMinLoss(double minLoss) {
  m_minLoss = minLoss;
}

double FriisPropagationLossModel::GetMinLoss() const { return m_minLoss; }
...
double FriisPropagationLossModel::GetFrequency() const { return m_frequency; }

double FriisPropagationLossModel::DbmToW(double dbm) const {
  double mw = std::pow(10.0, dbm / 10.0);
  return mw / 1000.0;
}

double FriisPropagationLossModel::DbmFromW(double w) const {
...
TypeId TwoRayGroundPropagationLossModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::TwoRayGroundPropagationLossModel")
          ...
          .AddAttribute("MinDistance",
                        ...
                        DoubleValue(0.5),
                        MakeDoubleAccessor(
                            &TwoRayGroundPropagationLossModel::SetMinDistance,
          ...
          .AddAttribute(
              ...
              DoubleValue(0),
              MakeDoubleAccessor(
                  &TwoRayGroundPropagationLossModel::m_heightAboveZ),
              MakeDoubleChecker<double>());
  return tid;
}
...
void TwoRayGroundPropagationLossModel::SetSystemLoss(double systemLoss) {
  m_systemLoss = systemLoss;
}

double TwoRayGroundPropagationLossModel::GetSystemLoss() const {
  return m_systemLoss;
}

void TwoRayGroundPropagationLossModel::SetMinDistance(double minDistance) {
  m_minDistance = minDistance;
}

double TwoRayGroundPropagationLossModel::GetMinDistance() const {
  return m_minDistance;
}

void TwoRayGroundPropagationLossModel::SetHeightAboveZ(double heightAboveZ) {
...
double TwoRayGroundPropagationLossModel::GetFrequency() const {
  return m_frequency;
}

double TwoRayGroundPropagationLossModel::DbmToW(double dbm) const {
  double mw = std::pow(10.0, dbm / 10.0);
  return mw / 1000.0;
}

double TwoRayGroundPropagationLossModel::DbmFromW(double w) const {
  double dbm = std::log10(w * 1000.0) * 10.0;
  return dbm;
}
...
double TwoRayGroundPropagationLossModel::DoCalcRxPower(
  ...
  if (distance <= dCross) {
    ...
    NS_LOG_DEBUG("Receiver within crossover ("
                 << dCross << "m) for Two_ray path; using Friis");
  ...
  } else // Use Two-Ray Pathloss
  {
    ...
    NS_LOG_DEBUG("distance=" << distance
                             << "m, attenuation coefficient=" << rayPr << "dB");
...
TypeId LogDistancePropagationLossModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::LogDistancePropagationLossModel")
          ...
          .AddAttribute(
              ...
              DoubleValue(1.0),
              MakeDoubleAccessor(
                  &LogDistancePropagationLossModel::m_referenceDistance),
              MakeDoubleChecker<double>())
          .AddAttribute("ReferenceLoss",
                        ...
                        DoubleValue(46.6777),
                        MakeDoubleAccessor(
                            &LogDistancePropagationLossModel::m_referenceLoss),
                        MakeDoubleChecker<double>());
  return tid;
}
...
void LogDistancePropagationLossModel::SetPathLossExponent(double n) {
  m_exponent = n;
}

void LogDistancePropagationLossModel::SetReference(double referenceDistance,
                                                   double referenceLoss) {
  m_referenceDistance = referenceDistance;
  m_referenceLoss = referenceLoss;
}

double LogDistancePropagationLossModel::GetPathLossExponent() const {
  return m_exponent;
}

double LogDistancePropagationLossModel::DoCalcRxPower(
    double txPowerDbm, Ptr<MobilityModel> a, Ptr<MobilityModel> b) const {
  double distance = a->GetDistanceFrom(b);
  ...
  NS_LOG_DEBUG("distance=" << distance << "m, reference-attenuation="
                           << -m_referenceLoss << "dB, "
...
TypeId ThreeLogDistancePropagationLossModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::ThreeLogDistancePropagationLossModel")
          ...
          .AddAttribute("Distance1",
                        ...
                        DoubleValue(200.0),
                        MakeDoubleAccessor(
                            &ThreeLogDistancePropagationLossModel::m_distance1),
                        MakeDoubleChecker<double>())
          .AddAttribute("Distance2",
                        "Beginning of the third (far) distance field.",
                        DoubleValue(500.0),
                        MakeDoubleAccessor(
                            &ThreeLogDistancePropagationLossModel::m_distance2),
                        MakeDoubleChecker<double>())
          .AddAttribute("Exponent0", "The exponent for the first field.",
                        DoubleValue(1.9),
                        MakeDoubleAccessor(
                            &ThreeLogDistancePropagationLossModel::m_exponent0),
                        MakeDoubleChecker<double>())
          .AddAttribute("Exponent1", "The exponent for the second field.",
                        DoubleValue(3.8),
                        MakeDoubleAccessor(
                            &ThreeLogDistancePropagationLossModel::m_exponent1),
                        MakeDoubleChecker<double>())
          .AddAttribute("Exponent2", "The exponent for the third field.",
                        DoubleValue(3.8),
                        MakeDoubleAccessor(
                            &ThreeLogDistancePropagationLossModel::m_exponent2),
                        MakeDoubleChecker<double>())
          .AddAttribute(
              "ReferenceLoss",
              ...
              DoubleValue(46.6777),
              MakeDoubleAccessor(
                  &ThreeLogDistancePropagationLossModel::m_referenceLoss),
              MakeDoubleChecker<double>());
  return tid;
}
...
double ThreeLogDistancePropagationLossModel::DoCalcRxPower(
    double txPowerDbm, Ptr<MobilityModel> a, Ptr<MobilityModel> b) const {
  double distance = a->GetDistanceFrom(b);
  ...
  if (distance < m_distance0) {
    ...
    pathLossDb =
        m_referenceLoss + 10 * m_exponent0 * std::log10(distance / m_distance0);
...
TypeId NakagamiPropagationLossModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::NakagamiPropagationLossModel")
          ...
          .AddAttribute(
              ...
              MakePointerAccessor(
                  &NakagamiPropagationLossModel::m_erlangRandomVariable),
          ...
          .AddAttribute(
              ...
              MakePointerAccessor(
                  &NakagamiPropagationLossModel::m_gammaRandomVariable),
...
double NakagamiPropagationLossModel::DoCalcRxPower(double txPowerDbm,
  ...
  NS_LOG_DEBUG("Nakagami distance=" << distance << "m, "
                                    ...
                                    << "W=" << resultPowerDbm << "dBm");

  return resultPowerDbm;
}

int64_t NakagamiPropagationLossModel::DoAssignStreams(int64_t stream) {
...
TypeId FixedRssLossModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::FixedRssLossModel")
          .SetParent<PropagationLossModel>()
          .SetGroupName("Propagation")
...
void FixedRssLossModel::SetRss(double rss) { m_rss = rss; }

double FixedRssLossModel::DoCalcRxPower(double txPowerDbm, Ptr<MobilityModel> a,
                                        Ptr<MobilityModel> b) const {
  return m_rss;
}
...
TypeId MatrixPropagationLossModel::GetTypeId() {
  static TypeId tid =
...
void MatrixPropagationLossModel::SetDefaultLoss(double loss) {
  m_default = loss;
}

void MatrixPropagationLossModel::SetLoss(Ptr<MobilityModel> ma,
                                         Ptr<MobilityModel> mb, double loss,
                                         bool symmetric) {
  NS_ASSERT(ma && mb);
...
double MatrixPropagationLossModel::DoCalcRxPower(double txPowerDbm,
                                                 Ptr<MobilityModel> a,
                                                 Ptr<MobilityModel> b) const {
...
int64_t MatrixPropagationLossModel::DoAssignStreams(int64_t stream) {
  return 0;
}
...
TypeId RangePropagationLossModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::RangePropagationLossModel")
          ...
          .AddAttribute("MaxRange", "Maximum Transmission Range (meters)",
                        DoubleValue(250),
...
double RangePropagationLossModel::DoCalcRxPower(double txPowerDbm,
                                                Ptr<MobilityModel> a,
                                                Ptr<MobilityModel> b) const {
  double distance = a->GetDistanceFrom(b);
  if (distance <= m_range) {
