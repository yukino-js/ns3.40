...
TypeId PropagationDelayModel::GetTypeId() {
...
int64_t PropagationDelayModel::AssignStreams(int64_t stream) {
...
int64_t RandomPropagationDelayModel::DoAssignStreams(int64_t stream) {
...
TypeId ConstantSpeedPropagationDelayModel::GetTypeId() {
  static TypeId tid =
...
void ConstantSpeedPropagationDelayModel::SetSpeed(double speed) {
  m_speed = speed;
}

double ConstantSpeedPropagationDelayModel::GetSpeed() const { return m_speed; }

int64_t ConstantSpeedPropagationDelayModel::DoAssignStreams(int64_t stream) {
  return 0;
}
