...
private:
  ...
  O2iLowHighConditionValue
      m_o2iLowHighCondition; //!< contains the information about the O2I
...
private:
  ...
  double m_o2iThreshold{0}; //!< the threshold for determining what is the ratio
                            //!< of channels with O2I
  ...
  Ptr<UniformRandomVariable>
      m_uniformVarO2i; //!< uniform random variable that is used for the
                       //!< generation of the O2i conditions
  Ptr<UniformRandomVariable>
      m_uniformO2iLowHighLossVar; //!< a uniform random variable for the
                                  //!< calculation of the low/high losses, see
                                  //!< TR38.901 Table 7.4.3-2
};
