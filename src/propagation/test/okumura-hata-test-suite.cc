...
void OkumuraHataPropagationLossModelTestCase::DoRun() {
...
OkumuraHataPropagationLossModelTestSuite::
  ...
  AddTestCase(new OkumuraHataPropagationLossModelTestCase(
              ...
              TestCase::QUICK);
  AddTestCase(new OkumuraHataPropagationLossModelTestCase(
                  freq, 2000, 30, 1, UrbanEnvironment, SmallCity, 137.88,
                  "original OH Urban small city"),
              TestCase::QUICK);
  AddTestCase(new OkumuraHataPropagationLossModelTestCase(
                  freq, 2000, 30, 1, SubUrbanEnvironment, LargeCity, 128.03,
                  "original OH SubUrban"),
              TestCase::QUICK);
  AddTestCase(new OkumuraHataPropagationLossModelTestCase(
                  freq, 2000, 30, 1, OpenAreasEnvironment, LargeCity, 110.21,
