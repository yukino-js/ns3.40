...
TypeId UdpEchoServer::GetTypeId() {
  static TypeId tid =
...
UdpEchoServer::UdpEchoServer() { NS_LOG_FUNCTION(this); }
...
void UdpEchoServer::DoDispose() {
  NS_LOG_FUNCTION(this);
  Application::DoDispose();
}

void UdpEchoServer::StartApplication() {
  NS_LOG_FUNCTION(this);
...
void UdpEchoServer::StopApplication() {
  NS_LOG_FUNCTION(this);
