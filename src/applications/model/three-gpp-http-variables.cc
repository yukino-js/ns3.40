      ...
      TypeId("ns3::ThreeGppHttpVariables")
          ...
          .AddAttribute("MainObjectSizeMean",
                        ...
                        MakeUintegerAccessor(
                            &ThreeGppHttpVariables::SetMainObjectSizeMean),
                        MakeUintegerChecker<uint32_t>())
          .AddAttribute(
              ...
              UintegerValue(25032),
              MakeUintegerAccessor(
                  &ThreeGppHttpVariables::SetMainObjectSizeStdDev),
              MakeUintegerChecker<uint32_t>())
          .AddAttribute(
              "MainObjectSizeMin",
          ...
          .AddAttribute("EmbeddedObjectSizeMean",
                        ...
                        UintegerValue(7758),
                        MakeUintegerAccessor(
                            &ThreeGppHttpVariables::SetEmbeddedObjectSizeMean),
                        MakeUintegerChecker<uint32_t>())
          .AddAttribute(
              ...
              MakeUintegerAccessor(
                  &ThreeGppHttpVariables::SetEmbeddedObjectSizeStdDev),
              MakeUintegerChecker<uint32_t>())
          .AddAttribute(
              ...
              UintegerValue(50),
              MakeUintegerAccessor(
                  &ThreeGppHttpVariables::m_embeddedObjectSizeMin),
              MakeUintegerChecker<uint32_t>(22))
          .AddAttribute(
          ...
          .AddAttribute(
              ...
              UintegerValue(55),
              MakeUintegerAccessor(
                  &ThreeGppHttpVariables::SetNumOfEmbeddedObjectsMax),
              MakeUintegerChecker<uint32_t>())
          .AddAttribute(
              ...
              DoubleValue(1.1),
              MakeDoubleAccessor(
                  &ThreeGppHttpVariables::SetNumOfEmbeddedObjectsShape),
          ...
          .AddAttribute("HighMtuSize", "The higher MTU size.",
                        UintegerValue(1460),
...
uint32_t ThreeGppHttpVariables::GetMtuSize() {
...
uint32_t ThreeGppHttpVariables::GetRequestSize() {
  return m_requestSizeRng->GetInteger();
}

Time ThreeGppHttpVariables::GetMainObjectGenerationDelay() {
...
Time ThreeGppHttpVariables::GetEmbeddedObjectGenerationDelay() {
...
uint32_t ThreeGppHttpVariables::GetEmbeddedObjectSize() {
  ...
  } while ((value < m_embeddedObjectSizeMin) ||
           (value >= m_embeddedObjectSizeMax));
...
Time ThreeGppHttpVariables::GetReadingTime() {
  return Seconds(m_readingTimeRng->GetValue());
}

Time ThreeGppHttpVariables::GetParsingTime() {
  return Seconds(m_parsingTimeRng->GetValue());
}

int64_t ThreeGppHttpVariables::AssignStreams(int64_t stream) {
...
void ThreeGppHttpVariables::DoInitialize() {
  NS_LOG_FUNCTION(this);
...
void ThreeGppHttpVariables::SetMainObjectGenerationDelay(Time constant) {
  NS_LOG_FUNCTION(this << constant.As(Time::S));
  m_mainObjectGenerationDelayRng->SetAttribute(
      "Constant", DoubleValue(constant.GetSeconds()));
}

void ThreeGppHttpVariables::UpdateMainObjectMuAndSigma() {
  NS_LOG_FUNCTION(this);
...
void ThreeGppHttpVariables::UpdateEmbeddedObjectMuAndSigma() {
  NS_LOG_FUNCTION(this);
...
void ThreeGppHttpVariables::SetMainObjectSizeMean(uint32_t mean) {
...
void ThreeGppHttpVariables::SetMainObjectSizeStdDev(uint32_t stdDev) {
...
void ThreeGppHttpVariables::SetEmbeddedObjectGenerationDelay(Time constant) {
  NS_LOG_FUNCTION(this << constant.As(Time::S));
  m_embeddedObjectGenerationDelayRng->SetAttribute(
      "Constant", DoubleValue(constant.GetSeconds()));
}

void ThreeGppHttpVariables::SetEmbeddedObjectSizeMean(uint32_t mean) {
  NS_LOG_FUNCTION(this << mean);
  NS_ASSERT_MSG(mean > 0, "Mean must be greater than zero.");
...
void ThreeGppHttpVariables::SetEmbeddedObjectSizeStdDev(uint32_t stdDev) {
  NS_LOG_FUNCTION(this << stdDev);
...
void ThreeGppHttpVariables::SetNumOfEmbeddedObjectsMax(uint32_t max) {
  NS_LOG_FUNCTION(this << max);
  m_numOfEmbeddedObjectsRng->SetAttribute(
      "Bound", DoubleValue(static_cast<double>(max)));
}

void ThreeGppHttpVariables::SetNumOfEmbeddedObjectsShape(double shape) {
...
void ThreeGppHttpVariables::SetNumOfEmbeddedObjectsScale(uint32_t scale) {
...
void ThreeGppHttpVariables::SetReadingTimeMean(Time mean) {
  NS_LOG_FUNCTION(this << mean.As(Time::S));
  m_readingTimeRng->SetAttribute("Mean", DoubleValue(mean.GetSeconds()));
}

void ThreeGppHttpVariables::SetParsingTimeMean(Time mean) {
  NS_LOG_FUNCTION(this << mean.As(Time::S));
