...
void UdpClientServerTestCase::DoRun() {
  ...
  NS_TEST_ASSERT_MSG_EQ(server.GetServer()->GetLost(), 0,
                        "Packets were lost !");
  NS_TEST_ASSERT_MSG_EQ(server.GetServer()->GetReceived(), 8,
...
void UdpTraceClientServerTestCase::DoRun() {
  ...
  NS_TEST_ASSERT_MSG_EQ(server.GetServer()->GetLost(), 0,
                        "Packets were lost !");
  NS_TEST_ASSERT_MSG_EQ(server.GetServer()->GetReceived(), 247,
                        "Did not receive expected number of packets !");
}
...
void PacketLossCounterTestCase::DoRun() {
  ...
  NS_TEST_ASSERT_MSG_EQ(lossCounter.GetLost(), 0,
  ...
  NS_TEST_ASSERT_MSG_EQ(lossCounter.GetLost(), 1,
  ...
  NS_TEST_ASSERT_MSG_EQ(lossCounter.GetLost(), 7,
  ...
  NS_TEST_ASSERT_MSG_EQ(lossCounter.GetLost(), 9,
...
void UdpEchoClientSetFillTestCase::DoRun() {
  ...
  echoClient.SetFill(clientApps.Get(0), &(array[0]), (uint32_t)64,
                     (uint32_t)64);
