...
private:
  ...
  uint8_t m_sspecBcnOrder; //!< Superframe Specification field Beacon Order (Bit
                           //!< 0-3)
  ...
  bool m_sspecBatLifeExt;     //!< Superframe Specification field Battery Life
                          //!< Extension (Bit 12) Superframe Specification field
                          //!< Reserved (not necessary) (Bit 13)
...
private:
  ...
  struct GtsDescriptor {
    Mac16Address m_gtsDescDevShortAddr; //!< GTS Descriptor Device Short Address
                                        //!< (Bit 0-15)
  ...
  uint8_t m_gtsSpecDescCount; //!< GTS specification field Descriptor Count (Bit
                              //!< 0-2)
  ...
  // GTS List
  GtsDescriptor
      m_gtsList[7]; //!< GTS List field (maximum descriptors stored == 7)
};
...
private:
  ...
  bool m_receiverOnWhenIdle; //!< Capability Information Field, Receiver On When
                             //!< Idle (bit 3)
  uint8_t
      m_reservedBit45; //!< Capability Information Field, Reserved (bit 4 & 5)
