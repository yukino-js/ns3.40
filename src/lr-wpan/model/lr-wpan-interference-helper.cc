...
bool LrWpanInterferenceHelper::AddSignal(Ptr<const SpectrumValue> signal) {
...
bool LrWpanInterferenceHelper::RemoveSignal(Ptr<const SpectrumValue> signal) {
  NS_LOG_FUNCTION(this << signal);
...
void LrWpanInterferenceHelper::ClearSignals() {
...
Ptr<SpectrumValue> LrWpanInterferenceHelper::GetSignalPsd() const {
  NS_LOG_FUNCTION(this);
