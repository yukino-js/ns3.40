...
void LrWpanCollisionTestCase::DataIndication(McpsDataIndicationParams params,
                                             Ptr<Packet> p) {
  m_rxPackets++;
}
...
void LrWpanCollisionTestCase::DoRun() {
  ...
  Simulator::Schedule(Seconds(0.1), &LrWpanMac::McpsDataRequest, dev0->GetMac(),
                      params, p0);

  params.m_dstAddr = Mac16Address("00:01");
  Simulator::Schedule(Seconds(0.1), &LrWpanMac::McpsDataRequest, dev1->GetMac(),
                      params, p1);
  ...
  params.m_dstAddr = Mac16Address("00:01");
  Simulator::Schedule(Seconds(0.0002), &LrWpanMac::McpsDataRequest,
  ...
  params.m_dstAddr = Mac16Address("00:01");
  Simulator::Schedule(Seconds(0.1), &LrWpanMac::McpsDataRequest, dev2->GetMac(),
                      params, p1);
