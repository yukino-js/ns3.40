...
TypeId AparfWifiManager::GetTypeId() {
  static TypeId tid =
...
AparfWifiManager::AparfWifiManager() { NS_LOG_FUNCTION(this); }

AparfWifiManager::~AparfWifiManager() { NS_LOG_FUNCTION(this); }

void AparfWifiManager::SetupPhy(const Ptr<WifiPhy> phy) {
...
void AparfWifiManager::DoInitialize() {
...
WifiRemoteStation *AparfWifiManager::DoCreateStation() const {
  NS_LOG_FUNCTION(this);
  ...
  NS_LOG_DEBUG("create station=" << station
...
void AparfWifiManager::CheckInit(AparfWifiRemoteStation *station) {
...
void AparfWifiManager::DoReportRxOk(WifiRemoteStation *station, double rxSnr,
                                    WifiMode txMode) {
  NS_LOG_FUNCTION(this << station << rxSnr << txMode);
}

void AparfWifiManager::DoReportRtsOk(WifiRemoteStation *station, double ctsSnr,
                                     WifiMode ctsMode, double rtsSnr) {
  NS_LOG_FUNCTION(this << station << ctsSnr << ctsMode << rtsSnr);
}

void AparfWifiManager::DoReportDataOk(WifiRemoteStation *st, double ackSnr,
...
void AparfWifiManager::DoReportFinalRtsFailed(WifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
}

void AparfWifiManager::DoReportFinalDataFailed(WifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
}

WifiTxVector AparfWifiManager::DoGetDataTxVector(WifiRemoteStation *st,
