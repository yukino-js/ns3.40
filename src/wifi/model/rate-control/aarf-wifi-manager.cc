...
TypeId AarfWifiManager::GetTypeId() {
  static TypeId tid =
...
AarfWifiManager::~AarfWifiManager() { NS_LOG_FUNCTION(this); }

void AarfWifiManager::DoInitialize() {
  NS_LOG_FUNCTION(this);
  if (GetHtSupported()) {
    NS_FATAL_ERROR(
...
WifiRemoteStation *AarfWifiManager::DoCreateStation() const {
  NS_LOG_FUNCTION(this);
...
void AarfWifiManager::DoReportRtsFailed(WifiRemoteStation *station) {
...
void AarfWifiManager::DoReportRxOk(WifiRemoteStation *station, double rxSnr,
                                   WifiMode txMode) {
  NS_LOG_FUNCTION(this << station << rxSnr << txMode);
}

void AarfWifiManager::DoReportRtsOk(WifiRemoteStation *station, double ctsSnr,
                                    WifiMode ctsMode, double rtsSnr) {
  NS_LOG_FUNCTION(this << station << ctsSnr << ctsMode << rtsSnr);
  NS_LOG_DEBUG("station=" << station << " rts ok");
}

void AarfWifiManager::DoReportDataOk(WifiRemoteStation *st, double ackSnr,
...
void AarfWifiManager::DoReportFinalRtsFailed(WifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
}

void AarfWifiManager::DoReportFinalDataFailed(WifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
}

WifiTxVector AarfWifiManager::DoGetDataTxVector(WifiRemoteStation *st,
