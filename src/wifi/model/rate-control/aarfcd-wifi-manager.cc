...
TypeId AarfcdWifiManager::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::AarfcdWifiManager")
          ...
          .AddAttribute(
              ...
              MakeUintegerChecker<uint32_t>())
          .AddAttribute("MinRtsWnd", "Minimum value for RTS window of AARF-CD",
                        UintegerValue(1),
                        MakeUintegerAccessor(&AarfcdWifiManager::m_minRtsWnd),
                        MakeUintegerChecker<uint32_t>())
          .AddAttribute("MaxRtsWnd", "Maximum value for RTS window of AARF-CD",
                        UintegerValue(40),
...
AarfcdWifiManager::~AarfcdWifiManager() { NS_LOG_FUNCTION(this); }

void AarfcdWifiManager::DoInitialize() {
  NS_LOG_FUNCTION(this);
  if (GetHtSupported()) {
    NS_FATAL_ERROR(
...
WifiRemoteStation *AarfcdWifiManager::DoCreateStation() const {
  NS_LOG_FUNCTION(this);
...
void AarfcdWifiManager::DoReportRtsFailed(WifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
}

void AarfcdWifiManager::DoReportDataFailed(WifiRemoteStation *st) {
...
void AarfcdWifiManager::DoReportRxOk(WifiRemoteStation *station, double rxSnr,
                                     WifiMode txMode) {
  NS_LOG_FUNCTION(this << station << rxSnr << txMode);
}

void AarfcdWifiManager::DoReportRtsOk(WifiRemoteStation *st, double ctsSnr,
...
void AarfcdWifiManager::DoReportDataOk(WifiRemoteStation *st, double ackSnr,
...
void AarfcdWifiManager::DoReportFinalRtsFailed(WifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
}

void AarfcdWifiManager::DoReportFinalDataFailed(WifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
}

WifiTxVector AarfcdWifiManager::DoGetDataTxVector(WifiRemoteStation *st,
...
bool AarfcdWifiManager::DoNeedRts(WifiRemoteStation *st, uint32_t size,
                                  bool normally) {
...
void AarfcdWifiManager::CheckRts(AarfcdWifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
...
void AarfcdWifiManager::TurnOffRts(AarfcdWifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
  station->m_rtsOn = false;
  station->m_haveASuccess = false;
}

void AarfcdWifiManager::TurnOnRts(AarfcdWifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
  station->m_rtsOn = true;
}

void AarfcdWifiManager::IncreaseRtsWnd(AarfcdWifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
...
void AarfcdWifiManager::ResetRtsWnd(AarfcdWifiRemoteStation *station) {
  NS_LOG_FUNCTION(this << station);
  station->m_rtsWnd = m_minRtsWnd;
}
