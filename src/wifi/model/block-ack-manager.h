...
private:
  ...
  std::list<AgreementKey>
      m_sendBarIfDataQueued; ///< list of BA agreements for which a BAR shall
  ...
  Callback<void, Mac48Address, uint8_t>
      m_blockPackets; ///< block packets callback
  Callback<void, Mac48Address, uint8_t>
      m_unblockPackets;                    ///< unblock packets callback
