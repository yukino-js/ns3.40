...
public:
  ...
  struct NeighborApInformation {
    mutable TbttInformationHeader tbttInfoHdr{0, 0, 0, 0,
                                              0}; //!< TBTT Information header
    uint8_t operatingClass{0};                    //!< Operating class
    uint8_t channelNumber{0};                     //!< Primary channel number
    std::vector<TbttInformation>
        tbttInformationSet; //!< One or more TBTT Information fields

    bool hasBssid{
        false}; //!< whether BSSID is present in all TBTT Information fields
    bool hasShortSsid{false}; //!< whether Short SSID is present in all TBTT
                              //!< Information fields
    bool hasBssParams{false}; //!< whether BSS parameters is present in all TBTT
                              //!< Information fields
    bool has20MHzPsd{false};  //!< whether 20 MHz PSD is present in all TBTT
                              //!< Information fields
    bool hasMldParams{false}; //!< whether MLD Parameters is present in all TBTT
                              //!< Information fields
  };
