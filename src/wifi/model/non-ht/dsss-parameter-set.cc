...
DsssParameterSet::DsssParameterSet() : m_currentChannel(0) {}

WifiInformationElementId DsssParameterSet::ElementId() const {
...
uint16_t DsssParameterSet::GetInformationFieldSize() const { return 1; }

void DsssParameterSet::SerializeInformationField(Buffer::Iterator start) const {
  start.WriteU8(m_currentChannel);
}

uint16_t DsssParameterSet::DeserializeInformationField(Buffer::Iterator start,
                                                       uint16_t length) {
