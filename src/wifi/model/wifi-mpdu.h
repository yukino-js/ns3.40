...
private:
  ...
  struct OriginalInfo {
    ...
    DeaggregatedMsdus
        m_msduList; //!< list of aggregated MSDUs included in this MPDU
    std::optional<Iterator>
        m_queueIt;        //!< Queue iterator pointing to this MPDU, if queued
  ...
  InstanceInfo
      m_instanceInfo; //!< information associated with the instance type
  ...
  static constexpr std::size_t ALIAS =
      1; //!< index of an alias in the InstanceInfo variant
};
