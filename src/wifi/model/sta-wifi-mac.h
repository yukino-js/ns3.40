...
struct WifiScanParams {
  ...
  std::vector<ChannelList>
      channelList;     ///< list of channels to scan, for each link
...
public:
  ...
  struct ApInfo {
    ...
    MgtFrameType
        m_frame; ///< The body of the management frame used to update AP info
    WifiScanParams::Channel
        m_channel;    ///< The channel the management frame was received on
...
private:
  ...
  Ptr<RandomVariableStream>
      m_probeDelay;           ///< RandomVariable used to randomize the time
  ...
  TracedCallback<uint8_t, Mac48Address>
      m_setupCompleted;                         ///< link setup completed logger
  TracedCallback<Mac48Address> m_deAssocLogger; ///< disassociation logger
  TracedCallback<uint8_t, Mac48Address>
      m_setupCanceled;                  ///< link setup canceled logger
  ...
  using LinkSetupCallback = void (*)(uint8_t /* link ID */,
                                     Mac48Address /* AP address */);
};
