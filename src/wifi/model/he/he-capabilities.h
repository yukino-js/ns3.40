...
private:
  ...
  uint8_t m_maximumNumberOfFragmentedMsdus; //!< maximum number of fragmentation
                                            //!< MSDUs
  uint8_t m_minimumFragmentSize;            //!< minimum fragment size
  uint8_t
      m_triggerFrameMacPaddingDuration; //!< trigger frame MAC padding duration
  ...
  uint8_t
      m_maxAmpduLengthExponent; //!< maximum A-MPDU length exponent extension
  ...
  uint8_t
      m_numberOfSoundingDimensionsForSmallerOrEqualThan80Mhz; //!< # of sounding
                                                              //!< dimensions
                                                              //!< for < 80 MHz
  ...
  uint8_t
      m_heErSuPpdu4xHeLtf08sGi; //!< HE ER SU PPDU with 4x HE LTF and 0.8us GI
  ...
  uint8_t
      m_heErSuPpdu1xHeLtf08Gi;    //!< HE ER SU PPDU with 1x HE LTF and 0.8us GI
  ...
  uint8_t
      m_rxFullBwSuInHeMuNonCompressedSigB; //!< RX full BW SU using HE MU PPDU
