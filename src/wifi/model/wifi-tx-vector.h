...
public:
  ...
  typedef std::map<uint16_t /* staId */,
                   HeMuUserInfo /* HE MU specific user info */>
      HeMuUserInfoMap;
...
private:
  ...
  // MU information
  HeMuUserInfoMap
      m_muUserInfos; /**< HE MU specific per-user information
  ...
  mutable RuAllocation
      m_ruAllocation; /**< RU allocations that are going to be carried
