...
VhtConfiguration::VhtConfiguration() { NS_LOG_FUNCTION(this); }

VhtConfiguration::~VhtConfiguration() { NS_LOG_FUNCTION(this); }

TypeId VhtConfiguration::GetTypeId() {
...
void VhtConfiguration::Set160MHzOperationSupported(bool enable) {
  NS_LOG_FUNCTION(this << enable);
  m_160MHzSupported = enable;
}

bool VhtConfiguration::Get160MHzOperationSupported() const {
  return m_160MHzSupported;
}

void VhtConfiguration::SetSecondaryCcaSensitivityThresholds(
