...
TypeId WifiTxCurrentModel::GetTypeId() {
...
TypeId LinearWifiTxCurrentModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::LinearWifiTxCurrentModel")
          ...
          .AddAttribute(
              "Voltage", "The supply voltage (in Volts).", DoubleValue(3.0),
...
LinearWifiTxCurrentModel::LinearWifiTxCurrentModel() { NS_LOG_FUNCTION(this); }

LinearWifiTxCurrentModel::~LinearWifiTxCurrentModel() { NS_LOG_FUNCTION(this); }

double LinearWifiTxCurrentModel::CalcTxCurrent(double txPowerDbm) const {
