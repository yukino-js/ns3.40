...
TypeId ThresholdPreambleDetectionModel::GetTypeId() {
  static TypeId tid =
...
bool ThresholdPreambleDetectionModel::IsPreambleDetected(
    double rssi, double snr, double channelWidth) const {
