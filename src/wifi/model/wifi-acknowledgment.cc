...
void WifiAcknowledgment::SetQosAckPolicy(
    Mac48Address receiver, uint8_t tid, WifiMacHeader::QosAckPolicy ackPolicy) {
  NS_ABORT_MSG_IF(!CheckQosAckPolicy(receiver, tid, ackPolicy),
                  "QoS Ack policy not admitted");
...
std::unique_ptr<WifiAcknowledgment> WifiNoAck::Copy() const {
  return std::make_unique<WifiNoAck>(*this);
}

bool WifiNoAck::CheckQosAckPolicy(Mac48Address receiver, uint8_t tid,
                                  WifiMacHeader::QosAckPolicy ackPolicy) const {
  return ackPolicy == WifiMacHeader::NO_ACK ||
         ackPolicy == WifiMacHeader::BLOCK_ACK;
}
...
bool WifiNormalAck::CheckQosAckPolicy(
...
std::unique_ptr<WifiAcknowledgment> WifiBlockAck::Copy() const {
  return std::make_unique<WifiBlockAck>(*this);
}

bool WifiBlockAck::CheckQosAckPolicy(
    Mac48Address receiver, uint8_t tid,
    WifiMacHeader::QosAckPolicy ackPolicy) const {
  return ackPolicy == WifiMacHeader::NORMAL_ACK;
}
...
bool WifiBarBlockAck::CheckQosAckPolicy(
    Mac48Address receiver, uint8_t tid,
    WifiMacHeader::QosAckPolicy ackPolicy) const {
...
std::unique_ptr<WifiAcknowledgment> WifiDlMuBarBaSequence::Copy() const {
  return std::make_unique<WifiDlMuBarBaSequence>(*this);
}

bool WifiDlMuBarBaSequence::CheckQosAckPolicy(
    Mac48Address receiver, uint8_t tid,
    WifiMacHeader::QosAckPolicy ackPolicy) const {
...
void WifiDlMuBarBaSequence::Print(std::ostream &os) const {
...
std::unique_ptr<WifiAcknowledgment> WifiDlMuTfMuBar::Copy() const {
...
void WifiDlMuTfMuBar::Print(std::ostream &os) const {
  os << "DL_MU_TF_MU_BAR [";
  for (const auto &sta : stationsReplyingWithBlockAck) {
    os << " (BA) " << sta.first;
  }
...
std::unique_ptr<WifiAcknowledgment> WifiDlMuAggregateTf::Copy() const {
...
void WifiDlMuAggregateTf::Print(std::ostream &os) const {
...
std::unique_ptr<WifiAcknowledgment> WifiUlMuMultiStaBa::Copy() const {
...
void WifiUlMuMultiStaBa::Print(std::ostream &os) const {
...
std::unique_ptr<WifiAcknowledgment> WifiAckAfterTbPpdu::Copy() const {
  return std::make_unique<WifiAckAfterTbPpdu>(*this);
}

bool WifiAckAfterTbPpdu::CheckQosAckPolicy(
    Mac48Address receiver, uint8_t tid,
    WifiMacHeader::QosAckPolicy ackPolicy) const {
  return ackPolicy == WifiMacHeader::NORMAL_ACK;
}

void WifiAckAfterTbPpdu::Print(std::ostream &os) const {
