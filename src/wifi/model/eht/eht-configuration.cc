...
EhtConfiguration::EhtConfiguration() { NS_LOG_FUNCTION(this); }

EhtConfiguration::~EhtConfiguration() { NS_LOG_FUNCTION(this); }

TypeId EhtConfiguration::GetTypeId() {
  using TidLinkMapValue = PairValue<AttributeContainerValue<UintegerValue>,
...
EhtConfiguration::GetTidLinkMapping(WifiDirection dir) const {
  ...
  const auto &linkMapping =
      (dir == WifiDirection::DOWNLINK ? m_linkMappingDl : m_linkMappingUl);
...
void EhtConfiguration::SetTidLinkMapping(
    WifiDirection dir,
