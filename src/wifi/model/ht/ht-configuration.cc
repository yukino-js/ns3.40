...
HtConfiguration::HtConfiguration() { NS_LOG_FUNCTION(this); }

HtConfiguration::~HtConfiguration() { NS_LOG_FUNCTION(this); }

TypeId HtConfiguration::GetTypeId() {
...
bool HtConfiguration::GetShortGuardIntervalSupported() const {
  return m_sgiSupported;
}

void HtConfiguration::SetLdpcSupported(bool enable) {
  NS_LOG_FUNCTION(this << enable);
  m_ldpcSupported = enable;
}

bool HtConfiguration::GetLdpcSupported() const { return m_ldpcSupported; }

void HtConfiguration::Set40MHzOperationSupported(bool enable) {
  NS_LOG_FUNCTION(this << enable);
  m_40MHzSupported = enable;
}

bool HtConfiguration::Get40MHzOperationSupported() const {
