...
private:
  ...
  uint16_t
      m_rxHighestSupportedDataRate; ///< receive highest supported data rate
  ...
  uint8_t m_explicitNoncompressedSteeringCapable; ///< explicit non compressed
                                                  ///< steering capable
  uint8_t m_explicitCompressedSteeringCapable; ///< explicit compressed steering
                                               ///< capable
  ...
  uint8_t
      m_noncompressedSteeringNBfAntennasSupported;  ///< non compressed steering
                                                    ///< NBF antenna supported
  uint8_t m_compressedSteeringNBfAntennasSupported; ///< compressed steering NBF
                                                    ///< antenna supported
  ...
  uint8_t m_explicitCsiFeedbackBasedTxASelCapable; ///< explicit CSI feedback
                                                   ...
                                                   ///< selection capable
  uint8_t
      m_antennaIndicesFeedbackBasedTxASelCapable; ///< antenna indices feedback
                                                  ///< based transmit antenna
                                                  ///< selection capable
