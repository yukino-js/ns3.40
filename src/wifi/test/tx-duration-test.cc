...
bool TxDurationTest::CheckPayloadDuration(uint32_t size, WifiMode payloadMode,
  ...
  for (auto &testedBand : testedBands) {
    if ((testedBand == WIFI_PHY_BAND_2_4GHZ) &&
      ...
      knownDuration += MicroSeconds(
          6); // 2.4 GHz band should be at the end of the bands to test
    }
...
void PhyHeaderSectionsTest::DoRun() {
  ...
  sections[WIFI_PPDU_FIELD_TRAINING] = {
      {ppduStart + MicroSeconds(28),
       ppduStart +
           MicroSeconds(52)}, // 1 HT-STF + 5 HT-LTFs (4 data + 1 extension)
      htSigMode};
  CheckPhyHeaderSections(phyEntity->GetPhyHeaderSections(txVector, ppduStart),
                         sections);
  ...
  sections = {
      ...
      {WIFI_PPDU_FIELD_TRAINING,
       {{ppduStart + MicroSeconds(32),
         ppduStart +
             MicroSeconds(52)}, // 1 HE-STF (@ 4 us) + 2 HE-LTFs (@ 8 us)
        sigAMode}},
  };
  CheckPhyHeaderSections(phyEntity->GetPhyHeaderSections(txVector, ppduStart),
                         sections);
  ...
  // 11be (EHT)
  sections.erase(
      WIFI_PPDU_FIELD_SIG_A); // FIXME: do we keep using separate type for 11be?
  sections.erase(
      WIFI_PPDU_FIELD_SIG_B); // FIXME: do we keep using separate type for 11be?
  ...
  sections[WIFI_PPDU_FIELD_TRAINING] = {
      {ppduStart + MicroSeconds(32),
       ppduStart +
           MicroSeconds(56)}, // 1 EHT-STF (@ 8 us) + 2 EHT-LTFs (@ 8 us)
      uSigMode};
  CheckPhyHeaderSections(phyEntity->GetPhyHeaderSections(txVector, ppduStart),
                         sections);
...
TxDurationTestSuite::TxDurationTestSuite()
  ...
  AddTestCase(
      new HeSigBDurationTest(
          ...
          VhtPhy::GetVhtMcs5(), 20, HeSigBDurationTest::OFDMA, {96},
  ...
  AddTestCase(
      new HeSigBDurationTest(
          ...
          VhtPhy::GetVhtMcs4(), 40, HeSigBDurationTest::OFDMA, {96, 112},
  ...
  AddTestCase(
      new HeSigBDurationTest(
          ...
          VhtPhy::GetVhtMcs3(), 40, HeSigBDurationTest::OFDMA, {96, 15},
  ...
  AddTestCase(
      new HeSigBDurationTest(
          ...
          VhtPhy::GetVhtMcs1(), 160, HeSigBDurationTest::OFDMA,
  ...
  AddTestCase(new HeSigBDurationTest(
                  ...
                  VhtPhy::GetVhtMcs5(), 20, HeSigBDurationTest::OFDMA, {0},
  ...
  AddTestCase(
      new HeSigBDurationTest(
          ...
          VhtPhy::GetVhtMcs5(), 20, HeSigBDurationTest::MU_MIMO, {192},
          std::make_pair(2, 0), // both users in HE-SIG-B content channel 1
          MicroSeconds(4)),     // one OFDM symbol
      TestCase::QUICK);
  ...
  AddTestCase(
      new HeSigBDurationTest(
          {{{HeRu::RU_242_TONE, 1, true}, 4, 3},
           {{HeRu::RU_242_TONE, 1, true}, 5, 2},
           {{HeRu::RU_242_TONE, 1, true}, 6, 1}},
          VhtPhy::GetVhtMcs4(), 20, HeSigBDurationTest::MU_MIMO, {192},
  ...
  AddTestCase(
      new HeSigBDurationTest(
          ...
          VhtPhy::GetVhtMcs5(), 40, HeSigBDurationTest::MU_MIMO, {200, 200},
          std::make_pair(
              1, 1), // users equally split between the two content channels
          MicroSeconds(4)), // one OFDM symbol
      TestCase::QUICK);
  ...
  AddTestCase(new HeSigBDurationTest(
                  ...
                  VhtPhy::GetVhtMcs4(), 40, HeSigBDurationTest::MU_MIMO,
                  {200, 200},
  ...
  AddTestCase(
      new HeSigBDurationTest(
          ...
          VhtPhy::GetVhtMcs4(), 40, HeSigBDurationTest::MU_MIMO, {200, 200},
          std::make_pair(
              2, 2), // users equally split between the two content channels
          MicroSeconds(4)), // one OFDM symbol
      TestCase::QUICK);
  ...
  AddTestCase(
      new HeSigBDurationTest(
          ...
          VhtPhy::GetVhtMcs4(), 40, HeSigBDurationTest::MU_MIMO, {200, 200},
          std::make_pair(
              3, 3), // users equally split between the two content channels
          MicroSeconds(4)), // one OFDM symbol
      TestCase::QUICK);
  ...
  AddTestCase(
      new HeSigBDurationTest(
          ...
          VhtPhy::GetVhtMcs4(), 40, HeSigBDurationTest::MU_MIMO, {200, 200},
          std::make_pair(
              4, 4), // users equally split between the two content channels
          MicroSeconds(4)), // one OFDM symbol
      TestCase::QUICK);
  ...
  AddTestCase(
      new HeSigBDurationTest(
          ...
          VhtPhy::GetVhtMcs5(), 160, HeSigBDurationTest::MU_MIMO,
  ...
  AddTestCase(new HeSigBDurationTest(
                  ...
                  VhtPhy::GetVhtMcs4(), 160, HeSigBDurationTest::MU_MIMO,
                  {208, 208, 208, 208, 208, 208, 208, 208},
                  std::make_pair(2, 1), // 2 users in content channel 1 and 1
                                        // user in content channel 2
                  MicroSeconds(4)),     // one OFDM symbol
