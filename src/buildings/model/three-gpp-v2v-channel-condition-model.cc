...
TypeId ThreeGppV2vUrbanChannelConditionModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::ThreeGppV2vUrbanChannelConditionModel")
...
double ThreeGppV2vUrbanChannelConditionModel::ComputePlos(
...
double ThreeGppV2vUrbanChannelConditionModel::ComputePnlos(
    Ptr<const MobilityModel> a, Ptr<const MobilityModel> b) const {
  NS_LOG_FUNCTION(this);
...
TypeId ThreeGppV2vHighwayChannelConditionModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::ThreeGppV2vHighwayChannelConditionModel")
          .SetParent<ThreeGppChannelConditionModel>()
          .SetGroupName("Buildings")
...
ThreeGppV2vHighwayChannelConditionModel::
    ...
    : ThreeGppChannelConditionModel() {
  m_buildingsCcm = CreateObject<BuildingsChannelConditionModel>();
  ComputeChCond = std::bind(
      &ThreeGppV2vHighwayChannelConditionModel::GetChCondAndFixCallback, this,
...
double ThreeGppV2vHighwayChannelConditionModel::ComputePlos(
    Ptr<const MobilityModel> a, Ptr<const MobilityModel> b) const {
  NS_LOG_FUNCTION(this);
...
double ThreeGppV2vHighwayChannelConditionModel::ComputePnlos(
    Ptr<const MobilityModel> a, Ptr<const MobilityModel> b) const {
  NS_LOG_FUNCTION(this);
...
ThreeGppV2vHighwayChannelConditionModel::GetChCondAndFixCallback(
    Ptr<const MobilityModel> a, Ptr<const MobilityModel> b) {
  Ptr<ChannelCondition> cond;
  if (BuildingList::Begin() != BuildingList::End()) {
    ComputeChCond = std::bind(
        &ThreeGppV2vHighwayChannelConditionModel::GetChCondWithBuildings, this,
        std::placeholders::_1, std::placeholders::_2);
...
Ptr<ChannelCondition>
ThreeGppV2vHighwayChannelConditionModel::GetChCondWithBuildings(
    Ptr<const MobilityModel> a, Ptr<const MobilityModel> b) const {
  Ptr<ChannelCondition> cond = m_buildingsCcm->GetChannelCondition(a, b);
  return cond;
}
