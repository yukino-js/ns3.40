...
XmlConfigSave::XmlConfigSave() : m_writer(nullptr) { NS_LOG_FUNCTION(this); }

void XmlConfigSave::SetFilename(std::string filename) {
...
void XmlConfigSave::Default() {
  class XmlDefaultIterator : public AttributeDefaultIterator {
  public:
    XmlDefaultIterator(xmlTextWriterPtr writer) { m_writer = writer; }
...
void XmlConfigSave::Attributes() {
  class XmlTextAttributeIterator : public AttributeIterator {
  public:
    XmlTextAttributeIterator(xmlTextWriterPtr writer) : m_writer(writer) {}
...
XmlConfigLoad::XmlConfigLoad() { NS_LOG_FUNCTION(this); }

XmlConfigLoad::~XmlConfigLoad() { NS_LOG_FUNCTION(this); }

void XmlConfigLoad::SetFilename(std::string filename) {
  NS_LOG_FUNCTION(filename);
  m_filename = filename;
}

void XmlConfigLoad::Default() {
