...
public:
  ...
  enum FrameFlag {
    ...
    FRAME_FLAG_SHORT_PREAMBLE =
        0x02,              /**< Frame sent/received with short preamble */
  ...
  enum McsFlags {
    ...
    MCS_FLAGS_BANDWIDTH_20L =
        0x02, /**< 20L (20 MHz in lower half of 40 MHz channel) */
    MCS_FLAGS_BANDWIDTH_20U =
        0x03, /**< 20U (20 MHz in upper half of 40 MHz channel) */
  ...
  enum AmpduFlags {
    ...
    A_MPDU_STATUS_DELIMITER_CRC_KNOWN =
        0x20 /**< Delimiter CRC value known: the delimiter CRC value field is
                valid */
  };
  ...
  enum VhtKnown {
    ...
    VHT_KNOWN_SHORT_GI_NSYM_DISAMBIGUATION =
        0x0008, /**< Short GI NSYM disambiguation known */
    VHT_KNOWN_LDPC_EXTRA_OFDM_SYMBOL =
        0x0010,                     /**< LDPC extra OFDM symbol known */
  ...
  enum VhtFlags {
    ...
    VHT_FLAGS_TXOP_PS_NOT_ALLOWED =
        0x02, /**< Set if STAs may not doze during TXOP (valid only for AP
                 transmitters). */
    ...
    VHT_FLAGS_BEAMFORMED =
        0x20, /**< Set if beamforming is used (valid for SU PPDUs only). */
  };
  ...
  enum HeData1 {
    ...
    HE_DATA1_SPTL_REUSE2_KNOWN =
        0x0800, /**< Spatial Reuse 2 known (HE TRIG PPDU format),
                   STA-ID known (HE MU PPDU format) */
    HE_DATA1_SPTL_REUSE3_KNOWN =
        0x1000, /**< Spatial Reuse 3 known (HE TRIG PPDU format) */
    HE_DATA1_SPTL_REUSE4_KNOWN =
        0x2000, /**< Spatial Reuse 4 known (HE TRIG PPDU format) */
  ...
  enum HeMuFlags2 {
    HE_MU_FLAGS2_BW_FROM_SIGA =
        0x0003, /**< Bandwidth from Bandwidth field in HE-SIG-A */
    ...
    HE_MU_FLAGS2_NUM_SIGB_SYMBOLS_FROM_SIGA =
        0x00f0, /**< # of HE-SIG-B Symbols - 1 or # of MU-MIMO Users - 1 from
                   SIG-A */
  ...
  enum HeMuPerUserKnown {
    ...
    HE_MU_PER_USER_SPATIAL_CONFIGURATION_KNOWN =
        0x10,                           //!< Spatial Configuration known
