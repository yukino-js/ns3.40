...
TypeId PcapFileWrapper::GetTypeId() {
  static TypeId tid =
...
PcapFileWrapper::PcapFileWrapper() { NS_LOG_FUNCTION(this); }
...
bool PcapFileWrapper::Fail() const {
  NS_LOG_FUNCTION(this);
  return m_file.Fail();
}

bool PcapFileWrapper::Eof() const {
  NS_LOG_FUNCTION(this);
  return m_file.Eof();
}

void PcapFileWrapper::Clear() {
  NS_LOG_FUNCTION(this);
  m_file.Clear();
}

void PcapFileWrapper::Close() {
  NS_LOG_FUNCTION(this);
  m_file.Close();
}

void PcapFileWrapper::Open(const std::string &filename,
...
void PcapFileWrapper::Write(Time t, Ptr<const Packet> p) {
...
void PcapFileWrapper::Write(Time t, const Header &header, Ptr<const Packet> p) {
...
void PcapFileWrapper::Write(Time t, const uint8_t *buffer, uint32_t length) {
...
Ptr<Packet> PcapFileWrapper::Read(Time &t) {
  uint32_t tsSec;
  uint32_t tsUsec;
  uint32_t inclLen;
  uint32_t origLen;
...
uint32_t PcapFileWrapper::GetMagic() {
  NS_LOG_FUNCTION(this);
  return m_file.GetMagic();
}

uint16_t PcapFileWrapper::GetVersionMajor() {
  NS_LOG_FUNCTION(this);
  return m_file.GetVersionMajor();
}

uint16_t PcapFileWrapper::GetVersionMinor() {
  NS_LOG_FUNCTION(this);
  return m_file.GetVersionMinor();
}

int32_t PcapFileWrapper::GetTimeZoneOffset() {
  NS_LOG_FUNCTION(this);
  return m_file.GetTimeZoneOffset();
}

uint32_t PcapFileWrapper::GetSigFigs() {
  NS_LOG_FUNCTION(this);
  return m_file.GetSigFigs();
}

uint32_t PcapFileWrapper::GetSnapLen() {
  NS_LOG_FUNCTION(this);
  return m_file.GetSnapLen();
}

uint32_t PcapFileWrapper::GetDataLinkType() {
  NS_LOG_FUNCTION(this);
