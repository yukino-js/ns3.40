...
PbbTlvBlock::PbbTlvBlock() { NS_LOG_FUNCTION(this); }
...
PbbTlvBlock::Iterator PbbTlvBlock::Begin() {
  NS_LOG_FUNCTION(this);
  return m_tlvList.begin();
}

PbbTlvBlock::ConstIterator PbbTlvBlock::Begin() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.begin();
}

PbbTlvBlock::Iterator PbbTlvBlock::End() {
  NS_LOG_FUNCTION(this);
  return m_tlvList.end();
}

PbbTlvBlock::ConstIterator PbbTlvBlock::End() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.end();
}

int PbbTlvBlock::Size() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.size();
}

bool PbbTlvBlock::Empty() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.empty();
}

Ptr<PbbTlv> PbbTlvBlock::Front() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.front();
}

Ptr<PbbTlv> PbbTlvBlock::Back() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.back();
}

void PbbTlvBlock::PushFront(Ptr<PbbTlv> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_tlvList.push_front(tlv);
}

void PbbTlvBlock::PopFront() {
  NS_LOG_FUNCTION(this);
  m_tlvList.pop_front();
}

void PbbTlvBlock::PushBack(Ptr<PbbTlv> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_tlvList.push_back(tlv);
}

void PbbTlvBlock::PopBack() {
  NS_LOG_FUNCTION(this);
  m_tlvList.pop_back();
}

PbbTlvBlock::Iterator PbbTlvBlock::Insert(PbbTlvBlock::Iterator position,
                                          const Ptr<PbbTlv> tlv) {
  NS_LOG_FUNCTION(this << &position << tlv);
  return m_tlvList.insert(position, tlv);
}

PbbTlvBlock::Iterator PbbTlvBlock::Erase(PbbTlvBlock::Iterator position) {
  NS_LOG_FUNCTION(this << &position);
  return m_tlvList.erase(position);
}

PbbTlvBlock::Iterator PbbTlvBlock::Erase(PbbTlvBlock::Iterator first,
                                         PbbTlvBlock::Iterator last) {
  NS_LOG_FUNCTION(this << &first << &last);
  return m_tlvList.erase(first, last);
}

void PbbTlvBlock::Clear() {
  NS_LOG_FUNCTION(this);
...
void PbbTlvBlock::Serialize(Buffer::Iterator &start) const {
...
void PbbTlvBlock::Deserialize(Buffer::Iterator &start) {
  NS_LOG_FUNCTION(this << &start);
...
void PbbTlvBlock::Print(std::ostream &os) const {
  NS_LOG_FUNCTION(this << &os);
  Print(os, 0);
}

void PbbTlvBlock::Print(std::ostream &os, int level) const {
...
bool PbbTlvBlock::operator==(const PbbTlvBlock &other) const {
  ...
  ConstIterator ti;
  ConstIterator oi;
  for (ti = Begin(), oi = other.Begin(); ti != End() && oi != other.End();
       ti++, oi++) {
    if (**ti != **oi) {
      return false;
    }
...
PbbAddressTlvBlock::Iterator PbbAddressTlvBlock::Begin() {
  NS_LOG_FUNCTION(this);
  return m_tlvList.begin();
}

PbbAddressTlvBlock::ConstIterator PbbAddressTlvBlock::Begin() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.begin();
}

PbbAddressTlvBlock::Iterator PbbAddressTlvBlock::End() {
  NS_LOG_FUNCTION(this);
  return m_tlvList.end();
}

PbbAddressTlvBlock::ConstIterator PbbAddressTlvBlock::End() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.end();
}

int PbbAddressTlvBlock::Size() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.size();
}

bool PbbAddressTlvBlock::Empty() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.empty();
}

Ptr<PbbAddressTlv> PbbAddressTlvBlock::Front() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.front();
}

Ptr<PbbAddressTlv> PbbAddressTlvBlock::Back() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.back();
}

void PbbAddressTlvBlock::PushFront(Ptr<PbbAddressTlv> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_tlvList.push_front(tlv);
}

void PbbAddressTlvBlock::PopFront() {
  NS_LOG_FUNCTION(this);
  m_tlvList.pop_front();
}

void PbbAddressTlvBlock::PushBack(Ptr<PbbAddressTlv> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_tlvList.push_back(tlv);
}

void PbbAddressTlvBlock::PopBack() {
  NS_LOG_FUNCTION(this);
  m_tlvList.pop_back();
}

PbbAddressTlvBlock::Iterator
PbbAddressTlvBlock::Insert(PbbAddressTlvBlock::Iterator position,
...
PbbAddressTlvBlock::Iterator
PbbAddressTlvBlock::Erase(PbbAddressTlvBlock::Iterator first,
                          PbbAddressTlvBlock::Iterator last) {
  NS_LOG_FUNCTION(this << &first << &last);
  return m_tlvList.erase(first, last);
}

void PbbAddressTlvBlock::Clear() {
  NS_LOG_FUNCTION(this);
  for (auto iter = Begin(); iter != End(); iter++) {
    *iter = nullptr;
  }
...
void PbbAddressTlvBlock::Serialize(Buffer::Iterator &start) const {
  NS_LOG_FUNCTION(this << &start);
  if (Empty()) {
    start.WriteHtonU16(0);
    return;
...
void PbbAddressTlvBlock::Deserialize(Buffer::Iterator &start) {
  NS_LOG_FUNCTION(this << &start);
  uint16_t size = start.ReadNtohU16();
...
void PbbAddressTlvBlock::Print(std::ostream &os) const {
  NS_LOG_FUNCTION(this << &os);
  Print(os, 0);
}

void PbbAddressTlvBlock::Print(std::ostream &os, int level) const {
  NS_LOG_FUNCTION(this << &os << level);
  std::string prefix = "";
  for (int i = 0; i < level; i++) {
    prefix.append("\t");
...
bool PbbAddressTlvBlock::operator==(const PbbAddressTlvBlock &other) const {
  if (Size() != other.Size()) {
    return false;
  }
  ...
  ConstIterator it;
  ConstIterator ot;
  for (it = Begin(), ot = other.Begin(); it != End() && ot != other.End();
       it++, ot++) {
    if (**it != **ot) {
      return false;
    }
...
uint8_t PbbPacket::GetVersion() const {
  NS_LOG_FUNCTION(this);
  return m_version;
}

void PbbPacket::SetSequenceNumber(uint16_t number) {
  NS_LOG_FUNCTION(this << number);
  m_seqnum = number;
  m_hasseqnum = true;
}

uint16_t PbbPacket::GetSequenceNumber() const {
  NS_LOG_FUNCTION(this);
  NS_ASSERT(HasSequenceNumber());
  return m_seqnum;
}

bool PbbPacket::HasSequenceNumber() const {
  NS_LOG_FUNCTION(this);
  return m_hasseqnum;
}
...
PbbPacket::ConstTlvIterator PbbPacket::TlvBegin() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Begin();
}

PbbPacket::TlvIterator PbbPacket::TlvEnd() {
  NS_LOG_FUNCTION(this);
  return m_tlvList.End();
}

PbbPacket::ConstTlvIterator PbbPacket::TlvEnd() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.End();
}

int PbbPacket::TlvSize() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Size();
}

bool PbbPacket::TlvEmpty() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Empty();
}

Ptr<PbbTlv> PbbPacket::TlvFront() {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Front();
}

const Ptr<PbbTlv> PbbPacket::TlvFront() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Front();
}

Ptr<PbbTlv> PbbPacket::TlvBack() {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Back();
}

const Ptr<PbbTlv> PbbPacket::TlvBack() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Back();
}

void PbbPacket::TlvPushFront(Ptr<PbbTlv> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_tlvList.PushFront(tlv);
}

void PbbPacket::TlvPopFront() {
  NS_LOG_FUNCTION(this);
  m_tlvList.PopFront();
}

void PbbPacket::TlvPushBack(Ptr<PbbTlv> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_tlvList.PushBack(tlv);
}

void PbbPacket::TlvPopBack() {
  NS_LOG_FUNCTION(this);
  m_tlvList.PopBack();
}

PbbPacket::TlvIterator PbbPacket::Erase(PbbPacket::TlvIterator position) {
  NS_LOG_FUNCTION(this << &position);
  return m_tlvList.Erase(position);
}

PbbPacket::TlvIterator PbbPacket::Erase(PbbPacket::TlvIterator first,
                                        PbbPacket::TlvIterator last) {
  NS_LOG_FUNCTION(this << &first << &last);
  return m_tlvList.Erase(first, last);
}

void PbbPacket::TlvClear() {
  NS_LOG_FUNCTION(this);
  m_tlvList.Clear();
}
...
PbbPacket::ConstMessageIterator PbbPacket::MessageBegin() const {
  NS_LOG_FUNCTION(this);
  return m_messageList.begin();
}

PbbPacket::MessageIterator PbbPacket::MessageEnd() {
  NS_LOG_FUNCTION(this);
  return m_messageList.end();
}

PbbPacket::ConstMessageIterator PbbPacket::MessageEnd() const {
  NS_LOG_FUNCTION(this);
  return m_messageList.end();
}

int PbbPacket::MessageSize() const {
  NS_LOG_FUNCTION(this);
  return m_messageList.size();
}

bool PbbPacket::MessageEmpty() const {
  NS_LOG_FUNCTION(this);
  return m_messageList.empty();
}

Ptr<PbbMessage> PbbPacket::MessageFront() {
  NS_LOG_FUNCTION(this);
  return m_messageList.front();
}

const Ptr<PbbMessage> PbbPacket::MessageFront() const {
  NS_LOG_FUNCTION(this);
  return m_messageList.front();
}

Ptr<PbbMessage> PbbPacket::MessageBack() {
  NS_LOG_FUNCTION(this);
  return m_messageList.back();
}

const Ptr<PbbMessage> PbbPacket::MessageBack() const {
  NS_LOG_FUNCTION(this);
  return m_messageList.back();
}

void PbbPacket::MessagePushFront(Ptr<PbbMessage> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_messageList.push_front(tlv);
}

void PbbPacket::MessagePopFront() {
  NS_LOG_FUNCTION(this);
  m_messageList.pop_front();
}

void PbbPacket::MessagePushBack(Ptr<PbbMessage> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_messageList.push_back(tlv);
}

void PbbPacket::MessagePopBack() {
  NS_LOG_FUNCTION(this);
...
PbbPacket::MessageIterator PbbPacket::Erase(PbbPacket::MessageIterator first,
                                            PbbPacket::MessageIterator last) {
  NS_LOG_FUNCTION(this << &first << &last);
  return m_messageList.erase(first, last);
}

void PbbPacket::MessageClear() {
  NS_LOG_FUNCTION(this);
...
TypeId PbbPacket::GetInstanceTypeId() const { return GetTypeId(); }
...
uint32_t PbbPacket::Deserialize(Buffer::Iterator start) {
  NS_LOG_FUNCTION(this << &start);
...
void PbbPacket::Print(std::ostream &os) const {
  NS_LOG_FUNCTION(this << &os);
...
bool PbbPacket::operator==(const PbbPacket &other) const {
...
void PbbMessage::SetType(uint8_t type) {
  NS_LOG_FUNCTION(this << static_cast<uint32_t>(type));
  m_type = type;
}

uint8_t PbbMessage::GetType() const {
  NS_LOG_FUNCTION(this);
  return m_type;
}

PbbAddressLength PbbMessage::GetAddressLength() const {
  NS_LOG_FUNCTION(this);
  return m_addrSize;
}

void PbbMessage::SetOriginatorAddress(Address address) {
  NS_LOG_FUNCTION(this << address);
  m_originatorAddress = address;
  m_hasOriginatorAddress = true;
}

Address PbbMessage::GetOriginatorAddress() const {
  NS_LOG_FUNCTION(this);
  NS_ASSERT(HasOriginatorAddress());
  return m_originatorAddress;
}

bool PbbMessage::HasOriginatorAddress() const {
  NS_LOG_FUNCTION(this);
  return m_hasOriginatorAddress;
}

void PbbMessage::SetHopLimit(uint8_t hopLimit) {
  NS_LOG_FUNCTION(this << static_cast<uint32_t>(hopLimit));
  m_hopLimit = hopLimit;
  m_hasHopLimit = true;
}

uint8_t PbbMessage::GetHopLimit() const {
  NS_LOG_FUNCTION(this);
  NS_ASSERT(HasHopLimit());
  return m_hopLimit;
}

bool PbbMessage::HasHopLimit() const {
  NS_LOG_FUNCTION(this);
  return m_hasHopLimit;
}

void PbbMessage::SetHopCount(uint8_t hopCount) {
  NS_LOG_FUNCTION(this << static_cast<uint32_t>(hopCount));
  m_hopCount = hopCount;
  m_hasHopCount = true;
}

uint8_t PbbMessage::GetHopCount() const {
  NS_LOG_FUNCTION(this);
  NS_ASSERT(HasHopCount());
  return m_hopCount;
}

bool PbbMessage::HasHopCount() const {
  NS_LOG_FUNCTION(this);
  return m_hasHopCount;
}

void PbbMessage::SetSequenceNumber(uint16_t sequenceNumber) {
  NS_LOG_FUNCTION(this << sequenceNumber);
  m_sequenceNumber = sequenceNumber;
  m_hasSequenceNumber = true;
}

uint16_t PbbMessage::GetSequenceNumber() const {
  NS_LOG_FUNCTION(this);
  NS_ASSERT(HasSequenceNumber());
  return m_sequenceNumber;
}

bool PbbMessage::HasSequenceNumber() const {
  NS_LOG_FUNCTION(this);
...
PbbMessage::ConstTlvIterator PbbMessage::TlvBegin() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Begin();
}

PbbMessage::TlvIterator PbbMessage::TlvEnd() {
  NS_LOG_FUNCTION(this);
  return m_tlvList.End();
}

PbbMessage::ConstTlvIterator PbbMessage::TlvEnd() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.End();
}

int PbbMessage::TlvSize() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Size();
}

bool PbbMessage::TlvEmpty() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Empty();
}

Ptr<PbbTlv> PbbMessage::TlvFront() {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Front();
}

const Ptr<PbbTlv> PbbMessage::TlvFront() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Front();
}

Ptr<PbbTlv> PbbMessage::TlvBack() {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Back();
}

const Ptr<PbbTlv> PbbMessage::TlvBack() const {
  NS_LOG_FUNCTION(this);
  return m_tlvList.Back();
}

void PbbMessage::TlvPushFront(Ptr<PbbTlv> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_tlvList.PushFront(tlv);
}

void PbbMessage::TlvPopFront() {
  NS_LOG_FUNCTION(this);
  m_tlvList.PopFront();
}

void PbbMessage::TlvPushBack(Ptr<PbbTlv> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_tlvList.PushBack(tlv);
}

void PbbMessage::TlvPopBack() {
  NS_LOG_FUNCTION(this);
  m_tlvList.PopBack();
}

PbbMessage::TlvIterator PbbMessage::TlvErase(PbbMessage::TlvIterator position) {
  NS_LOG_FUNCTION(this << &position);
  return m_tlvList.Erase(position);
}

PbbMessage::TlvIterator PbbMessage::TlvErase(PbbMessage::TlvIterator first,
                                             PbbMessage::TlvIterator last) {
  NS_LOG_FUNCTION(this << &first << &last);
  return m_tlvList.Erase(first, last);
}

void PbbMessage::TlvClear() {
  NS_LOG_FUNCTION(this);
  m_tlvList.Clear();
}
...
PbbMessage::ConstAddressBlockIterator PbbMessage::AddressBlockBegin() const {
  NS_LOG_FUNCTION(this);
  return m_addressBlockList.begin();
}

PbbMessage::AddressBlockIterator PbbMessage::AddressBlockEnd() {
  NS_LOG_FUNCTION(this);
  return m_addressBlockList.end();
}

PbbMessage::ConstAddressBlockIterator PbbMessage::AddressBlockEnd() const {
  NS_LOG_FUNCTION(this);
  return m_addressBlockList.end();
}

int PbbMessage::AddressBlockSize() const {
  NS_LOG_FUNCTION(this);
  return m_addressBlockList.size();
}

bool PbbMessage::AddressBlockEmpty() const {
  NS_LOG_FUNCTION(this);
  return m_addressBlockList.empty();
}

Ptr<PbbAddressBlock> PbbMessage::AddressBlockFront() {
  NS_LOG_FUNCTION(this);
  return m_addressBlockList.front();
}

const Ptr<PbbAddressBlock> PbbMessage::AddressBlockFront() const {
  NS_LOG_FUNCTION(this);
  return m_addressBlockList.front();
}

Ptr<PbbAddressBlock> PbbMessage::AddressBlockBack() {
  NS_LOG_FUNCTION(this);
  return m_addressBlockList.back();
}

const Ptr<PbbAddressBlock> PbbMessage::AddressBlockBack() const {
  NS_LOG_FUNCTION(this);
  return m_addressBlockList.back();
}

void PbbMessage::AddressBlockPushFront(Ptr<PbbAddressBlock> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_addressBlockList.push_front(tlv);
}

void PbbMessage::AddressBlockPopFront() {
  NS_LOG_FUNCTION(this);
  m_addressBlockList.pop_front();
}

void PbbMessage::AddressBlockPushBack(Ptr<PbbAddressBlock> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_addressBlockList.push_back(tlv);
}

void PbbMessage::AddressBlockPopBack() {
  NS_LOG_FUNCTION(this);
...
void PbbMessage::Serialize(Buffer::Iterator &start) const {
  NS_LOG_FUNCTION(this << &start);
...
void PbbMessage::Deserialize(Buffer::Iterator &start) {
  NS_LOG_FUNCTION(this << &start);
  Buffer::Iterator front = start;
...
void PbbMessage::Print(std::ostream &os) const {
  NS_LOG_FUNCTION(this << &os);
  Print(os, 0);
}

void PbbMessage::Print(std::ostream &os, int level) const {
  NS_LOG_FUNCTION(this << &os << level);
  std::string prefix = "";
  for (int i = 0; i < level; i++) {
    prefix.append("\t");
...
bool PbbMessage::operator==(const PbbMessage &other) const {
...
void PbbMessageIpv4::SerializeOriginatorAddress(Buffer::Iterator &start) const {
  NS_LOG_FUNCTION(this << &start);
...
void PbbMessageIpv4::PrintOriginatorAddress(std::ostream &os) const {
  NS_LOG_FUNCTION(this << &os);
...
PbbAddressLength PbbMessageIpv6::GetAddressLength() const {
  NS_LOG_FUNCTION(this);
  return IPV6;
}

void PbbMessageIpv6::SerializeOriginatorAddress(Buffer::Iterator &start) const {
  NS_LOG_FUNCTION(this << &start);
  auto buffer = new uint8_t[GetAddressLength() + 1];
...
void PbbMessageIpv6::PrintOriginatorAddress(std::ostream &os) const {
  NS_LOG_FUNCTION(this << &os);
...
PbbAddressBlock::ConstAddressIterator PbbAddressBlock::AddressBegin() const {
  NS_LOG_FUNCTION(this);
  return m_addressList.begin();
}

PbbAddressBlock::AddressIterator PbbAddressBlock::AddressEnd() {
  NS_LOG_FUNCTION(this);
  return m_addressList.end();
}

PbbAddressBlock::ConstAddressIterator PbbAddressBlock::AddressEnd() const {
  NS_LOG_FUNCTION(this);
  return m_addressList.end();
}

int PbbAddressBlock::AddressSize() const {
  NS_LOG_FUNCTION(this);
  return m_addressList.size();
}

bool PbbAddressBlock::AddressEmpty() const {
  NS_LOG_FUNCTION(this);
  return m_addressList.empty();
}

Address PbbAddressBlock::AddressFront() const {
  NS_LOG_FUNCTION(this);
  return m_addressList.front();
}

Address PbbAddressBlock::AddressBack() const {
  NS_LOG_FUNCTION(this);
  return m_addressList.back();
}

void PbbAddressBlock::AddressPushFront(Address tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_addressList.push_front(tlv);
}

void PbbAddressBlock::AddressPopFront() {
  NS_LOG_FUNCTION(this);
  m_addressList.pop_front();
}

void PbbAddressBlock::AddressPushBack(Address tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_addressList.push_back(tlv);
}

void PbbAddressBlock::AddressPopBack() {
  NS_LOG_FUNCTION(this);
...
void PbbAddressBlock::AddressClear() {
  NS_LOG_FUNCTION(this);
...
PbbAddressBlock::ConstPrefixIterator PbbAddressBlock::PrefixBegin() const {
  NS_LOG_FUNCTION(this);
  return m_prefixList.begin();
}

PbbAddressBlock::PrefixIterator PbbAddressBlock::PrefixEnd() {
  NS_LOG_FUNCTION(this);
  return m_prefixList.end();
}

PbbAddressBlock::ConstPrefixIterator PbbAddressBlock::PrefixEnd() const {
  NS_LOG_FUNCTION(this);
  return m_prefixList.end();
}

int PbbAddressBlock::PrefixSize() const {
  NS_LOG_FUNCTION(this);
  return m_prefixList.size();
}

bool PbbAddressBlock::PrefixEmpty() const {
  NS_LOG_FUNCTION(this);
  return m_prefixList.empty();
}

uint8_t PbbAddressBlock::PrefixFront() const {
  NS_LOG_FUNCTION(this);
  return m_prefixList.front();
}

uint8_t PbbAddressBlock::PrefixBack() const {
  NS_LOG_FUNCTION(this);
  return m_prefixList.back();
}

void PbbAddressBlock::PrefixPushFront(uint8_t prefix) {
  NS_LOG_FUNCTION(this << static_cast<uint32_t>(prefix));
  m_prefixList.push_front(prefix);
}

void PbbAddressBlock::PrefixPopFront() {
  NS_LOG_FUNCTION(this);
  m_prefixList.pop_front();
}

void PbbAddressBlock::PrefixPushBack(uint8_t prefix) {
  NS_LOG_FUNCTION(this << static_cast<uint32_t>(prefix));
  m_prefixList.push_back(prefix);
}

void PbbAddressBlock::PrefixPopBack() {
  NS_LOG_FUNCTION(this);
  m_prefixList.pop_back();
}

PbbAddressBlock::PrefixIterator
PbbAddressBlock::PrefixInsert(PbbAddressBlock::PrefixIterator position,
                              const uint8_t value) {
...
void PbbAddressBlock::PrefixClear() {
  NS_LOG_FUNCTION(this);
  m_prefixList.clear();
}
...
PbbAddressBlock::ConstTlvIterator PbbAddressBlock::TlvBegin() const {
  NS_LOG_FUNCTION(this);
  return m_addressTlvList.Begin();
}

PbbAddressBlock::TlvIterator PbbAddressBlock::TlvEnd() {
  NS_LOG_FUNCTION(this);
  return m_addressTlvList.End();
}

PbbAddressBlock::ConstTlvIterator PbbAddressBlock::TlvEnd() const {
  NS_LOG_FUNCTION(this);
  return m_addressTlvList.End();
}

int PbbAddressBlock::TlvSize() const {
  NS_LOG_FUNCTION(this);
  return m_addressTlvList.Size();
}

bool PbbAddressBlock::TlvEmpty() const {
  NS_LOG_FUNCTION(this);
  return m_addressTlvList.Empty();
}

Ptr<PbbAddressTlv> PbbAddressBlock::TlvFront() {
  NS_LOG_FUNCTION(this);
  return m_addressTlvList.Front();
}

const Ptr<PbbAddressTlv> PbbAddressBlock::TlvFront() const {
  NS_LOG_FUNCTION(this);
  return m_addressTlvList.Front();
}

Ptr<PbbAddressTlv> PbbAddressBlock::TlvBack() {
  NS_LOG_FUNCTION(this);
  return m_addressTlvList.Back();
}

const Ptr<PbbAddressTlv> PbbAddressBlock::TlvBack() const {
  NS_LOG_FUNCTION(this);
  return m_addressTlvList.Back();
}

void PbbAddressBlock::TlvPushFront(Ptr<PbbAddressTlv> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_addressTlvList.PushFront(tlv);
}

void PbbAddressBlock::TlvPopFront() {
  NS_LOG_FUNCTION(this);
  m_addressTlvList.PopFront();
}

void PbbAddressBlock::TlvPushBack(Ptr<PbbAddressTlv> tlv) {
  NS_LOG_FUNCTION(this << tlv);
  m_addressTlvList.PushBack(tlv);
}

void PbbAddressBlock::TlvPopBack() {
  NS_LOG_FUNCTION(this);
...
void PbbAddressBlock::Serialize(Buffer::Iterator &start) const {
  NS_LOG_FUNCTION(this << &start);
...
void PbbAddressBlock::Deserialize(Buffer::Iterator &start) {
  NS_LOG_FUNCTION(this << &start);
...
void PbbAddressBlock::Print(std::ostream &os) const {
  NS_LOG_FUNCTION(this << &os);
  Print(os, 0);
}

void PbbAddressBlock::Print(std::ostream &os, int level) const {
  NS_LOG_FUNCTION(this << &os << level);
  std::string prefix = "";
  for (int i = 0; i < level; i++) {
    prefix.append("\t");
...
bool PbbAddressBlock::operator==(const PbbAddressBlock &other) const {
...
uint8_t PbbAddressBlock::GetPrefixFlags() const {
  NS_LOG_FUNCTION(this);
  switch (PrefixSize()) {
  case 0:
    return 0;
...
void PbbAddressBlock::GetHeadTail(uint8_t *head, uint8_t &headlen,
...
bool PbbAddressBlock::HasZeroTail(const uint8_t *tail, uint8_t taillen) const {
...
uint8_t PbbAddressBlockIpv4::GetAddressLength() const {
  NS_LOG_FUNCTION(this);
  return 4;
}

void PbbAddressBlockIpv4::SerializeAddress(uint8_t *buffer,
                                           ConstAddressIterator iter) const {
  NS_LOG_FUNCTION(this << &buffer << &iter);
  Ipv4Address::ConvertFrom(*iter).Serialize(buffer);
}

Address PbbAddressBlockIpv4::DeserializeAddress(uint8_t *buffer) const {
  NS_LOG_FUNCTION(this << &buffer);
  return Ipv4Address::Deserialize(buffer);
}

void PbbAddressBlockIpv4::PrintAddress(std::ostream &os,
                                       ConstAddressIterator iter) const {
...
uint8_t PbbAddressBlockIpv6::GetAddressLength() const {
  NS_LOG_FUNCTION(this);
  return 16;
}

void PbbAddressBlockIpv6::SerializeAddress(uint8_t *buffer,
                                           ConstAddressIterator iter) const {
  NS_LOG_FUNCTION(this << &buffer << &iter);
  Ipv6Address::ConvertFrom(*iter).Serialize(buffer);
}

Address PbbAddressBlockIpv6::DeserializeAddress(uint8_t *buffer) const {
  NS_LOG_FUNCTION(this << &buffer);
  return Ipv6Address::Deserialize(buffer);
}

void PbbAddressBlockIpv6::PrintAddress(std::ostream &os,
                                       ConstAddressIterator iter) const {
  NS_LOG_FUNCTION(this << &os << &iter);
...
void PbbTlv::SetType(uint8_t type) {
  NS_LOG_FUNCTION(this << static_cast<uint32_t>(type));
  m_type = type;
}

uint8_t PbbTlv::GetType() const {
  NS_LOG_FUNCTION(this);
  return m_type;
}

void PbbTlv::SetTypeExt(uint8_t typeExt) {
  NS_LOG_FUNCTION(this << static_cast<uint32_t>(typeExt));
  m_typeExt = typeExt;
  m_hasTypeExt = true;
}

uint8_t PbbTlv::GetTypeExt() const {
  NS_LOG_FUNCTION(this);
  NS_ASSERT(HasTypeExt());
  return m_typeExt;
}

bool PbbTlv::HasTypeExt() const {
  NS_LOG_FUNCTION(this);
  return m_hasTypeExt;
}

void PbbTlv::SetIndexStart(uint8_t index) {
  NS_LOG_FUNCTION(this << static_cast<uint32_t>(index));
  m_indexStart = index;
  m_hasIndexStart = true;
}

uint8_t PbbTlv::GetIndexStart() const {
  NS_LOG_FUNCTION(this);
  NS_ASSERT(HasIndexStart());
  return m_indexStart;
}

bool PbbTlv::HasIndexStart() const {
  NS_LOG_FUNCTION(this);
  return m_hasIndexStart;
}

void PbbTlv::SetIndexStop(uint8_t index) {
  NS_LOG_FUNCTION(this << static_cast<uint32_t>(index));
  m_indexStop = index;
  m_hasIndexStop = true;
}

uint8_t PbbTlv::GetIndexStop() const {
  NS_LOG_FUNCTION(this);
  NS_ASSERT(HasIndexStop());
  return m_indexStop;
}

bool PbbTlv::HasIndexStop() const {
  NS_LOG_FUNCTION(this);
  return m_hasIndexStop;
}

void PbbTlv::SetMultivalue(bool isMultivalue) {
  NS_LOG_FUNCTION(this << isMultivalue);
  m_isMultivalue = isMultivalue;
}

bool PbbTlv::IsMultivalue() const {
  NS_LOG_FUNCTION(this);
  return m_isMultivalue;
}

void PbbTlv::SetValue(Buffer start) {
  NS_LOG_FUNCTION(this << &start);
  m_hasValue = true;
  m_value = start;
}

void PbbTlv::SetValue(const uint8_t *buffer, uint32_t size) {
...
Buffer PbbTlv::GetValue() const {
  NS_LOG_FUNCTION(this);
  NS_ASSERT(HasValue());
  return m_value;
}

bool PbbTlv::HasValue() const {
  NS_LOG_FUNCTION(this);
  return m_hasValue;
}
...
void PbbTlv::Serialize(Buffer::Iterator &start) const {
  NS_LOG_FUNCTION(this << &start);
  start.WriteU8(GetType());
...
void PbbTlv::Deserialize(Buffer::Iterator &start) {
  NS_LOG_FUNCTION(this << &start);
  SetType(start.ReadU8());
...
void PbbTlv::Print(std::ostream &os) const {
  NS_LOG_FUNCTION(this << &os);
  Print(os, 0);
}

void PbbTlv::Print(std::ostream &os, int level) const {
  NS_LOG_FUNCTION(this << &os << level);
  std::string prefix = "";
  for (int i = 0; i < level; i++) {
    prefix.append("\t");
...
bool PbbTlv::operator==(const PbbTlv &other) const {
  if (GetType() != other.GetType()) {
    return false;
  }
...
uint8_t PbbAddressTlv::GetIndexStart() const {
  NS_LOG_FUNCTION(this);
  return PbbTlv::GetIndexStart();
}

bool PbbAddressTlv::HasIndexStart() const {
  NS_LOG_FUNCTION(this);
  return PbbTlv::HasIndexStart();
}

void PbbAddressTlv::SetIndexStop(uint8_t index) {
  NS_LOG_FUNCTION(this << static_cast<uint32_t>(index));
  PbbTlv::SetIndexStop(index);
}

uint8_t PbbAddressTlv::GetIndexStop() const {
  NS_LOG_FUNCTION(this);
  return PbbTlv::GetIndexStop();
}

bool PbbAddressTlv::HasIndexStop() const {
  NS_LOG_FUNCTION(this);
  return PbbTlv::HasIndexStop();
}

void PbbAddressTlv::SetMultivalue(bool isMultivalue) {
  NS_LOG_FUNCTION(this << isMultivalue);
  PbbTlv::SetMultivalue(isMultivalue);
}

bool PbbAddressTlv::IsMultivalue() const {
  NS_LOG_FUNCTION(this);
