...
protected:
  ...
  Ptr<NetDevice>
      m_boundnetdevice; //!< the device this socket is bound to (might be null).
...
private:
  Callback<void, Ptr<Socket>>
      m_connectionSucceeded; //!< connection succeeded callback
  Callback<void, Ptr<Socket>>
      m_connectionFailed;                    //!< connection failed callback
  Callback<void, Ptr<Socket>> m_normalClose; //!< connection closed callback
  Callback<void, Ptr<Socket>>
      m_errorClose; //!< connection closed due to errors callback
