...
TypeId PointToPointNetDevice::GetTypeId() {
  static TypeId tid =
...
PointToPointNetDevice::~PointToPointNetDevice() { NS_LOG_FUNCTION(this); }
...
bool PointToPointNetDevice::TransmitStart(Ptr<Packet> p) {
  ...
  Simulator::Schedule(txCompleteTime, &PointToPointNetDevice::TransmitComplete,
                      this);
...
void PointToPointNetDevice::SetQueue(Ptr<Queue<Packet>> q) {
...
Ptr<Queue<Packet>> PointToPointNetDevice::GetQueue() const {
  NS_LOG_FUNCTION(this);
  return m_queue;
}

void PointToPointNetDevice::NotifyLinkUp() {
  NS_LOG_FUNCTION(this);
  m_linkUp = true;
...
uint32_t PointToPointNetDevice::GetIfIndex() const { return m_ifIndex; }
...
Address PointToPointNetDevice::GetAddress() const { return m_address; }

bool PointToPointNetDevice::IsLinkUp() const {
  NS_LOG_FUNCTION(this);
  return m_linkUp;
}
...
bool PointToPointNetDevice::IsMulticast() const {
  NS_LOG_FUNCTION(this);
  return true;
}
...
bool PointToPointNetDevice::IsPointToPoint() const {
  NS_LOG_FUNCTION(this);
  return true;
}

bool PointToPointNetDevice::IsBridge() const {
  NS_LOG_FUNCTION(this);
  return false;
}
...
Ptr<Node> PointToPointNetDevice::GetNode() const { return m_node; }
...
bool PointToPointNetDevice::NeedsArp() const {
  NS_LOG_FUNCTION(this);
  return false;
}
...
bool PointToPointNetDevice::SupportsSendFrom() const {
  NS_LOG_FUNCTION(this);
  return false;
}
...
Address PointToPointNetDevice::GetRemote() const {
  NS_LOG_FUNCTION(this);
...
uint16_t PointToPointNetDevice::GetMtu() const {
  NS_LOG_FUNCTION(this);
  return m_mtu;
}
