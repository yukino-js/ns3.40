...
InetTopologyReader::InetTopologyReader() { NS_LOG_FUNCTION(this); }

InetTopologyReader::~InetTopologyReader() { NS_LOG_FUNCTION(this); }

NodeContainer InetTopologyReader::Read() {
  std::ifstream topgen;
  ...
  lineBuffer >> totnode;
  lineBuffer >> totlink;
  NS_LOG_INFO("Inet topology should have " << totnode << " nodes and "
                                           << totlink << " links");
  ...
  NS_LOG_INFO("Inet topology created with " << nodesNumber << " nodes and "
                                            << linksNumber << " links");
  topgen.close();
