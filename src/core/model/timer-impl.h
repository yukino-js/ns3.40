...
template <typename FN> TimerImpl *MakeTimerImpl(IntToType<1>, FN fn) {
  ...
  struct FnTimerImplOne : public TimerImplOne<T1Parameter> {
    FnTimerImplOne(FN fn) : m_fn(fn) {}

    void SetArguments(T1Parameter a1) override { m_a1 = a1; }

    EventId Schedule(const Time &delay) override {
      return Simulator::Schedule(delay, m_fn, m_a1);
    }

    void Invoke() override { m_fn(m_a1); }
...
template <typename FN> TimerImpl *MakeTimerImpl(IntToType<2>, FN fn) {
  ...
  struct FnTimerImplTwo : public TimerImplTwo<T1Parameter, T2Parameter> {
    ...
    void Invoke() override { m_fn(m_a1, m_a2); }
...
template <typename FN> TimerImpl *MakeTimerImpl(IntToType<3>, FN fn) {
  ...
  struct FnTimerImplThree
    ...
    void Invoke() override { m_fn(m_a1, m_a2, m_a3); }
...
template <typename FN> TimerImpl *MakeTimerImpl(IntToType<4>, FN fn) {
  ...
  struct FnTimerImplFour : public TimerImplFour<T1Parameter, T2Parameter,
                                                T3Parameter, T4Parameter> {
    FnTimerImplFour(FN fn) : m_fn(fn) {}

    void SetArguments(T1Parameter a1, T2Parameter a2, T3Parameter a3,
                      T4Parameter a4) override {
      m_a1 = a1;
      m_a2 = a2;
      m_a3 = a3;
      m_a4 = a4;
    ...
    void Invoke() override { m_fn(m_a1, m_a2, m_a3, m_a4); }
...
template <typename FN> TimerImpl *MakeTimerImpl(IntToType<5>, FN fn) {
  ...
  struct FnTimerImplFive
      : public TimerImplFive<T1Parameter, T2Parameter, T3Parameter, T4Parameter,
                             T5Parameter> {
    FnTimerImplFive(FN fn) : m_fn(fn) {}

    void SetArguments(T1Parameter a1, T2Parameter a2, T3Parameter a3,
                      T4Parameter a4, T5Parameter a5) override {
      m_a1 = a1;
      m_a2 = a2;
      m_a3 = a3;
      m_a4 = a4;
    ...
    void Invoke() override { m_fn(m_a1, m_a2, m_a3, m_a4, m_a5); }
...
template <typename FN> TimerImpl *MakeTimerImpl(IntToType<6>, FN fn) {
  ...
  struct FnTimerImplSix
      : public TimerImplSix<T1Parameter, T2Parameter, T3Parameter, T4Parameter,
                            T5Parameter, T6Parameter> {
    FnTimerImplSix(FN fn) : m_fn(fn) {}

    virtual void SetArguments(T1Parameter a1, T2Parameter a2, T3Parameter a3,
                              T4Parameter a4, T5Parameter a5, T6Parameter a6) {
      m_a1 = a1;
      m_a2 = a2;
      m_a3 = a3;
      m_a4 = a4;
    ...
    virtual void Invoke() { m_fn(m_a1, m_a2, m_a3, m_a4, m_a5, m_a6); }
...
TimerImpl *MakeTimerImpl(MEM_PTR memPtr, OBJ_PTR objPtr) {
  ...
  return MakeTimerImpl(
      IntToType<TypeTraits<MEM_PTR>::PointerToMemberTraits::nArgs>(), memPtr,
      objPtr);
}
...
TimerImpl *MakeTimerImpl(IntToType<4>, MEM_PTR memPtr, OBJ_PTR objPtr) {
  ...
  struct MemFnTimerImplFour : public TimerImplFour<T1Parameter, T2Parameter,
                                                   T3Parameter, T4Parameter> {
...
template <typename T1, typename T2> void TimerImpl::SetArgs(T1 a1, T2 a2) {
...
template <typename T1, typename T2, typename T3>
void TimerImpl::SetArgs(T1 a1, T2 a2, T3 a3) {
...
template <typename T1, typename T2, typename T3, typename T4>
void TimerImpl::SetArgs(T1 a1, T2 a2, T3 a3, T4 a4) {
...
template <typename T1, typename T2, typename T3, typename T4, typename T5>
void TimerImpl::SetArgs(T1 a1, T2 a2, T3 a3, T4 a4, T5 a5) {
...
template <typename T1, typename T2, typename T3, typename T4, typename T5,
          typename T6>
void TimerImpl::SetArgs(T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, T6 a6) {
