...
Murmur3::Murmur3() { clear(); }

uint32_t Murmur3::GetHash32(const char *buffer, const std::size_t size) {
...
uint64_t Murmur3::GetHash64(const char *buffer, const std::size_t size) {
  using namespace Murmur3Implementation;
