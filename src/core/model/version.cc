...
std::string Version::VersionTag() { return NS3_VERSION_TAG; }

std::string Version::ClosestAncestorTag() { return NS3_VERSION_CLOSEST_TAG; }

uint32_t Version::Major() { return NS3_VERSION_MAJOR; }

uint32_t Version::Minor() { return NS3_VERSION_MINOR; }

uint32_t Version::Patch() { return NS3_VERSION_PATCH; }

std::string Version::ReleaseCandidate() {
  return std::string{NS3_VERSION_RELEASE_CANDIDATE};
}

uint32_t Version::TagDistance() { return NS3_VERSION_TAG_DISTANCE; }

bool Version::DirtyWorkingTree() {
...
std::string Version::BuildProfile() {
...
std::string Version::BuildSummary() {
  std::ostringstream ostream;
...
std::string Version::LongVersion() {
  std::ostringstream ostream;
  ostream << VersionTag();
