...
Length::Length() : m_value(0) { NS_LOG_FUNCTION(this); }
...
Length &Length::operator=(const Length::Quantity &q) {
...
double Length::GetDouble() const { return m_value; }

Length::Quantity Length::As(Length::Unit unit) const {
...
Length operator*(double scalar, const Length &right) { return right * scalar; }
...
Length Meters(double value) { return Length(value, Length::Unit::Meter); }
...
Length Inches(double value) { return Length(value, Length::Unit::Inch); }

Length Feet(double value) { return Length(value, Length::Unit::Foot); }

Length Yards(double value) { return Length(value, Length::Unit::Yard); }

Length Miles(double value) { return Length(value, Length::Unit::Mile); }
