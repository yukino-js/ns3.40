...
TypeId ListScheduler::GetTypeId() {
...
ListScheduler::ListScheduler() { NS_LOG_FUNCTION(this); }

ListScheduler::~ListScheduler() {}

void ListScheduler::Insert(const Event &ev) {
...
bool ListScheduler::IsEmpty() const {
  NS_LOG_FUNCTION(this);
  return m_events.empty();
}

Scheduler::Event ListScheduler::PeekNext() const {
  NS_LOG_FUNCTION(this);
  return m_events.front();
}

Scheduler::Event ListScheduler::RemoveNext() {
  NS_LOG_FUNCTION(this);
...
void ListScheduler::Remove(const Event &ev) {
  NS_LOG_FUNCTION(this << &ev);
  for (auto i = m_events.begin(); i != m_events.end(); i++) {
