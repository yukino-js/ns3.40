...
ObjectPtrContainerValue::ObjectPtrContainerValue() { NS_LOG_FUNCTION(this); }

ObjectPtrContainerValue::Iterator ObjectPtrContainerValue::Begin() const {
  NS_LOG_FUNCTION(this);
  return m_objects.begin();
}

ObjectPtrContainerValue::Iterator ObjectPtrContainerValue::End() const {
  NS_LOG_FUNCTION(this);
  return m_objects.end();
}

std::size_t ObjectPtrContainerValue::GetN() const {
  NS_LOG_FUNCTION(this);
  return m_objects.size();
}

Ptr<Object> ObjectPtrContainerValue::Get(std::size_t i) const {
...
Ptr<AttributeValue> ObjectPtrContainerValue::Copy() const {
  NS_LOG_FUNCTION(this);
  return ns3::Create<ObjectPtrContainerValue>(*this);
}

std::string ObjectPtrContainerValue::SerializeToString(
...
bool ObjectPtrContainerValue::DeserializeFromString(
...
bool ObjectPtrContainerAccessor::Set(ObjectBase *object,
...
bool ObjectPtrContainerAccessor::Get(const ObjectBase *object,
...
bool ObjectPtrContainerAccessor::HasGetter() const {
  NS_LOG_FUNCTION(this);
  return true;
}

bool ObjectPtrContainerAccessor::HasSetter() const {
  NS_LOG_FUNCTION(this);
  return false;
}
