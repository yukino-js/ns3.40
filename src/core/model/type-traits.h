...
private:
   ...
   */
  template <typename U> struct FunctionPtrTraits<U (*)()> {
    /** Value. */
    enum {
   ...
   */
  template <typename U, typename V1> struct FunctionPtrTraits<U (*)(V1)> {
    /** Value. */
    enum {
      IsFunctionPointer = 1 /**< Function pointer.     */
    };
   ...
   */
  template <typename U, typename V> struct PtrToMemberTraits<U (V::*)()> {
    /** Value. */
    enum {
   ...
   *  \tparam V \deduced Class type.
   */
  template <typename U, typename V> struct PtrToMemberTraits<U (V::*)() const> {
    /** Value. */
    enum {
      IsPointerToMember = 1 /**< Pointer to member function. */
    };
