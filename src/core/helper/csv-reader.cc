...
std::size_t CsvReader::ColumnCount() const {
  NS_LOG_FUNCTION(this);

  return m_columns.size();
}

std::size_t CsvReader::RowNumber() const {
  NS_LOG_FUNCTION(this);
...
bool CsvReader::IsBlankRow() const { return m_blankRow; }

bool CsvReader::GetValueAs(std::string input, double &value) const {
  NS_LOG_FUNCTION(this << input);

  return GenericTransform(std::move(input), value);
}

bool CsvReader::GetValueAs(std::string input, float &value) const {
  NS_LOG_FUNCTION(this << input);

  return GenericTransform(std::move(input), value);
}

bool CsvReader::GetValueAs(std::string input, signed char &value) const {
  ...
  NS_LOG_DEBUG("Input='" << input << "', output=" << tempOutput
                         << ", result=" << success);

  return success;
}

bool CsvReader::GetValueAs(std::string input, short &value) const {
  NS_LOG_FUNCTION(this << input);

  return GenericTransform(std::move(input), value);
}

bool CsvReader::GetValueAs(std::string input, int &value) const {
  NS_LOG_FUNCTION(this << input);

  return GenericTransform(std::move(input), value);
}

bool CsvReader::GetValueAs(std::string input, long &value) const {
  NS_LOG_FUNCTION(this << input);

  return GenericTransform(std::move(input), value);
}

bool CsvReader::GetValueAs(std::string input, long long &value) const {
  NS_LOG_FUNCTION(this << input);

  return GenericTransform(std::move(input), value);
}

bool CsvReader::GetValueAs(std::string input, std::string &value) const {
  NS_LOG_FUNCTION(this << input);
...
bool CsvReader::GetValueAs(std::string input, unsigned char &value) const {
...
bool CsvReader::GetValueAs(std::string input, unsigned short &value) const {
  NS_LOG_FUNCTION(this << input);

  return GenericTransform(std::move(input), value);
}

bool CsvReader::GetValueAs(std::string input, unsigned int &value) const {
  NS_LOG_FUNCTION(this << input);

  return GenericTransform(std::move(input), value);
}

bool CsvReader::GetValueAs(std::string input, unsigned long &value) const {
  NS_LOG_FUNCTION(this << input);

  return GenericTransform(std::move(input), value);
}

bool CsvReader::GetValueAs(std::string input, unsigned long long &value) const {
  NS_LOG_FUNCTION(this << input);

  return GenericTransform(std::move(input), value);
}

bool CsvReader::IsDelimiter(char c) const {
  NS_LOG_FUNCTION(this << c);

  return c == m_delimiter;
}

void CsvReader::ParseLine(const std::string &line) {
...
CsvReader::ParseColumn(std::string::const_iterator begin,
    ...
    if (state != State::QUOTED_STRING) {
      if (IsDelimiter(c)) {
        ...
        if (state == State::UNQUOTED_STRING) {
          NS_LOG_DEBUG("Removing trailing whitespace from unquoted field: '"
                       << buffer << "'");
