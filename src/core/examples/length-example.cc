...
void Constructors() {
  ...
  std::cout << "\nConstructors:"
            << "\nLength (" << input
            << ", Unit::Meter) = " << Length(input, Length::Unit::Meter)
            << "\nLength (" << input << ", \"m\") = " << Length(input, "m")
            << "\nLength (" << input
            << ", \"meter\") = " << Length(input, "meter")
            << "\nLength (Quantity(" << input
            << ", Unit::Meter)) = " << Length(quantity)
            << "\nLength (\"5m\") = " << Length("5m")
...
void EqualityOperators() {
  ...
  std::cout << "\n"
            ...
            << std::boolalpha << "Equality: " << oneMeter << " == " << oneMeter
...
void DivAndMod() {
  ...
  std::cout << "\nHow many times can a " << totalLen.As(Length::Unit::Foot)
            << " length "
            << "be split into " << pieceLen.As(Length::Unit::Foot)
            << " sized pieces? " << count
