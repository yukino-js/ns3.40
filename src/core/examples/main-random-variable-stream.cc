...
int main(int argc, char *argv[]) {
...

  {
    ...
    plot.AddDataset(
        Histogram(x, probes, precision, "UniformRandomVariable [0.0 .. 1.0)"));
...

  {
    ...
    plot.AddDataset(
        Histogram(x1, probes, precision, "ExponentialRandomVariable m=0.5"));
    ...
    plot.AddDataset(
        Histogram(x2, probes, precision, "ExponentialRandomVariable m=1"));
    ...
    plot.AddDataset(
        Histogram(x3, probes, precision, "ExponentialRandomVariable m=1.5"));
...

  {
    ...
    plot.AddDataset(
        Histogram(x1, probes, precision, "NormalRandomVariable m=0.0 v=1.0"));

    plot.AddDataset(Gnuplot2dFunction(
        "NormalDist {/Symbol m}=0.0 {/Symbol s}=1.0", "NormalDist(x,0.0,1.0)"));
    ...
    plot.AddDataset(
        Histogram(x2, probes, precision, "NormalRandomVariable m=0.0 v=2.0"));

    plot.AddDataset(
        Gnuplot2dFunction("NormalDist {/Symbol m}=0.0 {/Symbol s}=sqrt(2.0)",
    ...
    plot.AddDataset(
        Histogram(x3, probes, precision, "NormalRandomVariable m=0.0 v=3.0"));

    plot.AddDataset(
        Gnuplot2dFunction("NormalDist {/Symbol m}=0.0 {/Symbol s}=sqrt(3.0)",
...

  {
    ...
    plot.AddDataset(Histogram(x, probes, precision,
                              "EmpiricalRandomVariable (Sampling)", true));

    x->SetInterpolate(true);
    plot.AppendExtra("set y2range [0:*]");
    auto d2 = Histogram(x, probes, precision,
...

  {
    ...
    plot.AddDataset(
        Histogram(x1, probes, precision, "DeterministicRandomVariable", true));
...

  {
    ...
    plot.AddDataset(
        Histogram(x1, probes, precision, "GammaRandomVariable a=1.0 b=1.0"));
    ...
    plot.AddDataset(
        Histogram(x2, probes, precision, "GammaRandomVariable a=1.5 b=1.0"));
    ...
    plot.AddDataset(
        Histogram(x3, probes, precision, "GammaRandomVariable a=2.0 b=1.0"));
    ...
    plot.AddDataset(
        Histogram(x4, probes, precision, "GammaRandomVariable a=4.0 b=1.0"));
    ...
    plot.AddDataset(
        Histogram(x5, probes, precision, "GammaRandomVariable a=2.0 b=2.0"));
    ...
    plot.AddDataset(
        Histogram(x6, probes, precision, "GammaRandomVariable a=2.5 b=3.0"));
    ...
    plot.AddDataset(
        Histogram(x7, probes, precision, "GammaRandomVariable a=2.5 b=4.5"));
...

  {
    ...
    plot.AddDataset(
        Gnuplot2dFunction("Erlang(x, 1, 1.0)", "ErlangDist(x, 1, 1.0)"));
    ...
    plot.AddDataset(
        Gnuplot2dFunction("Erlang(x, 2, 1.0)", "ErlangDist(x, 2, 1.0)"));
    ...
    plot.AddDataset(
        Gnuplot2dFunction("Erlang(x, 3, 1.0)", "ErlangDist(x, 3, 1.0)"));
    ...
    plot.AddDataset(
        Gnuplot2dFunction("Erlang(x, 5, 1.0)", "ErlangDist(x, 5, 1.0)"));
    ...
    plot.AddDataset(
        Gnuplot2dFunction("Erlang(x, 2, 2.0)", "ErlangDist(x, 2, 2.0)"));
    ...
    plot.AddDataset(
        Gnuplot2dFunction("Erlang(x, 2, 3.0)", "ErlangDist(x, 2, 3.0)"));
    ...
    plot.AddDataset(
        Gnuplot2dFunction("Erlang(x, 2, 5.0)", "ErlangDist(x, 2, 5.0)"));
