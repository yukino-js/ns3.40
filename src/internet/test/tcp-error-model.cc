...
TypeId TcpGeneralErrorModel::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::TcpGeneralErrorModel").SetParent<ErrorModel>();
  return tid;
}

TcpGeneralErrorModel::TcpGeneralErrorModel() { NS_LOG_FUNCTION(this); }

bool TcpGeneralErrorModel::DoCorrupt(Ptr<Packet> p) {
...
TypeId TcpSeqErrorModel::GetTypeId() {
...
bool TcpSeqErrorModel::ShouldDrop(const Ipv4Header &ipHeader,
...
bool TcpFlagErrorModel::ShouldDrop(const Ipv4Header &ipHeader,
                                   const TcpHeader &tcpHeader,
...
void TcpFlagErrorModel::DoReset() {
