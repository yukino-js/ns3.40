...
void NetworkNumberAllocatorTestCase::DoTeardown() {
  Ipv4AddressGenerator::Reset();
}

void NetworkNumberAllocatorTestCase::DoRun() {
  Ipv4Address network;
...
void AddressAllocatorTestCase::DoRun() {
  Ipv4Address address;
...
void AddressAllocatorTestCase::DoTeardown() {
  Ipv4AddressGenerator::Reset();
  Simulator::Destroy();
}
...
void NetworkAndAddressTestCase::DoTeardown() {
  Ipv4AddressGenerator::Reset();
  Simulator::Destroy();
}

void NetworkAndAddressTestCase::DoRun() {
  Ipv4Address address;
  Ipv4Address network;
...
void ExampleAddressGeneratorTestCase::DoTeardown() {
  Ipv4AddressGenerator::Reset();
}
...
void AddressCollisionTestCase::DoTeardown() {
  Ipv4AddressGenerator::Reset();
  Simulator::Destroy();
}

void AddressCollisionTestCase::DoRun() {
  ...
  NS_TEST_EXPECT_MSG_EQ(allocated, false,
                        "0.0.0.21 should not be already allocated");
  ...
  NS_TEST_EXPECT_MSG_EQ(allocated, true,
                        "0.0.0.16 should be already allocated");
  ...
  NS_TEST_EXPECT_MSG_EQ(allocated, true,
                        "0.0.0.21 should be already allocated");
