...
public:
  TcpLinuxRenoTestSuite() : TestSuite("tcp-linux-reno-test", UNIT) {
    ...
    AddTestCase(
        new TcpLinuxRenoCongAvoidTest(524,     // segment size
                                      524,     // socket send size
                                      6,       // socket sends
                                      1,       // initial cwnd
    ...
    AddTestCase(
        new TcpLinuxRenoCongAvoidTest(1500,     // segment size
                                      1500,     // socket send size
                                      6,        // socket sends
                                      1,        // initial cwnd
                                      2,        // initial ssthresh
...
static TcpLinuxRenoTestSuite
    g_tcpLinuxRenoTestSuite; //!< Static variable for test initialization
