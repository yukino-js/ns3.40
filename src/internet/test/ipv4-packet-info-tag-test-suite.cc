...
void Ipv4PacketInfoTagTest::RxCb(Ptr<Socket> socket) {
...
void Ipv4PacketInfoTagTest::DoSendData(Ptr<Socket> socket, std::string to) {
...
void Ipv4PacketInfoTagTest::DoRun() {
  ...
  Ipv4InterfaceAddress ifaceAddr1 =
      Ipv4InterfaceAddress("10.1.1.1", "255.255.255.0");
  ...
  Ipv4InterfaceAddress ifaceAddr2 =
      Ipv4InterfaceAddress("10.1.1.2", "255.255.255.0");
  ...
  Ptr<SocketFactory> factory2 =
      node1->GetObject<SocketFactory>(UdpSocketFactory::GetTypeId());
