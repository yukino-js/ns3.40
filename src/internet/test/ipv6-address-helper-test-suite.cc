...
void IpAddressHelperTestCasev6::DoRun() {
  Ipv6AddressHelper ip1;
  Ipv6Address ipAddr1;
  ipAddr1 = ip1.NewAddress();
  // Ipv6AddressHelper that is unconfigured
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv6Address("2001:db8::1"),
                        "Ipv6AddressHelper failure");
  ipAddr1 = ip1.NewAddress();
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv6Address("2001:db8::2"),
                        "Ipv6AddressHelper failure");
  ip1.NewNetwork();
  ipAddr1 = ip1.NewAddress();
  ...
  ipAddr1 = ip1.NewAddress();
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv6Address("2001:db81::1"),
                        "Ipv6AddressHelper failure");
  // Skip a few addresses
  ip1.SetBase(Ipv6Address("2001:db81::"), Ipv6Prefix(32), Ipv6Address("::15"));
  ipAddr1 = ip1.NewAddress();
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv6Address("2001:db81::15"),
                        "Ipv6AddressHelper failure");
  ipAddr1 = ip1.NewAddress();
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv6Address("2001:db81::16"),
                        "Ipv6AddressHelper failure");
  // Skip a some more addresses
  ip1.SetBase(Ipv6Address("2001:db81::"), Ipv6Prefix(32), Ipv6Address("::ff"));
  ipAddr1 = ip1.NewAddress();
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv6Address("2001:db81::ff"),
                        "Ipv6AddressHelper failure");
  ipAddr1 = ip1.NewAddress();
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv6Address("2001:db81::100"),
                        "Ipv6AddressHelper failure");
  // Increment network
  ip1.NewNetwork();
  ipAddr1 = ip1.NewAddress();
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv6Address("2001:db82::ff"),
                        "Ipv6AddressHelper failure");
  ...
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv6Address("2001:dddd:0:2::1"),
                        "Ipv6AddressHelper failure");

  // Set again
  ip1.SetBase(Ipv6Address("2001:db82::"), Ipv6Prefix(32));
  ipAddr1 = ip1.NewAddress();
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv6Address("2001:db82::1"),
                        "Ipv6AddressHelper failure");

  // Reset again
  ip1.SetBase(Ipv6Address("2001:f00d:cafe:00ff::"), Ipv6Prefix(64),
              Ipv6Address("::1"));
...
void IpAddressHelperTestCasev6::DoTeardown() {
