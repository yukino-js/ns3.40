...
void NetworkNumber6AllocatorTestCase::DoTeardown() {
  Ipv6AddressGenerator::Reset();
}

void NetworkNumber6AllocatorTestCase::DoRun() {
  Ipv6Address network;
  ...
  NS_TEST_EXPECT_MSG_EQ(
      network, Ipv6Address("0:1::0"),
      "network should equal the initialized network for given prefix");
  network = Ipv6AddressGenerator::NextNetwork(Ipv6Prefix("FFFF:FFFF::0"));
  NS_TEST_EXPECT_MSG_EQ(network, Ipv6Address("0:2::0"),
                        "network should equal next network");
  ...
  NS_TEST_EXPECT_MSG_EQ(
      network, Ipv6Address("0:0:1::0"),
      "network should equal the initialized network for given prefix");
  network = Ipv6AddressGenerator::NextNetwork(Ipv6Prefix("FFFF:FFFF:FFFF::0"));
  NS_TEST_EXPECT_MSG_EQ(network, Ipv6Address("0:0:2::0"),
                        "network should equal next network");
}
...
void AddressAllocator6TestCase::DoRun() {
  ...
  address = Ipv6AddressGenerator::NextAddress(Ipv6Prefix(64));
  NS_TEST_EXPECT_MSG_EQ(
      address, Ipv6Address("2001:0:0:1::2"),
      "address should equal the initialized address for given prefix");
  ...
  NS_TEST_EXPECT_MSG_EQ(
      address, Ipv6Address("1::3"),
      "address should equal initialized address for given prefix");
  address = Ipv6AddressGenerator::NextAddress(Ipv6Prefix(16));
  NS_TEST_EXPECT_MSG_EQ(address, Ipv6Address("1::4"),
                        "address should equal next address");
}

void AddressAllocator6TestCase::DoTeardown() {
  Ipv6AddressGenerator::Reset();
  Simulator::Destroy();
}
...
void NetworkAndAddress6TestCase::DoTeardown() {
  Ipv6AddressGenerator::Reset();
  Simulator::Destroy();
}

void NetworkAndAddress6TestCase::DoRun() {
  Ipv6Address address;
  Ipv6Address network;
...
void ExampleAddress6GeneratorTestCase::DoTeardown() {
  Ipv6AddressGenerator::Reset();
}

void ExampleAddress6GeneratorTestCase::DoRun() {
  Ipv6Address address;
  ...
  NS_TEST_EXPECT_MSG_EQ(
      address, Ipv6Address("2001:0AB8::0:3"),
      "address should equal initialized address for given prefix");
  address = Ipv6AddressGenerator::NextAddress(Ipv6Prefix(48));
...
void AddressCollision6TestCase::DoTeardown() {
  Ipv6AddressGenerator::Reset();
  Simulator::Destroy();
}

void AddressCollision6TestCase::DoRun() {
  ...
  NS_TEST_EXPECT_MSG_EQ(allocated, false,
                        "0::0:21 should not be already allocated");
