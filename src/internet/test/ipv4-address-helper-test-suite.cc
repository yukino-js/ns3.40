...
void NetworkAllocatorHelperTestCase::DoTeardown() {
  Ipv4AddressGenerator::Reset();
  Simulator::Destroy();
}

void NetworkAllocatorHelperTestCase::DoRun() {
  Ipv4Address address;
  Ipv4Address network;
  Ipv4AddressHelper h;
...
void AddressAllocatorHelperTestCase::DoTeardown() {
  Ipv4AddressGenerator::Reset();
  Simulator::Destroy();
}

void AddressAllocatorHelperTestCase::DoRun() {
  Ipv4Address network;
  Ipv4Address address;
  Ipv4AddressHelper h;
...
void ResetAllocatorHelperTestCase::DoRun() {
  Ipv4Address network;
  Ipv4Address address;
  Ipv4AddressHelper h;
...
void ResetAllocatorHelperTestCase::DoTeardown() {
  Ipv4AddressGenerator::Reset();
  Simulator::Destroy();
}
...
void IpAddressHelperTestCasev4::DoRun() {
  ...
  ipAddr1 = ip1.NewAddress();
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv4Address("192.168.0.1"),
                        "Ipv4AddressHelper failure");
  ipAddr1 = ip1.NewAddress();
  NS_TEST_ASSERT_MSG_EQ(ipAddr1, Ipv4Address("192.168.0.2"),
                        "Ipv4AddressHelper failure");
  ip1.NewNetwork();
  ipAddr1 = ip1.NewAddress();
