...
TypeId Ipv6OptionHeader::GetInstanceTypeId() const { return GetTypeId(); }

Ipv6OptionHeader::Ipv6OptionHeader() : m_type(0), m_length(0) {}

Ipv6OptionHeader::~Ipv6OptionHeader() {}

void Ipv6OptionHeader::SetType(uint8_t type) { m_type = type; }

uint8_t Ipv6OptionHeader::GetType() const { return m_type; }

void Ipv6OptionHeader::SetLength(uint8_t length) { m_length = length; }

uint8_t Ipv6OptionHeader::GetLength() const { return m_length; }

void Ipv6OptionHeader::Print(std::ostream &os) const {
  os << "( type = " << (uint32_t)m_type << " )";
}

uint32_t Ipv6OptionHeader::GetSerializedSize() const { return m_length + 2; }
...
TypeId Ipv6OptionPad1Header::GetInstanceTypeId() const { return GetTypeId(); }

Ipv6OptionPad1Header::Ipv6OptionPad1Header() { SetType(0); }
...
uint32_t Ipv6OptionPad1Header::GetSerializedSize() const { return 1; }
...
TypeId Ipv6OptionPadnHeader::GetInstanceTypeId() const { return GetTypeId(); }
...
void Ipv6OptionRouterAlertHeader::SetValue(uint16_t value) { m_value = value; }

uint16_t Ipv6OptionRouterAlertHeader::GetValue() const { return m_value; }
