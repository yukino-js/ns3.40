...
TypeId TcpOptionSackPermitted::GetTypeId() {
...
TypeId TcpOptionSackPermitted::GetInstanceTypeId() const { return GetTypeId(); }

void TcpOptionSackPermitted::Print(std::ostream &os) const {
  os << "[sack_perm]";
}

uint32_t TcpOptionSackPermitted::GetSerializedSize() const { return 2; }
...
uint8_t TcpOptionSackPermitted::GetKind() const {
