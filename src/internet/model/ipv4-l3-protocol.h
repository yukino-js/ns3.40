...
private:
  ...
  Ipv4InterfaceReverseContainer
      m_reverseInterfacesContainer; //!< Container of NetDevice / Interface
                                    //!< index associations.
  ...
  Ptr<Ipv4RoutingProtocol>
      m_routingProtocol; //!< Routing protocol associated with the stack
  ...
  Ipv4RoutingProtocol::UnicastForwardCallback
      m_ucb; ///< Unicast forward callback
  Ipv4RoutingProtocol::MulticastForwardCallback
      m_mcb; ///< Multicast forward callback
