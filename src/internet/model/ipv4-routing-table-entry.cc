...
Ipv4RoutingTableEntry::Ipv4RoutingTableEntry() { NS_LOG_FUNCTION(this); }

Ipv4RoutingTableEntry::Ipv4RoutingTableEntry(const Ipv4RoutingTableEntry &route)
    : m_dest(route.m_dest), m_destNetworkMask(route.m_destNetworkMask),
      m_gateway(route.m_gateway), m_interface(route.m_interface) {
...
Ipv4RoutingTableEntry::Ipv4RoutingTableEntry(Ipv4Address dest,
                                             Ipv4Address gateway,
                                             uint32_t interface)
    : m_dest(dest), m_destNetworkMask(Ipv4Mask::GetOnes()), m_gateway(gateway),
      m_interface(interface) {}

Ipv4RoutingTableEntry::Ipv4RoutingTableEntry(Ipv4Address dest,
                                             uint32_t interface)
    : m_dest(dest), m_destNetworkMask(Ipv4Mask::GetOnes()),
      m_gateway(Ipv4Address::GetZero()), m_interface(interface) {}

Ipv4RoutingTableEntry::Ipv4RoutingTableEntry(Ipv4Address network,
                                             Ipv4Mask networkMask,
                                             Ipv4Address gateway,
                                             uint32_t interface)
    : m_dest(network), m_destNetworkMask(networkMask), m_gateway(gateway),
      m_interface(interface) {
...
Ipv4RoutingTableEntry::Ipv4RoutingTableEntry(Ipv4Address network,
                                             Ipv4Mask networkMask,
                                             uint32_t interface)
    : m_dest(network), m_destNetworkMask(networkMask),
      m_gateway(Ipv4Address::GetZero()), m_interface(interface) {
  NS_LOG_FUNCTION(this << network << networkMask << interface);
}

bool Ipv4RoutingTableEntry::IsHost() const {
  NS_LOG_FUNCTION(this);
  return m_destNetworkMask == Ipv4Mask::GetOnes();
}

Ipv4Address Ipv4RoutingTableEntry::GetDest() const {
  NS_LOG_FUNCTION(this);
  return m_dest;
}

bool Ipv4RoutingTableEntry::IsNetwork() const {
  NS_LOG_FUNCTION(this);
  return !IsHost();
}

bool Ipv4RoutingTableEntry::IsDefault() const {
  NS_LOG_FUNCTION(this);
  return m_dest == Ipv4Address::GetZero();
}

Ipv4Address Ipv4RoutingTableEntry::GetDestNetwork() const {
  NS_LOG_FUNCTION(this);
  return m_dest;
}

Ipv4Mask Ipv4RoutingTableEntry::GetDestNetworkMask() const {
  NS_LOG_FUNCTION(this);
  return m_destNetworkMask;
}

bool Ipv4RoutingTableEntry::IsGateway() const {
  NS_LOG_FUNCTION(this);
  return m_gateway != Ipv4Address::GetZero();
}

Ipv4Address Ipv4RoutingTableEntry::GetGateway() const {
  NS_LOG_FUNCTION(this);
  return m_gateway;
}

uint32_t Ipv4RoutingTableEntry::GetInterface() const {
  NS_LOG_FUNCTION(this);
  return m_interface;
}

Ipv4RoutingTableEntry
Ipv4RoutingTableEntry::CreateHostRouteTo(Ipv4Address dest, Ipv4Address nextHop,
                                         uint32_t interface) {
...
Ipv4RoutingTableEntry Ipv4RoutingTableEntry::CreateNetworkRouteTo(
    Ipv4Address network, Ipv4Mask networkMask, Ipv4Address nextHop,
    uint32_t interface) {
...
Ipv4RoutingTableEntry::CreateDefaultRoute(Ipv4Address nextHop,
  ...
  return Ipv4RoutingTableEntry(Ipv4Address::GetZero(), Ipv4Mask::GetZero(),
                               nextHop, interface);
}
...
std::ostream &operator<<(std::ostream &os, const Ipv4RoutingTableEntry &route) {
  if (route.IsDefault()) {
    ...
    os << "default out=" << route.GetInterface()
...
Ipv4MulticastRoutingTableEntry::Ipv4MulticastRoutingTableEntry(
    ...
    : m_origin(route.m_origin), m_group(route.m_group),
...
Ipv4Address Ipv4MulticastRoutingTableEntry::GetOrigin() const {
  NS_LOG_FUNCTION(this);
  return m_origin;
}

Ipv4Address Ipv4MulticastRoutingTableEntry::GetGroup() const {
  NS_LOG_FUNCTION(this);
  return m_group;
}

uint32_t Ipv4MulticastRoutingTableEntry::GetInputInterface() const {
  NS_LOG_FUNCTION(this);
  return m_inputInterface;
}

uint32_t Ipv4MulticastRoutingTableEntry::GetNOutputInterfaces() const {
  NS_LOG_FUNCTION(this);
  return m_outputInterfaces.size();
}

uint32_t Ipv4MulticastRoutingTableEntry::GetOutputInterface(uint32_t n) const {
...
Ipv4MulticastRoutingTableEntry::CreateMulticastRoute(
  ...
  return Ipv4MulticastRoutingTableEntry(origin, group, inputInterface,
                                        outputInterfaces);
}
