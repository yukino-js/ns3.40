...
void ArpHeader::SetRequest(Address sourceHardwareAddress,
...
void ArpHeader::SetReply(Address sourceHardwareAddress,
                         Ipv4Address sourceProtocolAddress,
                         Address destinationHardwareAddress,
                         Ipv4Address destinationProtocolAddress) {
  NS_LOG_FUNCTION(this << sourceHardwareAddress << sourceProtocolAddress
...
bool ArpHeader::IsRequest() const {
  NS_LOG_FUNCTION(this);
  return m_type == ARP_TYPE_REQUEST;
}

bool ArpHeader::IsReply() const {
  NS_LOG_FUNCTION(this);
  return m_type == ARP_TYPE_REPLY;
}

Address ArpHeader::GetSourceHardwareAddress() const {
  NS_LOG_FUNCTION(this);
  return m_macSource;
}

Address ArpHeader::GetDestinationHardwareAddress() const {
  NS_LOG_FUNCTION(this);
  return m_macDest;
}

Ipv4Address ArpHeader::GetSourceIpv4Address() const {
  NS_LOG_FUNCTION(this);
  return m_ipv4Source;
}

Ipv4Address ArpHeader::GetDestinationIpv4Address() const {
  NS_LOG_FUNCTION(this);
  return m_ipv4Dest;
}

TypeId ArpHeader::GetTypeId() {
...
TypeId ArpHeader::GetInstanceTypeId() const {
  NS_LOG_FUNCTION(this);
  return GetTypeId();
}

void ArpHeader::Print(std::ostream &os) const {
...
uint32_t ArpHeader::GetSerializedSize() const {
  NS_LOG_FUNCTION(this);
...
void ArpHeader::Serialize(Buffer::Iterator start) const {
