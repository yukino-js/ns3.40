...
Ipv6RoutingTableEntry::Ipv6RoutingTableEntry(const Ipv6RoutingTableEntry &route)
    : m_dest(route.m_dest), m_destNetworkPrefix(route.m_destNetworkPrefix),
...
Ipv6RoutingTableEntry::Ipv6RoutingTableEntry(Ipv6Address dest,
                                             Ipv6Address gateway,
                                             uint32_t interface)
    : m_dest(dest), m_destNetworkPrefix(Ipv6Prefix::GetZero()),
      m_gateway(gateway), m_interface(interface),
      m_prefixToUse(Ipv6Address("::")) {}

Ipv6RoutingTableEntry::Ipv6RoutingTableEntry(Ipv6Address dest,
                                             uint32_t interface)
    : m_dest(dest), m_destNetworkPrefix(Ipv6Prefix::GetOnes()),
      m_gateway(Ipv6Address::GetZero()), m_interface(interface),
      m_prefixToUse(Ipv6Address("::")) {}
...
Ipv6RoutingTableEntry::Ipv6RoutingTableEntry(Ipv6Address network,
    ...
    : m_dest(network), m_destNetworkPrefix(networkPrefix), m_gateway(gateway),
      m_interface(interface), m_prefixToUse(prefixToUse) {}
...
Ipv6RoutingTableEntry::Ipv6RoutingTableEntry(Ipv6Address network,
                                             ...
                                             uint32_t interface)
    : m_dest(network), m_destNetworkPrefix(networkPrefix), m_gateway(gateway),
      m_interface(interface), m_prefixToUse(Ipv6Address::GetZero()) {}

Ipv6RoutingTableEntry::Ipv6RoutingTableEntry(Ipv6Address network,
                                             Ipv6Prefix networkPrefix,
                                             uint32_t interface,
                                             Ipv6Address prefixToUse)
    : m_dest(network), m_destNetworkPrefix(networkPrefix),
      m_gateway(Ipv6Address::GetZero()), m_interface(interface),
...
Ipv6Address Ipv6RoutingTableEntry::GetDest() const { return m_dest; }
...
bool Ipv6RoutingTableEntry::IsNetwork() const { return !IsHost(); }

bool Ipv6RoutingTableEntry::IsDefault() const {
  return m_dest == Ipv6Address::GetZero();
}

Ipv6Address Ipv6RoutingTableEntry::GetDestNetwork() const { return m_dest; }
...
Ipv6Address Ipv6RoutingTableEntry::GetGateway() const { return m_gateway; }

Ipv6RoutingTableEntry
Ipv6RoutingTableEntry::CreateHostRouteTo(Ipv6Address dest, Ipv6Address nextHop,
                                         uint32_t interface,
                                         Ipv6Address prefixToUse) {
  return Ipv6RoutingTableEntry(dest, Ipv6Prefix::GetOnes(), nextHop, interface,
                               prefixToUse);
}
...
Ipv6RoutingTableEntry Ipv6RoutingTableEntry::CreateNetworkRouteTo(
    Ipv6Address network, Ipv6Prefix networkPrefix, uint32_t interface) {
  return Ipv6RoutingTableEntry(network, networkPrefix, interface, network);
}

Ipv6RoutingTableEntry
Ipv6RoutingTableEntry::CreateDefaultRoute(Ipv6Address nextHop,
                                          uint32_t interface) {
  return Ipv6RoutingTableEntry(Ipv6Address::GetZero(), nextHop, interface);
}

uint32_t Ipv6RoutingTableEntry::GetInterface() const { return m_interface; }
...
Ipv6MulticastRoutingTableEntry::Ipv6MulticastRoutingTableEntry(
    ...
    : m_origin(origin), m_group(group), m_inputInterface(inputInterface),
...
Ipv6Address Ipv6MulticastRoutingTableEntry::GetGroup() const { return m_group; }
...
Ipv6MulticastRoutingTableEntry::CreateMulticastRoute(
    Ipv6Address origin, Ipv6Address group, uint32_t inputInterface,
    std::vector<uint32_t> outputInterfaces) {
  return Ipv6MulticastRoutingTableEntry(origin, group, inputInterface,
                                        outputInterfaces);
}
