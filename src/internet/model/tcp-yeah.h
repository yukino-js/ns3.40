...
private:
  ...
  uint32_t
      m_epsilon;  //!< Log maximum fraction to be removed on early decongestion
  uint32_t m_phy; //!< Maximum delta from base
  uint32_t m_rho; //!< Minimum number of consecutive RTT to consider competition
                  //!< with Reno flows on loss
