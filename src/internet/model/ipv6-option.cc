...
Ipv6Option::~Ipv6Option() { NS_LOG_FUNCTION(this); }
...
Ipv6OptionPad1::Ipv6OptionPad1() { NS_LOG_FUNCTION(this); }
...
uint8_t Ipv6OptionPad1::Process(Ptr<Packet> packet, uint8_t offset,
                                const Ipv6Header &ipv6Header, bool &isDropped) {
...
Ipv6OptionPadn::Ipv6OptionPadn() { NS_LOG_FUNCTION(this); }
...
uint8_t Ipv6OptionPadn::Process(Ptr<Packet> packet, uint8_t offset,
                                const Ipv6Header &ipv6Header, bool &isDropped) {
  NS_LOG_FUNCTION(this << packet << offset << ipv6Header << isDropped);
...
Ipv6OptionJumbogram::Ipv6OptionJumbogram() { NS_LOG_FUNCTION(this); }
...
uint8_t Ipv6OptionJumbogram::Process(Ptr<Packet> packet, uint8_t offset,
...
Ipv6OptionRouterAlert::Ipv6OptionRouterAlert() { NS_LOG_FUNCTION(this); }
...
uint8_t Ipv6OptionRouterAlert::Process(Ptr<Packet> packet, uint8_t offset,
                                       const Ipv6Header &ipv6Header,
                                       bool &isDropped) {
  NS_LOG_FUNCTION(this << packet << offset << ipv6Header << isDropped);
