...
private:
  ...
  typedef std::list<TcpTxItem *>
      PacketList; //!< container for data stored in the buffer
  ...
  std::pair<PacketList::const_iterator, SequenceNumber32>
      m_highestSack; //!< Highest SACK byte
