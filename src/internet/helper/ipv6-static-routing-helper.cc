...
Ipv6StaticRoutingHelper::Ipv6StaticRoutingHelper(
    const Ipv6StaticRoutingHelper &o) {}

Ipv6StaticRoutingHelper *Ipv6StaticRoutingHelper::Copy() const {
  return new Ipv6StaticRoutingHelper(*this);
}

Ptr<Ipv6RoutingProtocol> Ipv6StaticRoutingHelper::Create(Ptr<Node> node) const {
...
void Ipv6StaticRoutingHelper::AddMulticastRoute(Ptr<Node> n, Ipv6Address source,
                                                Ipv6Address group,
                                                Ptr<NetDevice> input,
  ...
  ipv6StaticRouting->AddMulticastRoute(source, group, inputInterface,
                                       outputInterfaces);
}
...
void Ipv6StaticRoutingHelper::AddMulticastRoute(std::string nName,
                                                Ipv6Address source,
                                                Ipv6Address group,
                                                Ptr<NetDevice> input,
                                                NetDeviceContainer output) {
