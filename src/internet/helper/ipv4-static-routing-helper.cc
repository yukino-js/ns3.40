...
Ipv4StaticRoutingHelper::Ipv4StaticRoutingHelper(
    const Ipv4StaticRoutingHelper &o) {}

Ipv4StaticRoutingHelper *Ipv4StaticRoutingHelper::Copy() const {
  return new Ipv4StaticRoutingHelper(*this);
}

Ptr<Ipv4RoutingProtocol> Ipv4StaticRoutingHelper::Create(Ptr<Node> node) const {
...
void Ipv4StaticRoutingHelper::AddMulticastRoute(Ptr<Node> n, Ipv4Address source,
                                                Ipv4Address group,
                                                Ptr<NetDevice> input,
  ...
  ipv4StaticRouting->AddMulticastRoute(source, group, inputInterface,
                                       outputInterfaces);
}
...
void Ipv4StaticRoutingHelper::AddMulticastRoute(std::string nName,
                                                Ipv4Address source,
                                                Ipv4Address group,
                                                Ptr<NetDevice> input,
                                                NetDeviceContainer output) {
...
void Ipv4StaticRoutingHelper::SetDefaultMulticastRoute(Ptr<Node> n,
                                                       Ptr<NetDevice> nd) {
  Ptr<Ipv4> ipv4 = n->GetObject<Ipv4>();
...
void Ipv4StaticRoutingHelper::SetDefaultMulticastRoute(std::string nName,
                                                       Ptr<NetDevice> nd) {
  Ptr<Node> n = Names::Find<Node>(nName);
  SetDefaultMulticastRoute(n, nd);
}
