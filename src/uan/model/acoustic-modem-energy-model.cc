      ...
      TypeId("ns3::AcousticModemEnergyModel")
          ...
          .AddTraceSource(
              ...
              MakeTraceSourceAccessor(
                  &AcousticModemEnergyModel::m_totalEnergyConsumption),
...
void AcousticModemEnergyModel::SetNode(Ptr<Node> node) {
  NS_LOG_FUNCTION(this << node);
  NS_ASSERT(node);
  m_node = node;
}

Ptr<Node> AcousticModemEnergyModel::GetNode() const { return m_node; }

void AcousticModemEnergyModel::SetEnergySource(Ptr<EnergySource> source) {
  NS_LOG_FUNCTION(this << source);
  NS_ASSERT(source);
  m_source = source;
}

double AcousticModemEnergyModel::GetTotalEnergyConsumption() const {
  NS_LOG_FUNCTION(this);
  return m_totalEnergyConsumption;
}

double AcousticModemEnergyModel::GetTxPowerW() const {
  NS_LOG_FUNCTION(this);
  return m_txPowerW;
}

void AcousticModemEnergyModel::SetTxPowerW(double txPowerW) {
  NS_LOG_FUNCTION(this << txPowerW);
  m_txPowerW = txPowerW;
}

double AcousticModemEnergyModel::GetRxPowerW() const {
  NS_LOG_FUNCTION(this);
  return m_rxPowerW;
}

void AcousticModemEnergyModel::SetRxPowerW(double rxPowerW) {
  NS_LOG_FUNCTION(this << rxPowerW);
  m_rxPowerW = rxPowerW;
}

double AcousticModemEnergyModel::GetIdlePowerW() const {
  NS_LOG_FUNCTION(this);
  return m_idlePowerW;
}

void AcousticModemEnergyModel::SetIdlePowerW(double idlePowerW) {
  NS_LOG_FUNCTION(this << idlePowerW);
  m_idlePowerW = idlePowerW;
}

double AcousticModemEnergyModel::GetSleepPowerW() const {
  NS_LOG_FUNCTION(this);
  return m_sleepPowerW;
}

void AcousticModemEnergyModel::SetSleepPowerW(double sleepPowerW) {
  NS_LOG_FUNCTION(this << sleepPowerW);
  m_sleepPowerW = sleepPowerW;
}

int AcousticModemEnergyModel::GetCurrentState() const {
  NS_LOG_FUNCTION(this);
  return m_currentState;
}

void AcousticModemEnergyModel::SetEnergyDepletionCallback(
...
void AcousticModemEnergyModel::SetEnergyRechargeCallback(
...
void AcousticModemEnergyModel::HandleEnergyDepletion() {
  NS_LOG_FUNCTION(this);
...
void AcousticModemEnergyModel::HandleEnergyRecharged() {
  NS_LOG_FUNCTION(this);
...
double AcousticModemEnergyModel::DoGetCurrentA() const {
  NS_LOG_FUNCTION(this);
...
bool AcousticModemEnergyModel::IsStateTransitionValid(const int destState) {
  NS_LOG_FUNCTION(this << destState);
  return true;
}

void AcousticModemEnergyModel::SetMicroModemState(const int state) {
  NS_LOG_FUNCTION(this);
  if (IsStateTransitionValid(state)) {
    ...
    NS_LOG_DEBUG("AcousticModemEnergyModel:Switching to state: "
