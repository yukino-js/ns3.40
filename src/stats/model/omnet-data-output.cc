...
void OmnetDataOutput::DoDispose() {
  NS_LOG_FUNCTION(this);
...
void OmnetDataOutput::Output(DataCollector &dc) {
...
void OmnetDataOutput::OmnetOutputCallback::OutputStatistic(
    std::string context, std::string name, const StatisticalSummary *statSum) {
