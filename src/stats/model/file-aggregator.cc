...
TypeId FileAggregator::GetTypeId() {
...
FileAggregator::FileAggregator(const std::string &outputFileName,
                               FileType fileType)
    : m_outputFileName(outputFileName), m_fileType(fileType),
      m_hasHeadingBeenSet(false), m_1dFormat("%e"), m_2dFormat("%e %e"),
      m_3dFormat("%e %e %e"), m_4dFormat("%e %e %e %e"),
      m_5dFormat("%e %e %e %e %e"), m_6dFormat("%e %e %e %e %e %e"),
      m_7dFormat("%e %e %e %e %e %e %e"), m_8dFormat("%e %e %e %e %e %e %e %e"),
...
void FileAggregator::SetFileType(FileType fileType) {
  NS_LOG_FUNCTION(this << fileType);
  m_fileType = fileType;
}

void FileAggregator::SetHeading(const std::string &heading) {
...
void FileAggregator::Set1dFormat(const std::string &format) {
  NS_LOG_FUNCTION(this << format);
  m_1dFormat = format;
}

void FileAggregator::Set2dFormat(const std::string &format) {
  NS_LOG_FUNCTION(this << format);
  m_2dFormat = format;
}

void FileAggregator::Set3dFormat(const std::string &format) {
  NS_LOG_FUNCTION(this << format);
  m_3dFormat = format;
}

void FileAggregator::Set4dFormat(const std::string &format) {
  NS_LOG_FUNCTION(this << format);
  m_4dFormat = format;
}

void FileAggregator::Set5dFormat(const std::string &format) {
  NS_LOG_FUNCTION(this << format);
  m_5dFormat = format;
}

void FileAggregator::Set6dFormat(const std::string &format) {
  NS_LOG_FUNCTION(this << format);
  m_6dFormat = format;
}

void FileAggregator::Set7dFormat(const std::string &format) {
  NS_LOG_FUNCTION(this << format);
  m_7dFormat = format;
}

void FileAggregator::Set8dFormat(const std::string &format) {
  NS_LOG_FUNCTION(this << format);
  m_8dFormat = format;
}

void FileAggregator::Set9dFormat(const std::string &format) {
  NS_LOG_FUNCTION(this << format);
  m_9dFormat = format;
}

void FileAggregator::Set10dFormat(const std::string &format) {
  NS_LOG_FUNCTION(this << format);
  m_10dFormat = format;
}

void FileAggregator::Write1d(std::string context, double v1) {
...
void FileAggregator::Write2d(std::string context, double v1, double v2) {
...
void FileAggregator::Write3d(std::string context, double v1, double v2,
                             double v3) {
...
void FileAggregator::Write4d(std::string context, double v1, double v2,
                             double v3, double v4) {
...
void FileAggregator::Write5d(std::string context, double v1, double v2,
...
void FileAggregator::Write6d(std::string context, double v1, double v2,
...
void FileAggregator::Write7d(std::string context, double v1, double v2,
                             double v3, double v4, double v5, double v6,
                             double v7) {
...
void FileAggregator::Write8d(std::string context, double v1, double v2,
                             double v3, double v4, double v5, double v6,
                             double v7, double v8) {
  NS_LOG_FUNCTION(this << context << v1 << v2 << v3 << v4 << v5 << v6 << v7
                       << v8);
...
void FileAggregator::Write9d(std::string context, double v1, double v2,
                             double v3, double v4, double v5, double v6,
...
void FileAggregator::Write10d(std::string context, double v1, double v2,
                              double v3, double v4, double v5, double v6,
