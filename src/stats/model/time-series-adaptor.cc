...
TypeId TimeSeriesAdaptor::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::TimeSeriesAdaptor")
...
TimeSeriesAdaptor::TimeSeriesAdaptor() { NS_LOG_FUNCTION(this); }

TimeSeriesAdaptor::~TimeSeriesAdaptor() { NS_LOG_FUNCTION(this); }

void TimeSeriesAdaptor::TraceSinkDouble(double oldData, double newData) {
...
void TimeSeriesAdaptor::TraceSinkBoolean(bool oldData, bool newData) {
  NS_LOG_FUNCTION(this << oldData << newData);
...
void TimeSeriesAdaptor::TraceSinkUinteger8(uint8_t oldData, uint8_t newData) {
  NS_LOG_FUNCTION(this << oldData << newData);
...
void TimeSeriesAdaptor::TraceSinkUinteger16(uint16_t oldData,
                                            uint16_t newData) {
  NS_LOG_FUNCTION(this << oldData << newData);
...
void TimeSeriesAdaptor::TraceSinkUinteger32(uint32_t oldData,
                                            uint32_t newData) {
  NS_LOG_FUNCTION(this << oldData << newData);
