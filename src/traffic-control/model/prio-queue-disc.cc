...
PrioQueueDisc::~PrioQueueDisc() { NS_LOG_FUNCTION(this); }
...
uint16_t PrioQueueDisc::GetBandForPriority(uint8_t prio) const {
...
Ptr<QueueDiscItem> PrioQueueDisc::DoDequeue() {
  NS_LOG_FUNCTION(this);
...
Ptr<const QueueDiscItem> PrioQueueDisc::DoPeek() {
  NS_LOG_FUNCTION(this);
...
bool PrioQueueDisc::CheckConfig() {
  NS_LOG_FUNCTION(this);
...
void PrioQueueDisc::InitializeParams() { NS_LOG_FUNCTION(this); }
