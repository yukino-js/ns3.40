...
FifoQueueDisc::~FifoQueueDisc() { NS_LOG_FUNCTION(this); }
...
Ptr<QueueDiscItem> FifoQueueDisc::DoDequeue() {
  NS_LOG_FUNCTION(this);
...
Ptr<const QueueDiscItem> FifoQueueDisc::DoPeek() {
  NS_LOG_FUNCTION(this);
...
bool FifoQueueDisc::CheckConfig() {
  NS_LOG_FUNCTION(this);
...
void FifoQueueDisc::InitializeParams() { NS_LOG_FUNCTION(this); }
