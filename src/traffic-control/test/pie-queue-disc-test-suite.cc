...
public:
  ...
  bool m_checkAccuProb =
      false; //!< Enable/Disable accumulated drop probability checks
  bool m_constAccuProb =
      false; //!< Enable/Disable fixed accumulated drop probability
  bool m_checkMaxAccuProb =
      false; //!< Enable/Disable Maximum accumulated drop probability checks
  ...
  double m_setAccuProb =
      0.0; //!< Value to be set for accumulated drop probability
