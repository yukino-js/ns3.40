...
TypeId SubscriberStationNetDevice::GetTypeId() {
  static TypeId tid =
      TypeId("ns3::SubscriberStationNetDevice")
          ...
          .AddAttribute("BasicConnection", "Basic connection", PointerValue(),
                        MakePointerAccessor(
                            &SubscriberStationNetDevice::m_basicConnection),
                        MakePointerChecker<WimaxConnection>())

          .AddAttribute("PrimaryConnection", "Primary connection",
                        PointerValue(),
                        MakePointerAccessor(
                            &SubscriberStationNetDevice::m_primaryConnection),
                        MakePointerChecker<WimaxConnection>())
          ...
          .AddAttribute("LostDlMapInterval",
                        ...
                        MakeTimeAccessor(
                            &SubscriberStationNetDevice::GetLostDlMapInterval,
          ...
          .AddAttribute("LostUlMapInterval",
                        ...
                        MakeTimeAccessor(
                            &SubscriberStationNetDevice::GetLostUlMapInterval,
          ...
          .AddAttribute(
              ...
              MakeUintegerAccessor(
                  &SubscriberStationNetDevice::GetMaxContentionRangingRetries,
          ...
          .AddAttribute(
              ...
              PointerValue(),
              MakePointerAccessor(
                  &SubscriberStationNetDevice::GetIpcsClassifier,
          ...
          .AddTraceSource("SSTxDrop",
                          ...
                          MakeTraceSourceAccessor(
                              &SubscriberStationNetDevice::m_ssTxDropTrace),
          ...
          .AddTraceSource("SSPromiscRx",
                          ...
                          MakeTraceSourceAccessor(
                              &SubscriberStationNetDevice::m_ssPromiscRxTrace),
                          "ns3::Packet::TracedCallback")
          ...
          .AddTraceSource("SSRxDrop",
                          ...
                          "layer.",
                          MakeTraceSourceAccessor(
                              &SubscriberStationNetDevice::m_ssRxDropTrace),
                          "ns3::Packet::TracedCallback");
  return tid;
}
...
void SubscriberStationNetDevice::InitSubscriberStationNetDevice() {
...
SubscriberStationNetDevice::SubscriberStationNetDevice(Ptr<Node> node,
                                                       Ptr<WimaxPhy> phy) {
  InitSubscriberStationNetDevice();
  this->SetNode(node);
  this->SetPhy(phy);
...
void SubscriberStationNetDevice::DoDispose() {
...
void SubscriberStationNetDevice::SetLostDlMapInterval(Time lostDlMapInterval) {
...
void SubscriberStationNetDevice::SetLostUlMapInterval(Time lostUlMapInterval) {
  m_lostUlMapInterval = lostUlMapInterval;
}

Time SubscriberStationNetDevice::GetLostUlMapInterval() const {
  return m_lostUlMapInterval;
}

void SubscriberStationNetDevice::SetMaxDcdInterval(Time maxDcdInterval) {
  m_maxDcdInterval = maxDcdInterval;
}

Time SubscriberStationNetDevice::GetMaxDcdInterval() const {
  return m_maxDcdInterval;
}

void SubscriberStationNetDevice::SetMaxUcdInterval(Time maxUcdInterval) {
  m_maxUcdInterval = maxUcdInterval;
}

Time SubscriberStationNetDevice::GetMaxUcdInterval() const {
  return m_maxUcdInterval;
}

void SubscriberStationNetDevice::SetIntervalT1(Time interval) {
  m_intervalT1 = interval;
}

Time SubscriberStationNetDevice::GetIntervalT1() const { return m_intervalT1; }

void SubscriberStationNetDevice::SetIntervalT2(Time interval) {
  m_intervalT2 = interval;
}

Time SubscriberStationNetDevice::GetIntervalT2() const { return m_intervalT2; }

void SubscriberStationNetDevice::SetIntervalT3(Time interval) {
  m_intervalT3 = interval;
}

Time SubscriberStationNetDevice::GetIntervalT3() const { return m_intervalT3; }

void SubscriberStationNetDevice::SetIntervalT7(Time interval) {
  m_intervalT7 = interval;
}

Time SubscriberStationNetDevice::GetIntervalT7() const { return m_intervalT7; }

void SubscriberStationNetDevice::SetIntervalT12(Time interval) {
  m_intervalT12 = interval;
}

Time SubscriberStationNetDevice::GetIntervalT12() const {
  return m_intervalT12;
}

void SubscriberStationNetDevice::SetIntervalT20(Time interval) {
  m_intervalT20 = interval;
}

Time SubscriberStationNetDevice::GetIntervalT20() const {
  return m_intervalT20;
}

void SubscriberStationNetDevice::SetIntervalT21(Time interval) {
  m_intervalT21 = interval;
}

Time SubscriberStationNetDevice::GetIntervalT21() const {
  return m_intervalT21;
}

void SubscriberStationNetDevice::SetMaxContentionRangingRetries(
    uint8_t maxContentionRangingRetries) {
  m_maxContentionRangingRetries = maxContentionRangingRetries;
}

uint8_t SubscriberStationNetDevice::GetMaxContentionRangingRetries() const {
  return m_maxContentionRangingRetries;
}

void SubscriberStationNetDevice::SetBasicConnection(
    Ptr<WimaxConnection> basicConnection) {
...
Ptr<WimaxConnection> SubscriberStationNetDevice::GetBasicConnection() const {
  return m_basicConnection;
}

void SubscriberStationNetDevice::SetPrimaryConnection(
    Ptr<WimaxConnection> primaryConnection) {
...
Ptr<WimaxConnection> SubscriberStationNetDevice::GetPrimaryConnection() const {
  return m_primaryConnection;
}

Cid SubscriberStationNetDevice::GetBasicCid() const {
  return m_basicConnection->GetCid();
}

Cid SubscriberStationNetDevice::GetPrimaryCid() const {
  return m_primaryConnection->GetCid();
}

void SubscriberStationNetDevice::SetModulationType(
    WimaxPhy::ModulationType modulationType) {
  m_modulationType = modulationType;
}

WimaxPhy::ModulationType SubscriberStationNetDevice::GetModulationType() const {
  return m_modulationType;
}

void SubscriberStationNetDevice::SetAreManagementConnectionsAllocated(
    bool areManagementConnectionsAllocated) {
  m_areManagementConnectionsAllocated = areManagementConnectionsAllocated;
}

bool SubscriberStationNetDevice::GetAreManagementConnectionsAllocated() const {
  return m_areManagementConnectionsAllocated;
}

void SubscriberStationNetDevice::SetAreServiceFlowsAllocated(
    bool areServiceFlowsAllocated) {
  m_areServiceFlowsAllocated = areServiceFlowsAllocated;
}

bool SubscriberStationNetDevice::GetAreServiceFlowsAllocated() const {
  return m_areServiceFlowsAllocated;
}

Ptr<SSScheduler> SubscriberStationNetDevice::GetScheduler() const {
  return m_scheduler;
}

void SubscriberStationNetDevice::SetScheduler(Ptr<SSScheduler> scheduler) {
  m_scheduler = scheduler;
}

bool SubscriberStationNetDevice::HasServiceFlows() const {
  return !GetServiceFlowManager()
              ->GetServiceFlows(ServiceFlow::SF_TYPE_ALL)
              .empty();
}

Ptr<IpcsClassifier> SubscriberStationNetDevice::GetIpcsClassifier() const {
  return m_classifier;
}

void SubscriberStationNetDevice::SetIpcsPacketClassifier(
    Ptr<IpcsClassifier> classifier) {
  m_classifier = classifier;
}

Ptr<SSLinkManager> SubscriberStationNetDevice::GetLinkManager() const {
  return m_linkManager;
}

void SubscriberStationNetDevice::SetLinkManager(
    Ptr<SSLinkManager> linkManager) {
...
void SubscriberStationNetDevice::SetServiceFlowManager(
    Ptr<SsServiceFlowManager> sfm) {
  m_serviceFlowManager = sfm;
}

void SubscriberStationNetDevice::Start() {
  SetReceiveCallback();
  ...
  Simulator::ScheduleNow(&SSLinkManager::StartScanning, m_linkManager,
                         EVENT_NONE, false);
}

void SubscriberStationNetDevice::Stop() { SetState(SS_STATE_STOPPED); }

void SubscriberStationNetDevice::AddServiceFlow(ServiceFlow sf) const {
...
bool SubscriberStationNetDevice::DoSend(Ptr<Packet> packet,
  ...
  NS_LOG_DEBUG("packet to send, size : " << packet->GetSize()
                                         << ", destination : " << dest);
  ...
  if (protocolNumber == 2048) {
    serviceFlow = m_classifier->Classify(packet, GetServiceFlowManager(),
                                         ServiceFlow::SF_DIRECTION_UP);
  }

  if ((protocolNumber != 2048) || (serviceFlow == nullptr)) {
    serviceFlow = *GetServiceFlowManager()
                       ->GetServiceFlows(ServiceFlow::SF_TYPE_ALL)
                       .begin();
...
bool SubscriberStationNetDevice::Enqueue(Ptr<Packet> packet,
                                         const MacHeaderType &hdrType,
                                         Ptr<WimaxConnection> connection) {
  NS_ASSERT_MSG(connection, "SS: Can not enqueue the packet: the selected "
  ...
  if (connection->GetType() == Cid::TRANSPORT) {
    if (connection->GetSchedulingType() == ServiceFlow::SF_TYPE_UGS &&
        m_scheduler->GetPollMe()) {
...
void SubscriberStationNetDevice::SendBurst(
    uint8_t uiuc, uint16_t nrSymbols, Ptr<WimaxConnection> connection,
  ...
  if (uiuc == OfdmUlBurstProfile::UIUC_INITIAL_RANGING ||
    ...
    modulationType =
        GetBurstProfileManager()->GetModulationType(uiuc, DIRECTION_UPLINK);
  }
...
void SubscriberStationNetDevice::DoReceive(Ptr<Packet> packet) {
  ...
  if (gnrcMacHdr.GetHt() == MacHeaderType::HEADER_TYPE_GENERIC) {
    ...
    if (cid == GetBroadcastConnection()->GetCid() && !fragmentation) {
      ...
      case ManagementMessageType::MESSAGE_TYPE_DL_MAP: {
        ...
        m_linkManager->ScheduleScanningRestart(
            m_lostDlMapInterval, EVENT_LOST_DL_MAP, false, m_lostDlMapEvent);
        ...
        m_linkManager->ScheduleScanningRestart(
            m_intervalT1, EVENT_DCD_WAIT_TIMEOUT, false, m_dcdWaitTimeoutEvent);
        ...
        m_linkManager->ScheduleScanningRestart(
            m_intervalT12, EVENT_UCD_WAIT_TIMEOUT, true, m_ucdWaitTimeoutEvent);
      ...
      case ManagementMessageType::MESSAGE_TYPE_UL_MAP: {
        if (m_lostUlMapEvent.IsRunning()) {
          ...
          m_linkManager->ScheduleScanningRestart(
              m_lostUlMapInterval, EVENT_LOST_UL_MAP, true, m_lostUlMapEvent);
        }
      ...
      case ManagementMessageType::MESSAGE_TYPE_UCD: {
        ...
        if (GetState() == SS_STATE_ACQUIRING_PARAMETERS) {
          ...
          m_linkManager->ScheduleScanningRestart(
              m_intervalT2, EVENT_RANG_OPP_WAIT_TIMEOUT, false,
    ...
    } else if (GetInitialRangingConnection() &&
               cid == GetInitialRangingConnection()->GetCid() &&
               !fragmentation) {
      ...
      case ManagementMessageType::MESSAGE_TYPE_RNG_RSP:
        NS_ASSERT_MSG(
            GetState() >= SS_STATE_WAITING_REG_RANG_INTRVL,
    ...
    } else if (m_basicConnection && cid == m_basicConnection->GetCid() &&
               !fragmentation) {
      m_traceSSRx(packet, GetMacAddress(), cid);
      packet->RemoveHeader(msgType);
      switch (msgType.GetType()) {
      ...
      case ManagementMessageType::MESSAGE_TYPE_RNG_RSP:
        NS_ASSERT_MSG(
            GetState() == SS_STATE_WAITING_RNG_RSP,
            "SS: Error while receiving a ranging response message: SS state "
    ...
    } else if (m_primaryConnection && cid == m_primaryConnection->GetCid() &&
               !fragmentation) {
      m_traceSSRx(packet, GetMacAddress(), cid);
      packet->RemoveHeader(msgType);
      switch (msgType.GetType()) {
                   ...
                   cid)) // transport connection
    {
      ...
      if (!fragmentation) {
        ...
        if (fc == 2) {
          ...
          NS_LOG_INFO("\t fullPacket size = " << fullPacket->GetSize()
                                              << std::endl);
...
void SubscriberStationNetDevice::ProcessDlMap(const DlMap &dlmap) {
  m_nrDlMapRecvd++;
...
void SubscriberStationNetDevice::ProcessUlMap(const UlMap &ulmap) {
  m_nrUlMapRecvd++;
  ...
  for (auto iter = ulMapElements.begin(); iter != ulMapElements.end(); ++iter) {
    ...
    if (m_areManagementConnectionsAllocated &&
        cid == m_basicConnection->GetCid()) {
...

      {
        ...
        Simulator::Schedule(timeToAllocation,
                            &SubscriberStationNetDevice::SendBurst, this,
                            ulMapIe.GetUiuc(), ulMapIe.GetDuration(),
                            connection, MacHeaderType::HEADER_TYPE_GENERIC);
      }
    } else {
      if (ulMapIe.GetUiuc() == OfdmUlBurstProfile::UIUC_INITIAL_RANGING &&
...
void SubscriberStationNetDevice::ProcessDcd(const Dcd &dcd) {
  m_nrDcdRecvd++;
...
void SubscriberStationNetDevice::ProcessUcd(const Ucd &ucd) {
  m_nrUcdRecvd++;
...
Time SubscriberStationNetDevice::GetTimeToAllocation(Time deferTime) {
...
void SubscriberStationNetDevice::SetAsciiTxQueueEnqueueCallback(
    AsciiTraceCallback cb) {
  m_asciiTxQueueEnqueueCb = cb;
}

void SubscriberStationNetDevice::SetAsciiTxQueueDequeueCallback(
    AsciiTraceCallback cb) {
  m_asciiTxQueueDequeueCb = cb;
}

void SubscriberStationNetDevice::SetAsciiTxQueueDropCallback(
    AsciiTraceCallback cb) {
