...
private:
  ...
  uint16_t m_fecBlockSize; ///< in bits, size of FEC block transmitted after PHY
                           ///< operations
  uint32_t m_currentBurstSize; ///< current burst size

  std::list<Bvec>
      *m_receivedFecBlocks;   ///< a list of received FEC blocks until they are
  ...
  SNRToBlockErrorRateManager
      *m_snrToBlockErrorRateManager; ///< SNR to block error rate manager
