...
private:
  ...
  uint32_t m_frameNumber; ///< shall actually be only 4 LSB of the same field in
                          ///< OFDM DCD Channel Encodings
  uint8_t m_configurationChangeCount; ///< shall actually be only 4 LSB of the
                                      ///< same field in DCD
  std::vector<DlFramePrefixIe>
      m_dlFramePrefixElements; ///< vector of dl frame prefix elements
