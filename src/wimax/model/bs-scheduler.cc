...
void BSScheduler::SetBs(Ptr<BaseStationNetDevice> bs) { m_bs = bs; }

Ptr<BaseStationNetDevice> BSScheduler::GetBs() { return m_bs; }

bool BSScheduler::CheckForFragmentation(
    Ptr<WimaxConnection> connection, int availableSymbols,
