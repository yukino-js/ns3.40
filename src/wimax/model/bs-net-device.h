...
private:
  ...
  TracedCallback<Ptr<const Packet>>
      m_bsTxTrace; ///< the base station transmit trace callback
   ...
   */
  TracedCallback<Ptr<const Packet>>
      m_bsRxTrace; ///< base station receive trace callback
   ...
   */
  TracedCallback<Ptr<const Packet>>
      m_bsRxDropTrace; ///< base station receive drop trace callback
};
