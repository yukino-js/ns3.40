...
void Angles::SetAzimuth(double azimuth) {
  m_azimuth = azimuth;
  NormalizeAngles();
}

void Angles::SetInclination(double inclination) {
  m_inclination = inclination;
  NormalizeAngles();
}

double Angles::GetAzimuth() const { return m_azimuth; }

double Angles::GetInclination() const { return m_inclination; }
...
void Angles::CheckIfValid() const {
