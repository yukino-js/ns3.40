...
bool Ipv6FlowClassifier::Classify(const Ipv6Header &ipHeader,
  ...
  if ((tuple.protocol != UDP_PROT_NUMBER) &&
      (tuple.protocol != TCP_PROT_NUMBER)) {
    return false;
  }
...
bool Ipv6FlowClassifier::SortByCount::operator()(
...
void Ipv6FlowClassifier::SerializeToXmlStream(std::ostream &os,
