...
bool Ipv4FlowClassifier::Classify(const Ipv4Header &ipHeader,
...
bool Ipv4FlowClassifier::SortByCount::operator()(
...
void Ipv4FlowClassifier::SerializeToXmlStream(std::ostream &os,
