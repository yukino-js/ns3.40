...
TypeId ConstantPositionMobilityModel::GetTypeId() {
...
Vector ConstantPositionMobilityModel::DoGetPosition() const {
  return m_position;
}

void ConstantPositionMobilityModel::DoSetPosition(const Vector &position) {
  m_position = position;
  NotifyCourseChange();
}

Vector ConstantPositionMobilityModel::DoGetVelocity() const {
