...
PeerLinkOpenStart::PeerLinkOpenStart()
    : m_capability(0), m_rates(SupportedRates()),
      m_extendedRates(ExtendedSupportedRatesIE()), m_meshId(),
      m_config(IeConfiguration()) {}

void PeerLinkOpenStart::SetPlinkOpenStart(
...
TypeId PeerLinkOpenStart::GetTypeId() {
...
TypeId PeerLinkOpenStart::GetInstanceTypeId() const { return GetTypeId(); }

void PeerLinkOpenStart::Print(std::ostream &os) const {
...
void PeerLinkOpenStart::Serialize(Buffer::Iterator start) const {
...
uint32_t PeerLinkOpenStart::Deserialize(Buffer::Iterator start) {
  Buffer::Iterator i = start;
...
PeerLinkCloseStart::PeerLinkCloseStart() : m_meshId() {}

void PeerLinkCloseStart::SetPlinkCloseStart(
...
TypeId PeerLinkCloseStart::GetTypeId() {
...
TypeId PeerLinkCloseStart::GetInstanceTypeId() const { return GetTypeId(); }
...
void PeerLinkCloseStart::Serialize(Buffer::Iterator start) const {
  Buffer::Iterator i = start;
  i = m_meshId.Serialize(i);
}

uint32_t PeerLinkCloseStart::Deserialize(Buffer::Iterator start) {
  Buffer::Iterator i = start;
...
void PeerLinkConfirmStart::SetPlinkConfirmStart(
...
TypeId PeerLinkConfirmStart::GetTypeId() {
...
TypeId PeerLinkConfirmStart::GetInstanceTypeId() const { return GetTypeId(); }

void PeerLinkConfirmStart::Print(std::ostream &os) const {
  os << "capability=" << m_capability << ", rates=" << m_rates;
  os << ", ";
  m_config.Print(os);
}
...
void PeerLinkConfirmStart::Serialize(Buffer::Iterator start) const {
  Buffer::Iterator i = start;
...
uint32_t PeerLinkConfirmStart::Deserialize(Buffer::Iterator start) {
  Buffer::Iterator i = start;
