...
WifiInformationElementId IePerr::ElementId() const { return IE_PERR; }

void IePerr::Print(std::ostream &os) const {
...
void IePerr::AddAddressUnit(HwmpProtocol::FailedDestination unit) {
...
void IePerr::ResetPerr() { m_addressUnits.clear(); }
