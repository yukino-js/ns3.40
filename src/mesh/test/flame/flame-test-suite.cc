...
FlameRtableTest::FlameRtableTest()
    : TestCase("FlameRtable"), dst("01:00:00:01:00:01"),
      hop("01:00:00:01:00:03"), iface(8010), cost(10), seqnum(1) {}
...
void FlameRtableTest::TestLookup() {
  ...
  NS_TEST_EXPECT_MSG_EQ((table->Lookup(dst) == correct), true,
...
FlameTestSuite::FlameTestSuite() : TestSuite("devices-mesh-flame", UNIT) {
