...
SpectrumChannel::SpectrumChannel() { NS_LOG_FUNCTION(this); }

SpectrumChannel::~SpectrumChannel() {}

void SpectrumChannel::DoDispose() {
...
TypeId SpectrumChannel::GetTypeId() {
  static TypeId tid =
...
void SpectrumChannel::AddPropagationLossModel(Ptr<PropagationLossModel> loss) {
...
void SpectrumChannel::AddSpectrumPropagationLossModel(
    Ptr<SpectrumPropagationLossModel> loss) {
  NS_LOG_FUNCTION(this << loss);
...
void SpectrumChannel::AddPhasedArraySpectrumPropagationLossModel(
...
void SpectrumChannel::AddSpectrumTransmitFilter(
    Ptr<SpectrumTransmitFilter> filter) {
...
void SpectrumChannel::SetPropagationDelayModel(
