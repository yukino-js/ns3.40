...
public:
  ...
  using Complex2DVector =
      ComplexMatrixArray; //!< Create an alias for 2D complex vectors
  using Complex3DVector =
      ComplexMatrixArray; //!< Create an alias for 3D complex vectors
  ...
  static const uint8_t AOA_INDEX =
      0; //!< index of the AOA value in the m_angle array
  static const uint8_t ZOA_INDEX =
      1; //!< index of the ZOA value in the m_angle array
  static const uint8_t AOD_INDEX =
      2; //!< index of the AOD value in the m_angle array
  static const uint8_t ZOD_INDEX =
      3; //!< index of the ZOD value in the m_angle array
};
