...
protected:
  ...
  struct ThreeGppChannelParams : public MatrixBasedChannelModel::ChannelParams {
    ChannelCondition::LosConditionValue
        m_losCondition; //!< contains the information about the LOS state of the
                        //!< channel
    ChannelCondition::O2iConditionValue
        m_o2iCondition; //!< contains the information about the O2I state of the
                        //!< channel
    ...
    MatrixBasedChannelModel::Double2DVector
        m_nonSelfBlocking; //!< store the blockages
    ...
    MatrixBasedChannelModel::Double3DVector
        m_clusterPhase; //!< the initial random phases
    MatrixBasedChannelModel::Double2DVector
  ...
  struct ParamsTable : public SimpleRefCount<ParamsTable> {
    ...
    double m_sigLgDS =
        0; //!< Standard deviation value of 10-base logarithm of delay spread
    ...
    double m_perClusterShadowingStd =
        0;                //!< Per cluster shadowing standard deviation
  ...
  Ptr<ChannelConditionModel>
      m_channelConditionModel;            //!< the channel condition model
  ...
  Ptr<UniformRandomVariable>
      m_uniformRvShuffle; //!< uniform random variable used to shuffle array in
                          //!< GetNewChannel
  ...
  Ptr<UniformRandomVariable>
      m_uniformRvDoppler; //!< uniform random variable, used to compute the
  ...
  static const uint8_t X_INDEX =
      1; //!< index of the X value in the m_nonSelfBlocking array
  static const uint8_t THETA_INDEX =
      2; //!< index of the THETA value in the m_nonSelfBlocking array
  static const uint8_t Y_INDEX =
      3; //!< index of the Y value in the m_nonSelfBlocking array
  static const uint8_t R_INDEX =
      4; //!< index of the R value in the m_nonSelfBlocking array
};
} // namespace ns3
