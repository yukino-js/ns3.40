...
bool SpectrumValueTestCase::MoreOrLessEqual(SpectrumValue x, SpectrumValue y) {
  SpectrumValue z = x - y;
  return (Norm(z) < TOLERANCE);
}

void SpectrumValueTestCase::DoRun() {
  NS_TEST_ASSERT_MSG_SPECTRUM_MODEL_EQ_TOL(
      *m_a.GetSpectrumModel(), *m_b.GetSpectrumModel(), TOLERANCE, "");
...
SpectrumValueTestSuite::SpectrumValueTestSuite()
  ...
  AddTestCase(new SpectrumValueTestCase(tv9a, v9, "tv9a = v1 * doubleValue"),
              TestCase::QUICK);
  AddTestCase(
      new SpectrumValueTestCase(tv10a, v10, "tv10a = v1 div doubleValue"),
      TestCase::QUICK);
  ...
  AddTestCase(new SpectrumValueTestCase(tv9b, v9, "tv9b =  doubleValue * v1"),
              TestCase::QUICK);
  AddTestCase(
      new SpectrumValueTestCase(tv10b, v10, "tv10b = doubleValue div v1"),
      TestCase::QUICK);
