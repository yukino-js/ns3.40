...
TypeId DeviceEnergyModel::GetTypeId() {
...
DeviceEnergyModel::DeviceEnergyModel() { NS_LOG_FUNCTION(this); }

DeviceEnergyModel::~DeviceEnergyModel() { NS_LOG_FUNCTION(this); }

double DeviceEnergyModel::GetCurrentA() const {
...
double DeviceEnergyModel::DoGetCurrentA() const {
  NS_LOG_FUNCTION(this);
  return 0.0;
}
