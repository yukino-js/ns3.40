...
private:
  ...
  Ipv4Address
      m_remoteAddress; //!< Initially set to 255.255.255.255 to start DHCP
  ...
  Ptr<RandomVariableStream>
      m_ran;      //!< Uniform random variable for transaction ID
  ...
  std::list<DhcpHeader>
      m_offerList; //!< Stores all the offers given to the client
