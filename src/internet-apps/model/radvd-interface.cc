...
RadvdInterface::RadvdInterface(uint32_t interface, uint32_t maxRtrAdvInterval,
...
Time RadvdInterface::GetLastRaTxTime() { return m_lastSendTime; }
...
bool RadvdInterface::IsInitialRtrAdv() const {
