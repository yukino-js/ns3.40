...
private:
  mutable std::mutex
      m_mutex; //!< Mutex to serialize the operations performed on the queue
};
...
private:
  ...
  std::thread
      m_syncAndNotifyQueueThread; //!< Thread used to perform the flow control
  std::atomic<bool> m_syncAndNotifyQueueThreadRun; //!< Running flag of the flow
                                                   //!< control thread
