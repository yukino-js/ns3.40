...
int main(int argc, char *argv[]) {
  ...
  NS_LOG_INFO("INFO: Create nodes."); // - - - - - - - - - - - - - - - -
                                      ...
                                      // - - - - - - - - - - - - - - - -
  Ptr<Node> t2 =
      CreateObject<Node>(); // 192.168.1.2 : Top multi-switch udp echo client
  Ptr<Node> t3 =
      CreateObject<Node>(); // 192.168.1.3 : Top single-switch   udp echo server
                            //             :
  ...
  Ptr<Node> br = CreateObject<Node>();  // 76.1.1.2    : Router connecting WAN &
                                        ...
                                        //             :
  Ptr<Node> bs1 =
      CreateObject<Node>(); // <no IP>     : Bottom switch #1 (bridge)
  Ptr<Node> bs2 =
      CreateObject<Node>(); // <no IP>     : Bottom switch #2 (bridge)
  Ptr<Node> bs3 =
      CreateObject<Node>(); // <no IP>     : Bottom switch #3 (bridge)
  Ptr<Node> bs4 =
      CreateObject<Node>(); // <no IP>     : Bottom switch #4 (bridge)
  Ptr<Node> bs5 =
      CreateObject<Node>(); // <no IP>     : Bottom switch #5 (bridge)
                            //             :
  Ptr<Node> b2 =
      CreateObject<Node>(); // 192.168.2.2 : Bottom multi-switch udp echo server
